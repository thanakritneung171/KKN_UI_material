...
namespace KKN_UI
{
    public static class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/scripts/gridmvc").Include("~/scripts/gridmvc.js", "~/Scripts/gridmvc.min.js", "~/Scripts/jquery-1.10.2.js", "~/Scripts/jquery-1.10.2.min.js"));

            bundles.Add(new ScriptBundle("~/scripts/sorting").IncludeDirectory("~/scripts/plugin/sorting", "*.js"));

            bundles.Add(new ScriptBundle("~/scripts/main").Include("~/scripts/KKN/main.min.js"));
            ...
            bundles.Add(new ScriptBundle("~/scripts/velocity").Include(
                 "~/scripts/plugin/velocity/velocity.min.js",
                 "~/scripts/plugin/velocity/velocity.ui.min.js"
                 ));

            bundles.Add(new ScriptBundle("~/scripts/autosize").Include(
              "~/scripts/plugin/autosize/autosize.min.js"
              ));

            bundles.Add(new ScriptBundle("~/scripts/autonumber").Include(
                "~/scripts/plugin/autoNumeric/autoNumeric.js"
                ));

            bundles.Add(new ScriptBundle("~/scripts/datetimepicker").Include(
             "~/Scripts/plugin/datetimepicker/bootstrap-datetimepicker.min.js"
              ));
            //panel
            bundles.Add(new ScriptBundle("~/scripts/mixitup").Include(
              "~/scripts/plugin/mixitup/jquery.mixitup.min.js",
              "~/scripts/plugin/mixitup/main.js",
              "~/scripts/plugin/mixitup/modernizr.js"
            ));
