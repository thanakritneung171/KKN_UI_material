if (
  ...
  SpeechRecognition && voice_command)
) {
  $.root_.on("click", '[data-action="voiceCommand"]', function (a) {
    $.root_.hasClass("voice-command-active")
      ? $.speechApp.stop()
      : ($.speechApp.start(), $("#speech-btn .popover").fadeIn(350)),
      a.preventDefault();
  }),
    $(document).mouseup(function (a) {
      $("#speech-btn .popover").is(a.target) ||
        0 !== $("#speech-btn .popover").has(a.target).length ||
  ...
  modal.appendTo("body"),
    debugState && root.console.log("This browser supports Voice Command"),
    ($.speechApp = (function (a) {
      return (
        (a.start = function () {
        ...
        (a.stop = function () {
          smartSpeechRecognition &&
            ...
            $("#speech-btn .popover").is(":visible") &&
              $("#speech-btn .popover").fadeOut(250));
        }),
        (a.playON = function () {
          var a = document.createElement("audio");
          navigator.userAgent.match("Firefox/")
            ? a.setAttribute("src", $.sound_path + "voice_on.ogg")
            : a.setAttribute("src", $.sound_path + "voice_on.mp3"),
            a.addEventListener(
              "load",
              function () {
                a.play();
        ...
        (a.playOFF = function () {
          var a = document.createElement("audio");
          navigator.userAgent.match("Firefox/")
            ? a.setAttribute("src", $.sound_path + "voice_off.ogg")
            : a.setAttribute("src", $.sound_path + "voice_off.mp3"),
            $.get(),
            a.addEventListener(
              "load",
              function () {
        ...
        (a.playConfirmation = function () {
          var a = document.createElement("audio");
          navigator.userAgent.match("Firefox/")
            ? a.setAttribute("src", $.sound_path + "voice_alert.ogg")
            : a.setAttribute("src", $.sound_path + "voice_alert.mp3"),
            $.get(),
            a.addEventListener(
              "load",
              function () {
...
(function (a) {
  ...
  root.smartSpeechRecognition = {
        ...
        (b.onstart = function () {
          m(e.start),
            debugState &&
              ...
              root.console.log(
                "Language setting is set to: " + b.lang,
                debugStyle
              )),
              ...
              (c = !1),
                ...
                m(
                  new Date().getTime() - f < 200
                    ? e.errorPermissionBlocked
                    : e.errorPermissionDenied
                );
          }
        }),
        (b.onend = function () {
          if ((m(e.end), c)) {
            ...
            1e3 > a
              ? setTimeout(root.smartSpeechRecognition.start, 1e3 - a)
        ...
        (b.onresult = function (a) {
          ...
          for (var b, c = a.results[a.resultIndex], f = 0; f < c.length; f++) {
            (b = c[f].transcript.trim()),
              debugState &&
                root.console.log("Speech recognized: %c" + b, debugStyle);
            for (var g = 0, h = d.length; h > g; g++) {
              ...
              if (i) {
                ...
                debugState &&
                  (root.console.log(
                    "command matched: %c" + d[g].originalPhrase,
                    debugStyle
                  ),
                  j.length && root.console.log("with parameters", j)),
                  d[g].callback.apply(this, j),
                  m(e.resultMatch);
                var k = ["sound on", "mute", "stop"];
                return (
                  k.indexOf(d[g].originalPhrase) < 0 &&
                    ($.smallBox({
    ...
    start: function (d) {
      n(),
        (d = d || {}),
        (c = d.autoRestart !== a ? !!d.autoRestart : !0),
        (f = new Date().getTime()),
        b.start();
    },
    abort: function () {
    ...
    debug: function (a) {
      arguments.length > 0 ? (debugState = !!a) : (debugState = !0);
    },
    ...
    addCommands: function (a) {
      ...
      for (var e in a)
        if (a.hasOwnProperty(e)) {
          ...
          (c = l(e)), d.push({ command: c, callback: b, originalPhrase: e });
        }
      debugState &&
        root.console.log(
          "Commands successfully loaded: %c" + d.length,
          debugStyle
        );
    },
    ...
    addCallback: function (b, c, d) {
      if (e[b] !== a) {
        var f = root[c] || c;
        "function" == typeof f &&
          e[b].push({ callback: f, context: d || this });
      }
    },
  };
}.call(this));
...
SpeechRecognition &&
  voice_command &&
  "true" == localStorage.getItem("sm-setautovoice") &&
  autoStart(),
