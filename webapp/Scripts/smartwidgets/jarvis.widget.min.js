!(function (a, b, c, d) {
  ...
  (e.prototype = {
    ...
    _loadKeys: function () {
      ...
      if (a.o.ajaxnav === !0) {
        ...
        (a.storage.keySettings = "jarvisWidgets_settings_" + b + "_" + a.objId),
          (a.storage.keyPosition =
            "jarvisWidgets_position_" + b + "_" + a.objId);
      }
    },
    _saveSettingsWidget: function () {
      ...
      var d = b.obj
          ...
          .map(function () {
            ...
            return (
              ...
              (b.collapsed = a(this).hasClass("jarviswidget-collapsed")
                ? 1
                : 0),
              b
            );
      ...
      c.enabled &&
        c.getKeySettings != e &&
        (localStorage.setItem(c.keySettings, e), (c.getKeySettings = e)),
        "function" == typeof b.o.onSave &&
          b.o.onSave.call(this, null, e, c.keySettings);
    },
    _savePositionWidget: function () {
      ...
      c.enabled &&
        c.getKeyPosition != e &&
        (localStorage.setItem(c.keyPosition, e), (c.getKeyPosition = e)),
        "function" == typeof b.o.onSave &&
          b.o.onSave.call(this, e, c.keyPosition);
    },
    init: function () {
      var b = this;
      if (!b.initialized) {
        if (
          ...
          a("#" + b.objId).length ||
            alert(
              "It looks like your using a class instead of an ID, dont do that!"
            ),
          b.o.rtl === !0 && a("body").addClass("rtl"),
          a(b.o.grid).each(function () {
            a(this).find(b.o.widgets).length &&
          ...
          for (var e in c.grid) {
            ...
            for (var i in c.grid[e].section)
              h.append(a("#" + c.grid[e].section[i].id));
          }
        }
        if (b.storage.enabled && b.storage.getKeySettings) {
          ...
          for (var e in j.widget) {
            ...
            j.widget[e].style &&
              ...
              1 == j.widget[e].hidden
                ? k.hide(1)
                : k.show(1).removeAttr("data-widget-hidden"),
              1 == j.widget[e].collapsed &&
                k.addClass("jarviswidget-collapsed").children("div").hide(1),
              k.children("header").children("h2").text() != j.widget[e].title &&
                k.children("header").children("h2").text(j.widget[e].title);
          }
        }
        if (
          (b.widget.each(function () {
            ...
            if (!m.parent().attr("role")) {
              l.data("widget-hidden") === !0 && l.hide(),
                l.data("widget-collapsed") === !0 &&
                  l.addClass("jarviswidget-collapsed").children("div").hide(),
                (c =
                  b.o.customButton === !0 &&
                  l.data("widget-custombutton") === d &&
                  0 !== b.customClass[0].length
                ...
                (f =
                  b.o.editButton === !0 && l.data("widget-editbutton") === d
                    ...
                    : ""),
                (g =
                  b.o.fullscreenButton === !0 &&
                  l.data("widget-fullscreenbutton") === d
                ...
                b.o.toggleButton === !0 && l.data("widget-togglebutton") === d
                  ? ((j =
                      l.data("widget-collapsed") === !0 ||
                      l.hasClass("jarviswidget-collapsed")
                        ? b.toggleClass[1]
                        : b.toggleClass[0]),
                    (i =
              ...
              ("" !== k ||
                ...
                "" !== f ||
                "" !== i) &&
                m.prepend('<div class="jarviswidget-ctrls">' + n + "</div>"),
                b.o.sortable === !0 &&
                  l.data("widget-sortable") === d &&
                  l.addClass("jarviswidget-sortable"),
          ...
          l.sortable({
            ...
            update: function (a, c) {
              b._runLoaderWidget(c.item.children()),
                ...
                "function" == typeof b.o.onChange &&
                  b.o.onChange.call(this, c.item);
            },
          });
        }
        b.o.buttonsHidden === !0 &&
    ...
    _initStorage: function (a) {
      (a.enabled =
        ...
        this._loadKeys(),
        a.enabled &&
          ((a.getKeySettings = localStorage.getItem(a.keySettings)),
          (a.getKeyPosition = localStorage.getItem(a.keyPosition)));
    },
    _clickEvents: function () {
      function c() {
        if (a("#jarviswidget-fullscreen-mode").length) {
          var c = a(b).height(),
            e = a("#jarviswidget-fullscreen-mode")
      ...
      e.on(g, ".jarviswidget-toggle-btn", function (b) {
        ...
        e.on(g, ".jarviswidget-fullscreen-btn", function (b) {
          ...
          d._runLoaderWidget(a(this)),
            a("#jarviswidget-fullscreen-mode").length
              ? (a(".nooverflow").removeClass("nooverflow"),
                e
                  ...
                  .children("a")
                  .show(),
                f.hasClass("jarviswidget-visible") &&
                  f.hide().removeClass("jarviswidget-visible"))
            ...
            c(),
            "function" == typeof d.o.onFullscreen &&
              d.o.onFullscreen.call(this, e),
            b.preventDefault();
        }),
        ...
        e.on(g, ".jarviswidget-edit-btn", function (b) {
          ...
          d._runLoaderWidget(a(this)),
            c.find(d.o.editPlaceholder).is(":visible")
              ...
              : a(this)
                  .children()
                  .removeClass(d.editClass[0])
                  .addClass(d.editClass[1])
                  .parents(d.o.widgets)
                  .find(d.o.editPlaceholder)
                  .slideDown(d.o.editSpeed),
        ...
        e.on(g, ".jarviswidget-custom-btn", function (b) {
          ...
          d._runLoaderWidget(a(this)),
            a(this).children("." + d.customClass[0]).length
              ? (a(this)
                  .children()
                  .removeClass(d.customClass[0])
                  .addClass(d.customClass[1]),
                "function" == typeof d.o.customStart &&
                  d.o.customStart.call(this, c))
              : (a(this)
                  .children()
                  .removeClass(d.customClass[1])
                  .addClass(d.customClass[0]),
                "function" == typeof d.o.customEnd &&
                  d.o.customEnd.call(this, c)),
            d._saveSettingsWidget(),
            b.preventDefault();
        }),
                ...
                function (b) {
                  "Yes" == b &&
                    ...
                    a("#" + e).fadeOut(d.o.deleteSpeed, function () {
                      a(this).remove(),
                        "function" == typeof d.o.onDelete &&
                          d.o.onDelete.call(this, c);
                    }));
                }
              )
            : a("#" + e).fadeOut(d.o.deleteSpeed, function () {
