  ...
  Wizard = function (a, b) {
    ...
    (this.$element = $(a)),
      ...
      (this.options.disablePreviousStep =
        "previous" === this.$element.data().restrict ? !0 : !1),
      (this.currentStep = this.options.selectedItem.step),
      (this.numSteps = this.$element.find(".steps li").length),
      (this.$prevBtn = this.$element.find("button.btn-prev")),
      (this.$nextBtn = this.$element.find("button.btn-next")),
      (c = this.$nextBtn.children().detach()),
      (this.nextText = $.trim(this.$nextBtn.text())),
      this.$nextBtn.append(c),
      this.$prevBtn.on("click", $.proxy(this.previous, this)),
      this.$nextBtn.on("click", $.proxy(this.next, this)),
      this.$element.on("click", "li.complete", $.proxy(this.stepclicked, this)),
      this.currentStep > 1 && this.selectedItem(this.options.selectedItem),
      this.options.disablePreviousStep &&
...
(Wizard.prototype = {
  ...
  setState: function () {
    ...
    this.options.disablePreviousStep ||
      this.$prevBtn.attr("disabled", b === !0 || a === !1);
    var d = this.$nextBtn.data();
    if (
      d &&
      d.last &&
      ((this.lastText = d.last), "undefined" != typeof this.lastText)
    ) {
    ...
    var n = 0;
    if (
      ((n = this.$element.find(".actions").length
        ? this.$element.width() -
      ...
      this.$element
        ...
        this.$element.find("li.active").first().position().left < 200 &&
          ((o += this.$element.find("li.active").first().position().left - 200),
          1 > o
            ? this.$element
                .find(".steps")
                .first()
  ...
  stepclicked: function (a) {
    var b = $(a.currentTarget),
      ...
      d = !0;
    if (
      (this.options.disablePreviousStep && c < this.currentStep && (d = !1), d)
    ) {
      var e = $.Event("stepclick");
      if ((this.$element.trigger(e, { step: c + 1 }), e.isDefaultPrevented()))
        return;
    ...
    var b,
      ...
      d = this.each(function () {
        var d = $(this),
          e = d.data("wizard"),
          f = "object" == typeof a && a;
        e || d.data("wizard", (e = new Wizard(this, f))),
          "string" == typeof a && (b = e[a].apply(e, c));
      });
    return void 0 === b ? d : b;
  }),
