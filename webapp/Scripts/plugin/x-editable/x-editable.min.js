          ...
          : ((this.options[b] = c),
            "disabled" === b
              ...
              : ("value" === b && this.setValue(c),
                ...
                void (this.input.option && this.input.option(b, c))));
      },
      handleEmpty: function (b) {
        this.options.display !== !1 &&
          (void 0 !== b
            ...
            : (this.isEmpty = "" === a.trim(this.$element.html())),
      ...
      return (
        ...
        this.$element.is("input")
          ? ((this.options = a.extend(
            ...
            void this.init())
          : void a.error("Combodate should be applied to INPUT element")
      );
    };
    (b.prototype = {
      constructor: b,
