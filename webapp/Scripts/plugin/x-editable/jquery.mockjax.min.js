 ...
 */ (function (e) {
  ...
  function a(t, n) {
    ...
    e.each(t, function (i) {
      ...
      typeof n[i] == "object" && n[i] !== null
        ? (r = r && a(t[i], n[i]))
        : t[i] && e.isFunction(t[i].test)
        ? (r = r && t[i].test(n[i]))
        : (r = r && t[i] == n[i]);
    });
    return r;
  ...
  function l(t, n) {
    ...
    if (e.isFunction(t.url.test)) {
      ...
      if (
        (t.url !== n.url && r === -1) ||
        !new RegExp(
          t.url.replace(/[-[\]{}()+?.,\\^$|#\s]/g, "\\$&").replace(/\*/g, ".+")
        ).test(n.url)
      )
        return null;
    }
    return t.data && n.data && !a(t.data, n.data)
      ? null
      : t && t.type && t.type.toLowerCase() != n.type.toLowerCase()
      ? null
      : t;
  }
  function c(n, r, i) {
    var s = (function (t) {
      return function () {
        return function () {
          ...
          if (r.dataType == "json" && typeof n.responseText == "object")
            this.responseText = JSON.stringify(n.responseText);
          ...
          if (typeof n.status == "number" || typeof n.status == "string")
            this.status = n.status;
    ...
    n.proxy
      ...
      : r.async === !1
      ? s()
      : (this.responseTimer = setTimeout(s, n.responseTime || 50));
  }
  function h(t, n, r, i) {
    ...
    return {
      ...
      getResponseHeader: function (e) {
        ...
        if (e.toLowerCase() == "last-modified")
          return t.lastModified || new Date().toString();
        if (e.toLowerCase() == "etag") return t.etag || "";
        if (e.toLowerCase() == "content-type")
          return t.contentType || "text/plain";
      },
  ...
  function p(e, t, n) {
    ...
    if ((e.data && i.test(e.data)) || i.test(e.url)) {
      ...
      var r = /^(\w+:)?\/\/([^\/?#]+)/,
        s = r.exec(e.url),
        o =
          s && ((s[1] && s[1] !== location.protocol) || s[2] !== location.host);
      e.dataType = "script";
  ...
  function d(e) {
    if (e.type.toUpperCase() === "GET")
      i.test(e.url) ||
        (e.url +=
          (/\?/.test(e.url) ? "&" : "?") + (e.jsonp || "callback") + "=?");
    else if (!e.data || !i.test(e.data))
      e.data = (e.data ? e.data + "&" : "") + (e.jsonp || "callback") + "=?";
  }
  function v(t, n, r) {
    var i = (r && r.context) || t,
      s = null;
    n.response && e.isFunction(n.response)
      ? n.response(r)
      : typeof n.responseText == "object"
      ? e.globalEval("(" + JSON.stringify(n.responseText) + ")")
      : e.globalEval("(" + n.responseText + ")");
    g(t, i, n);
    y(t, i, n);
    if (e.Deferred) {
      s = new e.Deferred();
      typeof n.responseText == "object"
        ? s.resolveWith(i, [n.responseText])
        : s.resolveWith(i, [e.parseJSON(n.responseText)]);
    }
    return s;
  }
  function m(e, t, n) {
  ...
  function b(i, s) {
    ...
    for (var f = 0; f < n.length; f++) {
      ...
      if (u.dataType === "jsonp") if ((o = p(u, a, s))) return o;
      a.cache = u.cache;
      a.timeout = u.timeout;
      a.global = u.global;
      w(a, s);
    ...
    if (e.mockjaxSettings.throwUnmocked === !0)
      throw "AJAX not mocked: " + s.url;
    return t.apply(e, [s]);
  }
  function w(e, t) {
  ...
  e.mockjaxSettings = {
    log: function (t, n) {
      if (
        t.logging === !1 ||
        (typeof t.logging == "undefined" && e.mockjaxSettings.logging === !1)
      )
        return;
