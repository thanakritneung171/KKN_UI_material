!(function (a) {
  ...
  function c(b, c) {
    (this.$select = a(b)),
      (this.options = this.mergeOptions(a.extend({}, c, this.$select.data()))),
      (this.originalOptions = this.$select.clone()[0].options),
      (this.query = ""),
      (this.searchTimeout = null),
      (this.lastToggledInput = null),
      (this.options.multiple = "multiple" === this.$select.attr("multiple")),
      (this.options.onChange = a.proxy(this.options.onChange, this)),
      (this.options.onDropdownShow = a.proxy(
        this.options.onDropdownShow,
        this
      )),
      (this.options.onDropdownHide = a.proxy(
        this.options.onDropdownHide,
        this
      )),
      (this.options.onDropdownShown = a.proxy(
        this.options.onDropdownShown,
        this
      )),
      (this.options.onDropdownHidden = a.proxy(
    ...
    (c.prototype = {
      defaults: {
        buttonText: function (b, c) {
          ...
          if (this.allSelectedText && b.length == a("option", a(c)).length)
            return this.selectAllNumber
              ? this.allSelectedText + " (" + b.length + ")"
              : this.allSelectedText;
          if (b.length > this.numberDisplayed)
            return b.length + " " + this.nSelectedText;
          var d = "";
          return (
            b.each(function () {
              var b =
                void 0 !== a(this).attr("label")
                  ? a(this).attr("label")
                  : a(this).text();
              d += b + ", ";
            }),
      ...
      buildButton: function () {
        (this.$button = a(this.options.templates.button).addClass(
        ...
        b && this.$button.attr("tabindex", b),
          this.$container.prepend(this.$button);
      },
      buildDropdown: function () {
        (this.$ul = a(this.options.templates.ul)),
      ...
      buildDropdownOptions: function () {
        this.$select.children().each(
          a.proxy(function (b, c) {
            ...
            d.prop("value") !== this.options.selectAllValue &&
              ("optgroup" === e
                ? this.createOptgroup(c)
                : "option" === e &&
                  ("divider" === d.data("role")
                    ? this.createDivider()
          ...
          a("li input", this.$ul).on(
            ...
            a.proxy(function (b) {
              ...
              this.options.selectedClass &&
                (d
                  ? c.closest("li").addClass(this.options.selectedClass)
                  : c.closest("li").removeClass(this.options.selectedClass));
              var f = c.val(),
                g = this.getOptionByValue(f),
                h = a("option", this.$select).not(g),
                i = a("input", this.$container).not(c);
              return (
                e && (d ? this.selectAll() : this.deselectAll()),
                e ||
                  (d
                    ? (g.prop("selected", !0),
                      ...
                      "active" === this.options.selectedClass &&
                        h.closest("a").css("outline", ""))
                    : g.prop("selected", !1)),
                this.$select.change(),
                this.updateButtonText(),
                this.updateSelectAll(),
                this.options.onChange(g, d),
          ...
          a("li a", this.$ul).on(
            ...
            a.proxy(function (b) {
                ...
                if (
                  ...
                  h.prop("checked", d),
                    this.options.selectedClass &&
                      h
                        .closest("li")
                        .toggleClass(this.options.selectedClass, d);
              ...
              c.is("input") &&
                !c.closest("li").is(".multiselect-item") &&
                (this.lastToggledInput = c),
                c.blur();
            }, this)
          ),
          this.$container.off("keydown.multiselect").on(
            ...
            a.proxy(function (b) {
              if (!a('input[type="text"]', this.$container).is(":focus"))
                if (9 === b.keyCode && this.$container.hasClass("open"))
                  this.$button.click();
                else {
                  var c = a(this.$container)
          ...
          this.options.enableClickableOptGroups &&
            this.options.multiple &&
            a("li.multiselect-group", this.$ul).on(
              "click",
              a.proxy(function (b) {
                b.stopPropagation();
      ...
      createOptionValue: function (b) {
        ...
        var d = this.options.optionLabel(b),
          ...
          h = a("label", g);
        h.addClass(f),
          this.options.enableHTML ? h.html(" " + d) : h.text(" " + d);
        var i = a("<input/>").attr("type", f);
        this.options.checkboxName && i.attr("name", this.options.checkboxName),
          h.prepend(i);
        var j = c.prop("selected") || !1;
        i.val(e),
          e === this.options.selectAllValue &&
            (g.addClass("multiselect-item multiselect-all"),
            i.parent().parent().addClass("multiselect-all")),
          h.attr("title", c.attr("title")),
          this.$ul.append(g),
          c.is(":disabled") &&
            i
      ...
      createOptgroup: function (b) {
        ...
        this.options.enableHTML ? a("label", d).html(c) : a("label", d).text(c),
          this.options.enableClickableOptGroups &&
            d.addClass("multiselect-group-clickable"),
          this.$ul.append(d),
          a(b).is(":disabled") && d.addClass("disabled"),
          a("option", b).each(
      ...
      buildSelectAll: function () {
        ...
        if (
          ...
          this.options.multiple &&
          a("option", this.$select).length >
            this.options.includeSelectAllIfMoreThan
        ) {
          this.options.includeSelectAllDivider &&
            this.$ul.prepend(a(this.options.templates.divider));
          var c = a(this.options.templates.li);
          a("label", c).addClass("checkbox"),
            this.options.enableHTML
              ? a("label", c).html(" " + this.options.selectAllText)
              : a("label", c).text(" " + this.options.selectAllText),
            this.options.selectAllName
              ...
              : a("label", c).prepend('<input type="checkbox" />');
          var d = a("input", c);
          d.val(this.options.selectAllValue),
            c.addClass("multiselect-item multiselect-all"),
            d.parent().parent().addClass("multiselect-all"),
            this.$ul.prepend(c),
            d.prop("checked", !1);
        }
      },
      buildFilter: function () {
        if (
          ...
          if (this.$select.find("option").length >= b) {
            if (
              ((this.$filter = a(this.options.templates.filter)),
              a("input", this.$filter).attr(
                "placeholder",
              ...
              c.on(
                ...
                a.proxy(function (b) {
                  clearTimeout(this.searchTimeout),
                    ...
                    a("li", this.$ul).show().removeClass("filter-hidden"),
                    this.updateSelectAll();
                }, this)
              ),
                this.$filter.find(".input-group").append(c);
            }
                              ...
                              a.proxy(function (b, e) {
                                ...
                                if (
                                  ...
                                  h
                                    ...
                                    ? (i = !0)
                                    : h.indexOf(this.query) > -1 && (i = !0),
                                    a(e)
                                      .toggle(i)
                                      .toggleClass("filter-hidden", !i),
        ...
        a("option", this.$select).each(
          a.proxy(function (b, c) {
            ...
            a(c).is(":selected")
              ? (d.prop("checked", !0),
                this.options.selectedClass &&
                  d.closest("li").addClass(this.options.selectedClass))
              : (d.prop("checked", !1),
                this.options.selectedClass &&
                  d.closest("li").removeClass(this.options.selectedClass)),
              a(c).is(":disabled")
                ? d
                    .attr("disabled", "disabled")
                    .prop("disabled", !0)
                    .closest("li")
                    .addClass("disabled")
                : d.prop("disabled", !1).closest("li").removeClass("disabled");
          }, this)
        ),
          this.updateButtonText(),
          this.updateSelectAll();
      ...
      select: function (b, c) {
        ...
        for (var d = 0; d < b.length; d++) {
          ...
          if (null !== e && void 0 !== e) {
            ...
            void 0 !== f &&
              ...
              this.options.selectedClass &&
                g.closest("li").addClass(this.options.selectedClass),
              g.prop("checked", !0),
              f.prop("selected", !0));
          }
        }
        this.updateButtonText(),
          this.updateSelectAll(),
          c && 1 === b.length && this.options.onChange(f, !0);
      },
      ...
      deselect: function (b, c) {
        ...
        for (var d = 0; d < b.length; d++) {
          ...
          if (null !== e && void 0 !== e) {
            ...
            void 0 !== f &&
              void 0 !== g &&
              (this.options.selectedClass &&
                g.closest("li").removeClass(this.options.selectedClass),
              g.prop("checked", !1),
              f.prop("selected", !1));
          }
        }
        this.updateButtonText(),
          this.updateSelectAll(),
          c && 1 === b.length && this.options.onChange(f, !1);
      },
      selectAll: function (b, c) {
        ...
        if (
          (b
            ? (e.prop("checked", !0),
              a("li:not(.divider):not(.disabled)", this.$ul)
                .filter(":visible")
                .addClass(this.options.selectedClass))
            : (d.prop("checked", !0),
              a("li:not(.divider):not(.disabled)", this.$ul).addClass(
                this.options.selectedClass
              )),
          f === g || b === !1)
        )
          a("option:enabled", this.$select).prop("selected", !0);
        else {
          var h = e
            .map(function () {
              return a(this).val();
      ...
      deselectAll: function (b) {
        ...
        if (b) {
          ...
          a("li input[type='checkbox']:enabled", this.$ul).prop("checked", !1),
            a("option:enabled", this.$select).prop("selected", !1),
            this.options.selectedClass &&
              a("li:not(.divider):not(.disabled)", this.$ul).removeClass(
                this.options.selectedClass
              );
      },
      rebuild: function () {
        this.$ul.html(""),
          ...
          this.updateButtonText(),
          this.updateSelectAll(),
          this.options.disableIfEmpty && a("option", this.$select).length <= 0
            ? this.disable()
            : this.enable(),
          this.options.dropRight && this.$ul.addClass("pull-right");
      },
      ...
      updateButtonText: function () {
        ...
        this.options.enableHTML
          ? a(".multiselect .multiselect-selected-text", this.$container).html(
              this.options.buttonText(b, this.$select)
            )
          : a(".multiselect .multiselect-selected-text", this.$container).text(
              this.options.buttonText(b, this.$select)
            ),
          a(".multiselect", this.$container).attr(
            "title",
            this.options.buttonTitle(b, this.$select)
          );
      },
      ...
      getOptionByValue: function (b) {
        for (
          var c = a("option", this.$select), d = b.toString(), e = 0;
          e < c.length;
          e += 1
        ) {
          var f = c[e];
      ...
      getInputByValue: function (b) {
        for (
          var c = a("li input", this.$ul), d = b.toString(), e = 0;
          e < c.length;
          e += 1
        ) {
          var f = c[e];
    ...
    (a.fn.multiselect = function (b, d, e) {
      return this.each(function () {
        ...
        f || ((f = new c(this, g)), a(this).data("multiselect", f)),
          "string" == typeof b &&
            (f[b](d, e), "destroy" === b && a(this).data("multiselect", !1));
      });
    }),
    (a.fn.multiselect.Constructor = c),
    a(function () {
