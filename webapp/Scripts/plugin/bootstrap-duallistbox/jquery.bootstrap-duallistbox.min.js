!(function (a, b, c, d) {
  ...
  function l(b, c) {
    if (b.settings.showFilterInputs) {
      ...
      (e =
        1 === c
          ? e.find("option").not(":selected")
          : e.find("option:selected")),
        e.each(function (e, f) {
          var g = a(f),
            h = !0;
          (f.text.match(d) ||
            (b.settings.filterOnValues && g.attr("value").match(d))) &&
            ((h = !1),
            b.elements["select" + c].append(
              g.clone(!0).prop("selected", g.data("_selected"))
            )),
            b.element
              .find("option")
              .eq(g.data("original-index"))
              .data("filtered" + c, h);
        }),
        j(b);
    }
  ...
  function m(b, c) {
    b.elements["select" + c].find("option").each(function (c, d) {
      ...
      b.element
        ...
        .data("_selected", e.prop("selected"));
    });
  }
  function n(b) {
    b.find("option")
    ...
    (a.fn[u] = function (b) {
      ...
      if (b === d || "object" == typeof b)
        return this.each(function () {
          a(this).is("select")
            ? a.data(this, "plugin_" + u) ||
              a.data(this, "plugin_" + u, new e(this, b))
            : a(this)
                .find("select")
                .each(function (c, d) {
