...
function ResponsiveDatatablesHelper(a, b, c) {
  "string" == typeof a ? (this.tableElement = $(a)) : (this.tableElement = a),
  ...
  (this.tableId = e.sTableId),
    (this.saveState = e.oInit.bStateSave),
    (this.cookieName =
      "DataTablesResponsiveHelper_" + this.tableId + (d ? "_" + d : "")),
    (this.lastStateExists = !1),
    (this.expandColumn = void 0),
    (this.origBreakpointsDefs = void 0),
    (this.breakpoints = {}),
    (this.options = {
...
(ResponsiveDatatablesHelper.prototype.init = function (a, b) {
  ...
  (ResponsiveDatatablesHelper.prototype.initBreakpoints = function () {
    if ((this.saveState && this.getState(), !this.lastStateExists)) {
      var a = [];
      for (var b in this.origBreakpointsDefs)
        a.push({
          name: b,
      ...
      for (var c = 0, d = 0; d < a.length; d++)
        (a[d].lowerLimit = c), (c = a[d].upperLimit);
      a.push({
        name: "always",
        lowerLimit: c,
        upperLimit: 1 / 0,
      ...
      for (d = 0, e = f.length; e > d; d++)
        this.api.columns(d).visible() &&
          (this.columnIndexes.push(d), g.push(f[d]));
      for (var h = 0; h < g.length; h++) {
        var i = $(g[h]);
        "expand" === i.attr("data-class") &&
          (this.expandColumn = this.columnIndexes[h]);
        var j = i.attr("data-hide");
        if (void 0 !== j)
          for (var k = j.split(/,\s*/), d = 0; d < k.length; d++) {
            var l = k[d];
            if ("always" === l)
              for (var b in this.breakpoints)
                "default" !== this.breakpoints[b].name &&
                  this.breakpoints[b].columnsToHide.push(this.columnIndexes[h]);
            else
              void 0 !== this.breakpoints[l] &&
                this.breakpoints[l].columnsToHide.push(this.columnIndexes[h]);
          }
      }
    }
  }),
  ...
  (ResponsiveDatatablesHelper.prototype.respond = function () {
    if (!this.disabled) {
      ...
      for (var d in this.breakpoints) {
        ...
        (!e.lowerLimit || b > e.lowerLimit) &&
          (!e.upperLimit || b <= e.upperLimit) &&
          ((this.currentBreakpoint = e.name), (c = e.columnsToHide));
      }
      var f = !1;
      ...
      f &&
        ...
        this.setState(),
        (this.skipNextWindowsWidthChange = !1)),
        this.columnsHiddenIndexes.length
          ? (this.tableElement.addClass("has-columns-hidden"),
            $("tr.detail-show", this.tableElement).each(function (b, c) {
              var d = $(c);
              0 === d.next(".row-detail").length &&
                ResponsiveDatatablesHelper.prototype.showRowDetail(a, d);
            }))
          : (this.tableElement.removeClass("has-columns-hidden"),
            $("tr.row-detail").each(function (b) {
  ...
  (ResponsiveDatatablesHelper.prototype.showHideColumns = function () {
    for (var a = 0, b = this.columnsShownIndexes.length; b > a; a++)
      this.api.column(this.columnsShownIndexes[a]).visible(!0);
    for (var a = 0, b = this.columnsHiddenIndexes.length; b > a; a++)
      this.api.column(this.columnsHiddenIndexes[a]).visible(!1);
    var c = this;
    $("tr.row-detail").each(function () {
      ResponsiveDatatablesHelper.prototype.hideRowDetail(c, $(this).prev());
    }),
      this.tableElement.hasClass("has-columns-hidden") &&
        $("tr.detail-show", this.tableElement).each(function (a, b) {
    ...
    if (!this.disabled)
      for (var b = $("td", a), c = 0, d = b.length; d > c; c++) {
        ...
        if (((e = $(e)), f === this.expandColumn)) {
          if (0 == $("span.responsiveExpander", e).length)
            switch (
              (e.prepend(this.expandIconTemplate), this.options.clickOn)
            ) {
              case "cell":
                e.on(
                  "click",
  ...
  (ResponsiveDatatablesHelper.prototype.showRowDetailEventHandler = function (
    ...
    if (!b.disabled) {
      ...
      if (c.closest("table").hasClass("has-columns-hidden")) {
        var d = c.closest("tr");
        d.hasClass("detail-show")
          ? ResponsiveDatatablesHelper.prototype.hideRowDetail(b, d)
          : ResponsiveDatatablesHelper.prototype.showRowDetail(b, d),
          d.toggleClass("detail-show"),
          a.stopPropagation();
      }
    }
  }),
  (ResponsiveDatatablesHelper.prototype.showRowDetail = function (a, b) {
    for (
      var c = a.api,
        ...
        f = $("ul", e),
        g = 0;
      g < a.columnsHiddenIndexes.length;
      g++
    ) {
      ...
      if (!a.options.hideEmptyColumnsInRowDetail || j.innerHTML.trim().length) {
        ...
        for (
          var m = $(j).contents(), n = m.clone(), o = 0, p = m.length;
          p > o;
          o++
        ) {
          var q = m[o];
          q.nodeType === Node.ELEMENT_NODE &&
            "SELECT" === q.tagName &&
            (n[o].selectedIndex = q.selectedIndex);
        }
        $(".columnValue", k).append(n).data("originalTdSource", j),
          k.attr("data-column", h);
        var r = $(j).attr("class");
        "undefined" !== r && r !== !1 && "" !== r && k.addClass(r), f.append(k);
      }
    }
    var s = a.columnIndexes.length - a.columnsHiddenIndexes.length;
    e.find("> td").attr("colspan", s),
      b.after(e),
      a.options.showDetail && a.options.showDetail(e);
  }),
  (ResponsiveDatatablesHelper.prototype.hideRowDetail = function (a, b) {
    var c = b.next(".row-detail");
    a.options.hideDetail && a.options.hideDetail(c),
  ...
  (ResponsiveDatatablesHelper.prototype.getState = function () {
    try {
      ...
      a &&
        ((this.columnIndexes = a.columnIndexes),
        (this.breakpoints = a.breakpoints),
        (this.expandColumn = a.expandColumn),
        (this.lastBreakpoint = a.lastBreakpoint),
        (this.lastStateExists = !0));
    } catch (b) {}
  }),
  (ResponsiveDatatablesHelper.prototype.setState = function () {
    var a = this.difference(
        this.lastColumnsHiddenIndexes,
        this.columnsHiddenIndexes
      ).length,
      b = this.difference(
    ...
    if (a + b > 0) {
      ...
      this.setCookie(this.cookieName, c, 72e5),
