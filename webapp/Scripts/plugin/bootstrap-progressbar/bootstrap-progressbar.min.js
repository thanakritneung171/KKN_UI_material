...
!(function (a) {
  ...
  (b.defaults = {
    ...
    (b.prototype.transition = function () {
      ...
      if ("center" === g.display_text && !e && !f) {
        (this.$back_text = e =
          a("<span>").addClass("progressbar-back-text").prependTo(d)),
          (this.$front_text = f =
            a("<span>").addClass("progressbar-front-text").prependTo(c));
        var p;
        k
          ? ((p = d.css("height")),
            e.css({ height: p, "line-height": p }),
            f.css({ height: p, "line-height": p }),
      ...
      setTimeout(function () {
        ...
        var r = setInterval(function () {
          k
            ? ((n = c.height()), (p = d.height()))
            : ((n = c.width()), (p = d.width())),
            (a = Math.round((100 * n) / p)),
            (b = Math.round((n / p) * (j - i))),
            a >= o && ((a = o), (b = h), m(), clearInterval(r)),
            "none" !== g.display_text &&
              ((q = g.use_percentage
                ? g.percent_format(a)
                : g.amount_format(b, j)),
              "fill" === g.display_text
                ? c.text(q)
                : "center" === g.display_text && (e.text(q), f.text(q))),
            c.attr("aria-valuenow", b),
            l(a);
        }, g.refresh_speed);
      }, g.transition_delay);
    });
  ...
  (a.fn.progressbar = function (c) {
    ...
    (a.fn.progressbar.Constructor = b),
