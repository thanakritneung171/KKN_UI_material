...
(function (b, f, i) {
  ...
  function m(a) {
    for (
      var a = a.attributes, b = {}, c = /^jQuery\d+/, e = 0;
      e < a.length;
      e++
    )
  ...
  function j() {
    ...
    a.is(":password") ||
      (a.data("password")
        ? ((d = a.next().show().focus()),
          b("label[for=" + a.attr("id") + "]").attr("for", d.attr("id")),
          a.remove())
        : a.realVal() == a.attr("placeholder") &&
    ...
    b.trim(a.val()).length > 0 ||
      (a.is(":password")
        ? ((c = a.attr("id") + "-clone"),
          ...
          a.before(d).hide(),
          b("label[for=" + a.attr("id") + "]").attr("for", c))
        : (a.val(placeholder), a.addClass("placeholder")));
  }
  ...
  !i && g && h
    ...
    : (!i && g && !h && (c = "textarea[placeholder]"),
      (b.fn.realVal = b.fn.val),
      (b.fn.val = function () {
        var a = b(this),
          d;
