var swfobject = (function () {
    ...
    if (0 < a)
      for (var b = 0; b < a; b++) {
        ...
        if (0 < e.pv[0]) {
          ...
          if ((c = E(c)) && typeof c.SetVariable != i)
            (g.success = !0), (g.ref = c);
          f(g);
        }
      }
  ...
  function E(a) {
    ...
    if ((a = n(a)) && "OBJECT" == a.nodeName)
      typeof a.SetVariable != i
        ? (b = a)
        : (a = a.getElementsByTagName(r)[0]) && (b = a);
    return b;
  }
  function F() {
  ...
  function J(a, b, c) {
    ...
    if (g)
      if ((typeof a.id == i && (a.id = c), e.ie && e.win)) {
        ...
        h = "";
        for (var j in b)
          b[j] != Object.prototype[j] &&
            (h += '<param name="' + j + '" value="' + b[j] + '" />');
        g.outerHTML =
    ...
    e = (function () {
      ...
      if (typeof q.plugins != i && typeof q.plugins["Shockwave Flash"] == r) {
        if (
          ...
          !(
            typeof q.mimeTypes != i &&
            q.mimeTypes[y] &&
            !q.mimeTypes[y].enabledPlugin
          )
        )
          (T = !0),
            (g = !1),
  ...
  (function () {
    e.w3 &&
      (((typeof d.readyState != i && "complete" == d.readyState) ||
        (typeof d.readyState == i &&
          (d.getElementsByTagName("body")[0] || d.body))) &&
        u(),
      s ||
        (typeof d.addEventListener != i &&
