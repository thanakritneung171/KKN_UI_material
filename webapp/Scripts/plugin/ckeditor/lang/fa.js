...
CKEDITOR.lang["fa"] = {
  ...
  common: {
    ...
    confirmCancel:
      "برخی از گزینهها تغییر کردهاند. آیا واقعا قصد بستن این پنجره را دارید؟",
    options: "گزینهها",
  ...
  bidi: { ltr: "نوشتار متن از چپ به راست", rtl: "نوشتار متن از راست به چپ" },
  ...
  templates: {
    ...
    selectPromptMsg:
      "لطفا الگوی موردنظر را برای بازکردن در ویرایشگر برگزینید<br>(محتویات کنونی از دست خواهند رفت):",
  ...
  forms: {
    ...
    hidden: { title: "ویژگیهای فیلد پنهان", name: "نام", value: "مقدار" },
    select: {
    ...
    textarea: { title: "ویژگیهای ناحیهٴ متنی", cols: "ستونها", rows: "سطرها" },
    textfield: {
  ...
  showblocks: { toolbar: "نمایش بلوکها" },
