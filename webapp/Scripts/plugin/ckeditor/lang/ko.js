...
CKEDITOR.lang["ko"] = {
  ...
  about: {
    ...
    moreInfo:
      "라이센스에 대한  정보를 보고싶다면 우리의 웹 사이트를 방문하세요:",
    title: "CKEditor에 대하여",
  ...
  clipboard: {
    copy: "복사하기",
    copyError:
      "브라우저의 보안설정때문에 복사하기 기능을 실행할 수 없습니다. 키보드 명령을 사용하십시요.  (Ctrl/Cmd+C).",
    cut: "잘라내기",
    cutError:
      "브라우저의 보안설정때문에 잘라내기 기능을 실행할 수 없습니다. 키보드 명령을 사용하십시요. (Ctrl/Cmd+X).",
    paste: "붙여넣기",
    pasteArea: "범위 붙여넣기",
    pasteMsg:
      "키보드의 (<STRONG>Ctrl/Cmd+V</STRONG>) 를 이용해서 상자안에 붙여넣고 <STRONG>OK</STRONG> 를 누르세요.",
    securityMsg:
      "브러우저 보안 설정으로 인해, 클립보드의 자료를 직접 접근할 수 없습니다. 이 창에 다시 붙여넣기 하십시오.",
    title: "붙여넣기",
  },
  colorbutton: {
    auto: "기본색상",
  ...
  templates: {
    ...
    options: "템플릿 옵션",
    selectPromptMsg:
      "에디터에서 사용할 템플릿을 선택하십시요.<br>(지금까지 작성된 내용은 사라집니다.):",
    title: "내용 템플릿",
  },
  ...
  forms: {
    ...
    hidden: { title: "숨김필드 속성", name: "이름", value: "값" },
    select: {
      title: "펼침목록 속성",
      selectInfo: "정보",
      opAvail: "선택옵션",
    ...
    textarea: { title: "입력영역 속성", cols: "칸수", rows: "줄수" },
    textfield: {
      title: "입력필드 속성",
      name: "이름",
      value: "값",
  ...
  smiley: { options: "이모티콘 옵션", title: "아이콘 삽입", toolbar: "아이콘" },
  justify: {
    block: "양쪽 맞춤",
    center: "가운데 정렬",
    left: "왼쪽 정렬",
  ...
  newpage: { toolbar: "새 문서" },
  pagebreak: { alt: "패이지 나누기", toolbar: "인쇄시 페이지 나누기 삽입" },
  pastetext: { button: "텍스트로 붙여넣기", title: "텍스트로 붙여넣기" },
  pastefromword: {
    confirmCleanup:
      "붙여 넣기 할 텍스트는 MS Word에서 복사 한 것입니다. 붙여 넣기 전에 MS Word 포멧을 삭제 하시겠습니까?",
