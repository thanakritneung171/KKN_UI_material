...
CKEDITOR.lang["el"] = {
  ...
  about: {
    ...
    moreInfo:
      "Για πληροφορίες αδειών παρακαλούμε επισκεφθείτε την ιστοσελίδα μας:",
  ...
  showblocks: { toolbar: "Προβολή Περιοχών" },
  ...
  table: {
    ...
    invalidCellPadding:
      "Το γέμισμα μέσα στα κελιά πρέπει να είναι ένας θετικός αριθμός.",
    invalidCellSpacing:
