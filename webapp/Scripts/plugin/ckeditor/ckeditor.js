...
(function () {
        ...
        fire: (function () {
          ...
          return function (j, i, l) {
            ...
            if (m) {
              var w = m.listeners;
              if (w.length)
                for (var w = w.slice(0), k, g = 0; g < w.length; g++) {
                  if (m.errorProof)
                    try {
                      k = w[g].call(this, l, i, b, h);
                    } catch (p) {}
  ...
  CKEDITOR.env ||
    (CKEDITOR.env = (function () {
      ...
      if (a.ie) {
        f =
          a.quirks || !document.documentMode
            ? parseFloat(b.match(/msie (\d+)/)[1])
      ...
      if (a.ie) {
        a.cssClass =
          a.cssClass +
          (" cke_browser_ie" + (a.quirks || a.version < 7 ? "6" : a.version));
        if (a.quirks) a.cssClass = a.cssClass + " cke_browser_iequirks";
      }
      if (a.gecko)
        if (f < 10900) a.cssClass = a.cssClass + " cke_browser_gecko18";
      ...
      extend: function (a) {
        ...
        for (var c = 1; c < f; c++) {
          var j = arguments[c],
            i;
          for (i in j)
            if (b === true || a[i] == void 0) if (!e || i in e) a[i] = j[i];
        }
        return a;
      },
          ...
          var j = b,
            b = function () {
              ...
              for (b in c) {
                var f = c[b];
                a[b] =
                  typeof f == "function" ? CKEDITOR.tools.bind(f, this) : f;
              }
  ...
  CKEDITOR.dtd = (function () {
    var b = CKEDITOR.tools.extend,
      c = function (a, b) {
        for (
          var f = CKEDITOR.tools.clone(a), d = 1;
          d < arguments.length;
          d++
        ) {
          var b = arguments[d],
  ...
  CKEDITOR.dom.event.prototype = {
    ...
    getPageOffset: function () {
      ...
      return {
        x:
          this.$.pageX ||
          this.$.clientX + (b.documentElement.scrollLeft || b.body.scrollLeft),
        y:
          this.$.pageY ||
          this.$.clientY + (b.documentElement.scrollTop || b.body.scrollTop),
      };
    },
  };
    ...
    return {
        ...
        if (!this.hasListeners(b)) {
          ...
          if (f) {
            this.$.removeEventListener
              ? this.$.removeEventListener(b, f, false)
              : this.$.detachEvent && this.$.detachEvent("on" + b, f);
            delete a[b];
          }
        }
      },
      removeAllListeners: function () {
        ...
        for (a in b) {
          var f = b[a];
          this.$.detachEvent
            ? this.$.detachEvent("on" + a, f)
            : this.$.removeEventListener &&
              this.$.removeEventListener(a, f, false);
          delete b[a];
        }
      },
    };
  ...
  CKEDITOR.dom.node = function (b) {
    return b
      ? new CKEDITOR.dom[
          b.nodeType == CKEDITOR.NODE_DOCUMENT
            ? "document"
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.node.prototype, {
    ...
    getAddress: function (b) {
      for (
        var c = [], a = this.getDocument().$.documentElement, f = this.$;
        f && f != a;
    ...
    getPreviousSourceNode: function (b, c, a) {
      ...
      return !b || (a && a(b) === false)
        ? null
        : c && b.type != c
        ? b.getPreviousSourceNode(false, c, a)
        : b;
    },
    ...
    getParent: function (b) {
      ...
      return c &&
        (c.nodeType == CKEDITOR.NODE_ELEMENT ||
          (b && c.nodeType == CKEDITOR.NODE_DOCUMENT_FRAGMENT))
        ? new CKEDITOR.dom.node(c)
        : null;
    },
  ...
  CKEDITOR.tools.extend(CKEDITOR.dom.document.prototype, {
    ...
    getById: function (b) {
      return (b = this.$.getElementById(b))
  ...
  CKEDITOR.dom.element.get = function (b) {
    return (
      (b =
        typeof b == "string"
          ? document.getElementById(b) || document.getElementsByName(b)[0]
          : b) && (b.$ ? b : new CKEDITOR.dom.element(b))
    );
  };
    ...
    CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
          ...
          ? function (a) {
              switch (a) {
                ...
                case "checked":
                  ...
                  return (a.specified ? a.nodeValue : this.$.checked)
                    ? "checked"
                    : null;
                case "hspace":
                case "value":
      ...
      isEmptyInlineRemoveable: function () {
        ...
        for (var a = this.getChildren(), b = 0, d = a.count(); b < d; b++) {
          var c = a.getItem(b);
          if (
            !(c.type == CKEDITOR.NODE_ELEMENT && c.data("cke-bookmark")) &&
            ((c.type == CKEDITOR.NODE_ELEMENT &&
              !c.isEmptyInlineRemoveable()) ||
              (c.type == CKEDITOR.NODE_TEXT &&
                CKEDITOR.tools.trim(c.getText())))
          )
            return false;
        }
        return true;
        ...
        CKEDITOR.env.ie && (CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat)
          ...
          : function () {
              var a = this.$.attributes,
                b = a.length,
                d = { "data-cke-expando": 1, _moz_dirty: 1 };
              return (
                b > 0 &&
                (b > 2 || !d[a[0].nodeName] || (b == 2 && !d[a[1].nodeName]))
              );
            },
      ...
      mergeSiblings: (function () {
        function a(a, b, c) {
          if (b && b.type == CKEDITOR.NODE_ELEMENT) {
            for (
              var h = [];
              b.data("cke-bookmark") || b.isEmptyInlineRemoveable();
      ...
      setOpacity: function (a) {
        if (CKEDITOR.env.ie && CKEDITOR.env.version < 9) {
          ...
          this.setStyle(
            ...
            a >= 100
              ? ""
              : "progid:DXImageTransform.Microsoft.Alpha(opacity=" + a + ")"
          );
      ...
      getDocumentPosition: function (a) {
        ...
        if (document.documentElement.getBoundingClientRect) {
          var i = this.$.getBoundingClientRect(),
            l = e.$.documentElement,
            m = l.clientTop || h.$.clientTop || 0,
            q = l.clientLeft || h.$.clientLeft || 0,
            w = true;
          if (CKEDITOR.env.ie) {
          ...
          for (
            e = null;
            h && !(h.getName() == "body" || h.getName() == "html");
        ...
        if (a) {
          ...
          if (!h.equals(e) && h.$.frameElement) {
            a = new CKEDITOR.dom.element(h.$.frameElement).getDocumentPosition(
              a
            );
            b = b + a.x;
            c = c + a.y;
      ...
      scrollIntoParent: function (a, b, c) {
        ...
        a instanceof CKEDITOR.dom.window &&
          (a = w ? j.getBody() : j.getDocumentElement());
        j = a.getWindow();
        h = m(this, j);
        var k = m(a, j),
          g = this.$.offsetHeight;
        ...
        if (i < 0 || h > 0)
          l(0, b === true ? i : b === false ? h : i < 0 ? i : h);
        ...
        for (var c = this.$.attributes, b = b || {}, e = 0; e < c.length; e++) {
          ...
          if (!(j in b))
            if (j == "checked" && (i = this.getAttribute(j)))
              ...
              h.specified ||
              (CKEDITOR.env.ie && h.nodeValue && j == "value")
            ) {
  ...
  CKEDITOR.dom.documentFragment = function (b) {
    ...
    this.$ =
      b.type == CKEDITOR.NODE_DOCUMENT ? b.$.createDocumentFragment() : b;
  };
  ...
  (function () {
    function b(a, b) {
      ...
      if (!a && !this._.guardLTR) {
        var t = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(),
      ...
      if (a && !this._.guardRTL) {
        var E = m.type == CKEDITOR.NODE_ELEMENT ? m : m.getParent(),
          B =
      ...
      k = g
        ...
        : r;
      if (this.current) d = this.current[e](false, p, k);
      else {
        if (a)
          d.type == CKEDITOR.NODE_ELEMENT &&
            (d =
              f > 0
                ...
                : k(d, true) === false
                ? null
                : d.getPreviousSourceNode(true, p, k));
        else {
          d = m;
          if (d.type == CKEDITOR.NODE_ELEMENT && !(d = d.getChild(q)))
            d = k(m, true) === false ? null : m.getNextSourceNode(true, p, k);
        }
        d && k(d) === false && (d = null);
      }
      for (; d && !this._.end; ) {
    ...
    CKEDITOR.dom.element.prototype.isBlockBoundary = function (b) {
      b = b
        ? CKEDITOR.tools.extend({}, CKEDITOR.dtd.$block, b || {})
        : CKEDITOR.dtd.$block;
      return (
        (this.getComputedStyle("float") == "none" &&
          a[this.getComputedStyle("display")]) ||
        b[this.getName()]
      );
    };
    ...
    CKEDITOR.dom.walker.bookmark = function (a, b) {
      function c(a) {
        return (
          a && a.getName && a.getName() == "span" && a.data("cke-bookmark")
        );
      }
      return function (d) {
        var m, q;
    ...
    function b() {
      ...
      return function (g) {
        ...
        return (g.type == CKEDITOR.NODE_TEXT &&
          ...
          (g.type == CKEDITOR.NODE_ELEMENT && !g.is(e))
          ? false
          : true;
      };
    }
      ...
      d = function (a, b, c, k) {
        ...
        if (b == 2) {
          ...
          if (
            r &&
            x &&
            (g.$.parentNode != r.$.parentNode ||
              d.$.parentNode != x.$.parentNode)
          ) {
            b = x.getIndex();
    ...
    CKEDITOR.dom.range.prototype = {
      ...
      createBookmark2: (function () {
        function a(b) {
          ...
          var m = d;
          g =
            g.type != CKEDITOR.NODE_ELEMENT || m === 0 || m == g.getChildCount()
              ? 0
              : g.getChild(m - 1).type == CKEDITOR.NODE_TEXT &&
                g.getChild(m).type == CKEDITOR.NODE_TEXT;
          if (g) {
            c = c.getChild(d - 1);
            d = c.getLength();
          }
          ...
          if (c.type == CKEDITOR.NODE_TEXT) {
            g = c;
            for (m = 0; (g = g.getPrevious()) && g.type == CKEDITOR.NODE_TEXT; )
              m = m + g.getLength();
            d = d + m;
          }
          b.container = c;
      ...
      enlarge: function (a, b) {
        switch (a) {
                  ...
                  if (h.type == CKEDITOR.NODE_TEXT) {
                    ...
                    if (j && CKEDITOR.dtd.$removeEmpty[h.getName()]) {
                      ...
                      if (/[^\s\ufeff]/.test(x)) h = null;
                        ...
                        for (
                          var l = h.$.getElementsByTagName("*"), s = 0, C;
                          (C = l[s++]);

                        )
                          if (
                            !CKEDITOR.dtd.$removeEmpty[C.nodeName.toLowerCase()]
                          ) {
                            h = null;
                            break;
                          }
          ...
          case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
            ...
            var y,
              o,
              u = CKEDITOR.dom.walker.blockBoundary(
            ...
            this.setStartAt(
              y,
              !y.is("br") &&
                ((!e && this.checkStartOfBlock()) || (e && y.contains(e)))
            ...
            this.setEndAt(
              y,
              (!e && this.checkEndOfBlock()) || (e && y.contains(e))
      ...
      shrink: function (a, b, c) {
        if (!this.collapsed) {
          ...
          if (g && g.type == CKEDITOR.NODE_TEXT)
            if (f)
              if (f >= g.getLength()) d.setStartAfter(g);
              else {
                d.setStartBefore(g);
                i = 0;
              }
      ...
      checkReadOnly: (function () {
        function a(b, c) {
          for (; b; ) {
            if (b.type == CKEDITOR.NODE_ELEMENT) {
              if (
                b.getAttribute("contentEditable") == "false" &&
                !b.data("cke-editable")
              )
                return 0;
              if (
      ...
      moveToElementEditablePosition: function (b, c) {
        ...
        for (var d = 0; b; ) {
          if (b.type == CKEDITOR.NODE_TEXT) {
            c && this.checkEndOfBlock() && l.test(b.getText())
          ...
          if (b.type == CKEDITOR.NODE_ELEMENT)
            if (b.isEditable()) {
              this.moveToPosition(
                b,
                c ? CKEDITOR.POSITION_BEFORE_END : CKEDITOR.POSITION_AFTER_START
              );
              d = 1;
            } else
              c &&
    ...
    b.prototype = {
      getNextParagraph: function (b) {
        ...
        if (!this._.started) {
          ...
          m =
            i.endContainer.hasAscendant("pre", true) ||
            i.startContainer.hasAscendant("pre", true);
          i.enlarge(
            (this.forceBrBreak && !m) || !this.enlargeBr
          ...
          if (!i.collapsed) {
            ...
            if (
              ...
              if (k.checkEndOfBlock()) {
                ...
                this._.lastNode = (k.block || k.blockLimit).getNextSourceNode(
                  true
                );
              }
            }
        ...
        for (this._.nextNode = null; k; ) {
          ...
          if (v) k.type == CKEDITOR.NODE_TEXT && a.test(k.getText()) && (v = 0);
            ...
            if (k.isBlockBoundary(this.forceBrBreak && !p && { br: 1 })) {
              if (n == "br") v = 1;
              else if (!i && !k.getChildCount() && n != "hr") {
                d = k;
                l = k.equals(m);
                break;
              }
        ...
        if (!d) {
          ...
          if (
            ...
            this._.nextNode = d.equals(m)
              ? null
              : c(i.getBoundaryNodes().endNode, 1, m);
        }
        if (q)
          (i = d.getPrevious()) &&
            ...
            (i.getName() == "br"
              ? i.remove()
              : i.getLast() &&
                i.getLast().$.nodeName.toLowerCase() == "br" &&
                i.getLast().remove());
        if (w)
          (i = d.getLast()) &&
            i.type == CKEDITOR.NODE_ELEMENT &&
            i.getName() == "br" &&
            (CKEDITOR.env.ie || i.getPrevious(f) || i.getNext(f)) &&
            i.remove();
        if (!this._.nextNode)
          this._.nextNode = l || d.equals(m) || !m ? null : c(d, 1, m);
        return d;
      },
    };
  ...
  CKEDITOR.command = function (b, c) {
    ...
    this.exec = function (a) {
      ...
      return this.fire("exec") === false
        ? true
        : c.exec.call(this, b, a) !== false;
    };
    this.refresh = function (a, b) {
      ...
      return this.fire("refresh", { editor: a, path: b }) === false
        ? true
        : c.refresh && c.refresh.apply(this, arguments) !== false;
    };
    var a;
  ...
  CKEDITOR.command.prototype = {
    enable: function () {
      this.state == CKEDITOR.TRISTATE_DISABLED &&
        this.checkAllowed() &&
        this.setState(
          !this.preserveState || typeof this.previousState == "undefined"
  ...
  (function () {
    function b(a, b, g, e, f) {
      var h = b.name;
      if (
        (e || typeof a.elements != "function" || a.elements(h)) &&
        (!a.match || a.match(b))
      ) {
        if ((e = !f)) {
          a: if (a.nothingRequired) e = true;
            ...
            if ((f = a.requiredClasses)) {
              ...
              for (e = 0; e < f.length; ++e)
                if (CKEDITOR.tools.indexOf(h, f[e]) == -1) {
                  e = false;
                  break a;
                }
            }
            e =
              ...
              d(b.attributes, a.requiredAttributes);
          }
          e = !e;
        }
        if (!e) {
    ...
    function a(a, b) {
      ...
      if (typeof a == "string") {
        ...
        return a == "*"
          ? true
          : CKEDITOR.tools.convertArrayToObject(a.split(b));
      }
      if (CKEDITOR.tools.isArray(a))
    ...
    function i(a) {
      ...
      if (!a.classes)
        a.classes = a.attributes["class"]
          ? a.attributes["class"].split(/\s+/)
          : [];
    }
    function l(a) {
      var b = a.attributes,
    ...
    function k(a) {
      return (
        a.type == CKEDITOR.NODE_ELEMENT && (a.name == "br" || B.$block[a.name])
      );
    }
    function g(a, b, c) {
      var d = a.name;
      if (B.$empty[d] || !a.children.length)
        if (d == "hr" && b == "br") a.replaceWith(w());
        else {
        ...
        if (b == "br") {
          ...
          b: {
            ...
            for (var e = 0, f = d.length, h; e < f; ++e) {
              h = d[e];
              if (h.type == CKEDITOR.NODE_ELEMENT && !g[h.name]) {
                g = false;
                break b;
              }
            }
          ...
          if (g) {
            ...
            for (
              var e =
                  g.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || g.name == "body",
                p,
                f = d.length;
              f > 0;
              ...
              if (
                ...
                (h.type == CKEDITOR.NODE_TEXT ||
                  (h.type == CKEDITOR.NODE_ELEMENT && B.$inline[h.name]))
              ) {
                if (!p) {
    ...
    CKEDITOR.filter = function (a) {
      ...
      if (a instanceof CKEDITOR.editor) {
        ...
        if (a === true) this.disabled = true;
          ...
          this._.toDataFormatListener = b.on(
            "toDataFormat",
            function (a) {
    ...
    CKEDITOR.filter.prototype = {
      allow: function (b, c, d) {
        ...
        if (typeof b == "string") b = h(b);
          ...
          for (g = 0; g < b.length; ++g) e = this.allow(b[g], c, d);
          return e;
        }
        var f,
          d = [];
      ...
      applyTo: function (a, b, c) {
              ...
              a: {
                ...
                if (k)
                  for (o = 0; o < k.length; ++o)
                    if ((n = g.match(k[o])) && n[0].length == g.length) {
                      c = true;
                      break a;
                    }
                g = CKEDITOR.htmlParser.fragment.fromHtml(g);
                g.children.length == 1 &&
                  (f = g.children[0]).type == CKEDITOR.NODE_ELEMENT &&
                  p(f, e, h, c, b);
                c = !c.length;
              }
              c || d.push(a);
        ...
        d.length && (q = true);
        for (
          var o, n, a = [], c = ["p", "br", "div"][this.enterMode - 1];
          (o = d.pop());
        ...
        for (; (n = a.pop()); ) {
          ...
          if (o.parent)
            switch (n.check) {
              case "it":
                B.$removeEmpty[o.name] && !o.children.length
                  ? g(o, c, a)
                  : m(o) || g(o, c, a);
                break;
              case "el-up":
                o.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
                  !B[o.parent.name][o.name] &&
                  g(o, c, a);
                break;
              case "parent-down":
                o.parent.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
      ...
      addContentForms: function (a) {
        if (!this.disabled && a) {
          ...
          for (b = 0; b < a.length && !g; ++b) {
            c = a[b];
            if (
              (typeof c == "string" || c instanceof CKEDITOR.style) &&
              this.check(c)
            )
              g = c;
          }
      ...
      addFeature: function (a) {
        ...
        return this.customConfig && a.requiredContent
      ...
      check: function (a, b, c) {
        ...
        f(this)(
          o,
          this._.rules,
          b === false ? false : this._.transformations,
          q,
          false,
          !c,
          !c
        ...
        b =
          q.length > 0
            ? false
            : CKEDITOR.tools.objectCompare(g.attributes, o.attributes, true)
            ? true
            : false;
        ...
        transform: function (a, b) {
          if (typeof b == "string") a.name = b;
            ...
            for (e in g)
              if (e == "class") {
                c = a.classes.join("|");
                for (h = g[e].split(/\s+/); (p = h.pop()); )
                  c.indexOf(p) == -1 && a.classes.push(p);
  ...
  CKEDITOR.resourceManager.prototype = {
    ...
    getFilePath: function (b) {
      ...
      return CKEDITOR.getUrl(
        this.getPath(b) + (c ? c.file : this.fileName + ".js")
      );
    },
    ...
    load: function (b, c, a) {
      ...
      for (
        var f = this.loaded, d = this.registered, e = [], h = {}, j = {}, i = 0;
        i < b.length;
        i++
      ) {
        var l = b[i];
            ...
            b.call(
              ...
              function (a) {
                ...
                for (j in a) {
                  ...
                  if (!c[j]) {
                    if (q.icons)
                      for (var k = q.icons.split(","), g = k.length; g--; )
                        CKEDITOR.skin.addIcon(
                          k[g],
                          q.path +
                            "icons/" +
                            (CKEDITOR.env.hidpi && q.hidpi ? "hidpi/" : "") +
                            k[g] +
                            ".png"
                        );
                    c[j] = 1;
  ...
  (function () {
    function b(b, e, f) {
      ...
      if (e !== void 0) {
        ...
        if (
          !(f == CKEDITOR.ELEMENT_MODE_INLINE
            ? e.is(CKEDITOR.dtd.$editable) || e.is("textarea")
            : f == CKEDITOR.ELEMENT_MODE_REPLACE
            ? !e.is(CKEDITOR.dtd.$nonBodyContent)
            : 1)
        )
          throw Error(
    ...
    function e(a) {
      ...
      if (c.fn) {
        ...
        (CKEDITOR.getUrl(a.config.customConfig) == b || !e(a)) &&
    ...
    function m(a) {
      ...
      CKEDITOR.plugins.load(c.split(","), function (c) {
        ...
        for (var k in c) {
          ...
          if (o && !a.lang[k]) {
            o.split && (o = o.split(","));
            if (CKEDITOR.tools.indexOf(o, a.langCode) >= 0) n = a.langCode;
            else {
              n = a.langCode.replace(/-.*/, "");
              n =
                n != a.langCode && CKEDITOR.tools.indexOf(o, n) >= 0
                  ? n
                  : CKEDITOR.tools.indexOf(o, "en") >= 0
                  ? "en"
                  : o[0];
            }
            if (!q.langEntries || !q.langEntries[n])
              f.push(CKEDITOR.getUrl(q.path + "lang/" + n + ".js"));
            else {
          ...
          for (
            ...
            for (var h = 0; h < d.length; h++) {
              ...
              f === 0 &&
                ...
                k.lang &&
                k.langEntries &&
                (a.lang[k.name] = k.langEntries[e[h]]);
              if (k[c[f]]) k[c[f]](a);
            }
    ...
    CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
      ...
      checkDirty: function () {
        return (
          this.status == "ready" && this._.previousValue !== this.getSnapshot()
        );
      },
      resetDirty: function () {
  ...
  (function () {
    ...
    CKEDITOR.htmlParser.fragment.fromHtml = function (d, e, h) {
      ...
      var k = new CKEDITOR.htmlParser(),
        g =
          e instanceof CKEDITOR.htmlParser.element
            ? e
            : typeof e == "string"
            ? new CKEDITOR.htmlParser.element(e)
        ...
        if (b(e)) p.push(e);
          ...
          if (d == "br") v.push(e);
            ...
            for (;;) {
              h = (g = t.name)
                ? CKEDITOR.dtd[g] ||
                  (t._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span)
                : f;
              if (!e.isUnknown && !t.isUnknown && !h[d])
                if (t.isOptionalClose) k.onTagClose(g);
                else if (d in a && g in a) {
                  g = t.children;
                  ((g = g[g.length - 1]) && g.name == "li") ||
                    m((g = new CKEDITOR.htmlParser.element("li")), t);
                  !e.returnPoint && (e.returnPoint = t);
                  t = g;
                } else if (d in CKEDITOR.dtd.$listItem && !w(d, g))
                  k.onTagOpen(d == "li" ? "ul" : "dl", {}, 0, 1);
                else if (g in c && !w(d, g)) {
                  !e.returnPoint && (e.returnPoint = t);
                  t = t.parent;
                } else {
                  g in CKEDITOR.dtd.$inline && p.unshift(t);
                  if (t.parent) m(t, t.parent, 1);
                  else {
                    e.isOrphan = 1;
                    break;
                  }
  ...
  (function () {
    ...
    function d(a) {
      for (
        var b = a.type || a instanceof CKEDITOR.htmlParser.fragment, c = 0;
        c < this.length;
        c++
      ) {
        if (b)
  ...
  (function () {
    function b(b, c) {
        ...
        return function (d) {
          if (d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
            var k = [],
              ...
              n;
            if (h)
              for (o(h, 1) && k.push(h); h; ) {
                if (e(h) && (p = f(h)) && o(p))
                  if ((n = f(p)) && !e(n)) k.push(p);
                  else {
                    var u = p,
                      j = g(q),
                      A = u.parent.children,
                      v = CKEDITOR.tools.indexOf(A, u);
                    A.splice(v + 1, 0, j);
                    A = u.next;
                    u.next = j;
                    j.previous = u;
            ...
            for (h = 0; h < k.length; h++) i(k[h]);
            if (
              (k =
                (CKEDITOR.env.opera && !b) ||
                (typeof c == "function" ? c(d) !== false : c))
            )
              if (
                !q &&
                CKEDITOR.env.ie &&
                ...
                (document.documentMode > 7 ||
                  d.name in CKEDITOR.dtd.tr ||
                  d.name in CKEDITOR.dtd.$listItem)
              )
                k = false;
              else {
                k = a(d);
      ...
      function o(a, b) {
        if (
          ...
          return true;
        var c;
        if (a.type == CKEDITOR.NODE_TEXT && (c = a.value.match(E))) {
          if (c.index) {
          ...
          if (!q)
            if (((c = a.previous) && c.name == "br") || !c || e(c)) return true;
        }
        return false;
      }
      var p = { elements: {} },
        q = c == "html",
        n = CKEDITOR.tools.extend({}, z),
        u;
    ...
    function e(a) {
      return (
        a &&
        ((a.type == CKEDITOR.NODE_ELEMENT && a.name in z) ||
    ...
    function t(a, b) {
      var c = b._.dataStore;
      return a
        .replace(/<\!--\{cke_protected\}([\s\S]+?)--\>/g, function (a, b) {
          return decodeURIComponent(b);
        })
    ...
    function n(a, b) {
      for (
        var c = [],
          ...
          g = b._.dataStore || (b._.dataStore = { id: 1 }),
    ...
    CKEDITOR.htmlDataProcessor = function (a) {
      ...
      a.on(
        ...
        function (b) {
          ...
          d = g(d);
          d = v(d);
          b.dataValue = CKEDITOR.htmlParser.fragment.fromHtml(
            d,
            b.context,
      ...
      a.on(
        "toDataFormat",
        function (b) {
          b.data.dataValue = CKEDITOR.htmlParser.fragment.fromHtml(
            b.data.dataValue,
            a.editable().getName(),
            c(a.config)
          );
    ...
    var E = /(?:&nbsp;|\xa0)$/,
      ...
      s = { elements: {}, attributeNames: [[/^on/, "data-cke-pa-on"]] },
      C = {
        elementNames: [
          [/^cke:/, ""],
          [/^\?xml:namespace$/, ""],
    ...
    for (var y in { input: 1, textarea: 1 }) {
      s.elements[y] = m;
      C.elements[y] = q;
    }
    var o = /<(a|area|img|input|source)\b([^>]*)>/gi,
      u =
        /\s(on\w+|href|src|name)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi,
      I =
  ...
  CKEDITOR.htmlParser.cssStyle = function (b) {
    ...
    ((b instanceof CKEDITOR.htmlParser.element ? b.attributes.style : b) || "")
      .replace(/&quot;/g, '"')
      .replace(/\s*([^ :;]+)\s*:\s*([^;]+)\s*(?=;|$)/g, function (a, b, d) {
  ...
  (function () {
    ...
    CKEDITOR.inlineAll = function () {
      ...
      for (a in CKEDITOR.dtd.$editable)
        for (
          var f = CKEDITOR.document.getElementsByTag(a), d = 0, e = f.count();
          d < e;
          d++
        ) {
          b = f.getItem(d);
          if (b.getAttribute("contenteditable") == "true") {
            c = { element: b, config: {} };
            CKEDITOR.fire("inline", c) !== false &&
              CKEDITOR.inline(b, c.config);
          }
        }
    };
    CKEDITOR.domReady(function () {
  ...
  (function () {
    function b(b, e, f, j) {
      ...
      i.on("loaded", function () {
        a(i);
        j == CKEDITOR.ELEMENT_MODE_REPLACE &&
          i.config.autoUpdateElement &&
          b.$.form &&
          i._attachToForm();
    ...
    CKEDITOR.editor.prototype.resize = function (a, b, c, f) {
      ...
      l.setStyle(
        "height",
        Math.max(
          b - (c ? 0 : (f.$.offsetHeight || 0) - (l.$.clientHeight || 0)),
          0
        ) + "px"
      );
      m && (m.style.width = "100%");
  ...
  (function () {
    function b(b) {
      ...
      if (CKEDITOR.env.gecko) {
        var n = g.block || g.blockLimit || g.root,
          i = n && n.getLast(a);
        n &&
          n.isBlockBoundary() &&
          (!i || !(i.type == CKEDITOR.NODE_ELEMENT && i.isBlockBoundary())) &&
          !n.is("pre") &&
          !n.getBogus() &&
          n.appendBogus();
      }
      if (
        c.config.autoParagraph !== false &&
        h != CKEDITOR.ENTER_BR &&
        f.collapsed &&
        d.equals(e) &&
        !g.block
        ...
        if (
          ...
          c = f.fixBlock(
            true,
            c.config.enterMode == CKEDITOR.ENTER_DIV ? "div" : "p"
          );
          if (CKEDITOR.env.ie)
            (c = c.getFirst(a)) &&
              c.type == CKEDITOR.NODE_TEXT &&
    ...
    function f(a, b) {
      return function (c) {
        var d = CKEDITOR.dom.element.get(
    ...
    CKEDITOR.editable = CKEDITOR.tools.createClass({
      ...
      proto: {
        ...
        insertText: function (a) {
          ...
          a = a.replace(/\n/g, "<br>");
          b ||
            (a = a.replace(RegExp("<br>(?=</" + c + ">)"), function (a) {
              return d.repeat(a, 2);
            }));
          a = a.replace(/^ | $/g, "&nbsp;");
          a = a
          ...
          for (
            ...
            if (!n.checkReadOnly()) {
              ...
              if (j)
                for (
                  ;
                  (x = n.getCommonAncestor(0, 1)) &&
                  (z = CKEDITOR.dtd[x.getName()]) &&
                  (!z || !z[i]);

                )
                  if (x.getName() in CKEDITOR.dtd.span) n.splitElement(x);
        ...
        setup: function () {
          ...
          if (!this.is("textarea")) {
            ...
            this.attachListener(this, "click", function (a) {
              var a = a.data,
                b = new CKEDITOR.dom.elementPath(a.getTarget(), this).contains(
                  "a"
                );
              ...
              if (c in { 8: 1, 46: 1 }) {
                ...
                if ((e = d(e))) {
                  ...
                  if (
                    ...
                    f.blockLimit &&
                    f.blockLimit.is("td") &&
                    (k = f.blockLimit.getAscendant("table")) &&
                    b.checkBoundaryOfElement(
                      k,
                      c ? CKEDITOR.START : CKEDITOR.END
                    ) &&
                    (j = k[c ? "getPrevious" : "getNext"](i))
                  ) {
                    a.fire("saveSnapshot");
                    b["moveToElementEdit" + (c ? "End" : "Start")](j);
    ...
    var m = (function () {
      ...
      function c(a, d) {
        ...
        for (
          ...
          if (b(g)) {
            f = g.getName();
            if (B && f in CKEDITOR.dtd.$list) k = k.concat(c(g, d));
            else {
              h = !!n[f];
              if (f == "br" && g.data("cke-eol") && (!p || p == m - 1)) {
                E =
                  (e = p ? k[p - 1].node : j.getItem(p + 1)) &&
                  (!b(e) || !e.is("br"));
      ...
      function g(a) {
        return (
          a &&
          b(a) &&
          (a.is(i.$removeEmpty) || (a.is("a") && !a.isBlockBoundary()))
        );
      }
      function e(a, c, d, g) {
        var f = a.clone(),
        ...
        if (
          (h = new CKEDITOR.dom.walker(f).next()) &&
          b(h) &&
          n[h.getName()] &&
          (k = h.getPrevious()) &&
          b(k) &&
      ...
      var i = CKEDITOR.dtd,
        ...
        m = CKEDITOR.tools.extend({}, i.$inline);
      delete m.br;
      return function (n, l, z) {
        ...
        if (!C.checkReadOnly()) {
          var o =
              new CKEDITOR.dom.elementPath(C.startContainer, C.root)
                .blockLimit || C.root,
            l = {
              type: l,
              dontFilter: y,
          ...
          if (
            l.type == "text" &&
            s.shrink(CKEDITOR.SHRINK_ELEMENT, true, false)
          ) {
            u = CKEDITOR.dom.element.createFromHtml(
              "<span>&nbsp;</span>",
              s.document
            );
            s.insertNode(u);
          ...
          for (
            ...
            (D =
              b(s.startContainer) &&
              s.startContainer.getChild(s.startOffset - 1)) &&
            b(D) &&
            D.isBlockBoundary() &&
            I.contains(D);

          )
            s.moveToPosition(D, CKEDITOR.POSITION_BEFORE_END);
            ...
            for (f(I, F); u < I.length; u++) {
              ...
              if ((A = G.isLineBreak)) {
                ...
                if (G.hasBlockSibling) A = 1;
                  ...
                  if (!M || !M.is({ div: 1, p: 1 })) A = 0;
                  else {
                    R = M.getPosition(K);
                    if (
                      R == CKEDITOR.POSITION_IDENTICAL ||
                      R == CKEDITOR.POSITION_CONTAINS
                    )
                      A = 0;
                    else {
                      K = A.splitElement(M);
              ...
              if (A) y = u > 0;
                ...
                if (
                  !G.isBlock &&
                  (N =
                    l.editor.config.enterMode != CKEDITOR.ENTER_BR &&
                ...
                if (G.lastNotAllowed && u < I.length - 1) {
                  (O = Q ? o : O) &&
                    F.setEndAt(O, CKEDITOR.POSITION_AFTER_START);
                  s = 0;
                }
                F.collapse();
              }
          ...
          if (!l.dontMoveCaret) {
            for (
              H =
                b(J.startContainer) &&
                J.startContainer.getChild(J.startOffset - 1);
              H && b(H) && !H.is(i.$empty);
  ...
  (function () {
    ...
    CKEDITOR.on("instanceCreated", function (a) {
      ...
      f.on("contentDom", function () {
        ...
        if (CKEDITOR.env.ie || CKEDITOR.env.opera || i) {
          ...
          q
            ? g.attachListener(g, "beforedeactivate", m, null, null, -1)
            : g.attachListener(f, "selectionCheck", m, null, null, -1);
          g.attachListener(
            g,
            "blur",
            function () {
        ...
        if (CKEDITOR.env.ie && !i) {
          ...
          g.attachListener(g, "mousedown", function (a) {
            a.data.$.button == 2 &&
              f.document.$.selection.type == "None" &&
              (w = f.window.getScrollPosition());
          });
              ...
              k.on("mousedown", function (a) {
                function b(a) {
                  ...
                  if (g) {
                    ...
                    g.setEndPoint(
                      f.compareEndPoints("StartToStart", c) < 0
                        ? "EndToEnd"
                        : "StartToStart",
                      c
                    );
        ...
        if (
          i ? CKEDITOR.env.webkit || CKEDITOR.env.gecko : CKEDITOR.env.opera
        ) {
          var o;
          g.attachListener(g, "mousedown", function () {
            o = 1;
          ...
          g.attachListener(
            CKEDITOR.env.ie ? g : a.getDocumentElement(),
            "mouseup",
            c,
            f
          );
        ...
        b.on(
          ...
          function () {
            var a = b.editable(),
              c = d(a);
            c &&
              (c.getCustomData("ready") ? e(a) : c.setCustomData("ready", 1));
          },
          null,
          null,
          -1
    ...
    CKEDITOR.dom.selection = function (a) {
      ...
      if (CKEDITOR.env.webkit)
        ((b.type == "None" && this.document.getActive().equals(a)) ||
          (b.type == "Caret" &&
            b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT)) &&
          j(a, b);
      else if (CKEDITOR.env.gecko)
        b &&
          this.document.getActive().equals(a) &&
          b.anchorNode &&
          b.anchorNode.nodeType == CKEDITOR.NODE_DOCUMENT &&
          j(a, b, true);
        ...
        if (q)
          b.type == "None" &&
            c &&
            c.equals(this.document.getDocumentElement()) &&
            j(a, null, true);
        else {
    ...
    CKEDITOR.dom.selection.prototype = {
        ...
        : function () {
            ...
            if (!c || !c.rangeCount) b = CKEDITOR.SELECTION_NONE;
              ...
              if (
                ...
                w[d.childNodes[c.startOffset].nodeName.toLowerCase()]
              )
          ...
          ? (function () {
              ...
              var b = function (b, c) {
                ...
                for (
                  ...
                  m = k.compareEndPoints("StartToStart", b);
                  if (m > 0) l = j - 1;
                  else if (m < 0) i = j + 1;
                ...
                k.setEndPoint(m > 0 ? "StartToStart" : "EndToStart", b);
                k = k.text.replace(/(\r\n|\r)/g, "\n").length;
                ...
                return {
                  container: o,
                  offset: m > 0 ? -k : o.nodeValue.length + k,
                };
              };
              return function () {
              ...
              if (!f.collapsed) {
                if (f.startContainer.isReadOnly())
                  for (var b = f.startContainer, h; b; ) {
                    if (
                      ((h = b.type == CKEDITOR.NODE_ELEMENT) && b.is("body")) ||
                      !b.isReadOnly()
                    )
                      break;
                    h &&
                ...
                h &&
                  h.type == CKEDITOR.NODE_TEXT &&
                  (l ? j.setEndAfter(h) : j.setEndBefore(h));
            ...
            if (q) {
              ...
              for (d = 0; d < a.length; d++) {
                ...
                if (
                  ...
                  if (
                    (!l && !c && i.is(CKEDITOR.dtd.$removeEmpty)) ||
      ...
      getCommonAncestor: function () {
        ...
        return a[0].startContainer.getCommonAncestor(
    ...
    if (!a) {
      ...
      this.on("selectionChange", function (b) {
        for (var c = 0; c < a.length; c++) {
          var e = a[c],
            h = e.style.checkActive(b.data.path)
  ...
  (function () {
        ...
        for (m.getPosition(j) == CKEDITOR.POSITION_FOLLOWING && (m = 0); m; ) {
          ...
          if (m.equals(j)) {
            ...
            var r = m.type,
              ...
              n = s && m.getAttribute("contentEditable") == "false",
            ...
            if (
              ...
              if (
                v &&
                ((v.getDtd() || CKEDITOR.dtd.span)[d] || f) &&
                (!e.parentRule || e.parentRule(v))
              ) {
                if (
                  !q &&
                  (!s ||
                ...
                if (
                  r == CKEDITOR.NODE_TEXT ||
                  n ||
                  (r == CKEDITOR.NODE_ELEMENT && !m.getChildCount())
                ) {
                  for (
                    var r = m, x;
                    (g = !r.getNext(C)) &&
                    ((x = r.getParent()), i[x.getName()]) &&
                    (x.getPosition(k) |
                      CKEDITOR.POSITION_FOLLOWING |
                      CKEDITOR.POSITION_IDENTICAL |
                      CKEDITOR.POSITION_IS_CONTAINED) ==
            ...
            for (
              ...
              if (t.getName() == d) {
                for (y in e.attributes)
                  if (!z[y] && (E = t.getAttribute(B)))
                    g.getAttribute(y) == E ? (s[y] = 1) : (z[y] = 1);
                for (B in e.styles)
                  if (!v[B] && (E = t.getStyle(B)))
                    g.getStyle(B) == E ? (r[B] = 1) : (v[B] = 1);
              }
              t = t.getParent();
            }
            for (y in s) g.removeAttribute(y);
            for (B in r) g.removeStyle(B);
            n && !g.hasAttributes() && (g = null);
            if (g) {
    ...
    function a(a) {
      ...
      if (a.collapsed) {
        for (
          var d = new CKEDITOR.dom.elementPath(c.getParent(), a.root),
            e,
            f = 0,
            g;
          f < d.elements.length && (g = d.elements[f]);
          f++
        ) {
          ...
          if (this.checkElementRemovable(g)) {
            ...
            if (
              ...
              (a.checkBoundaryOfElement(g, CKEDITOR.END) ||
                (h = a.checkBoundaryOfElement(g, CKEDITOR.START)))
            ) {
              e = g;
              e.match = h ? "start" : "end";
            } else {
          ...
          d = function () {
            for (
              var a = new CKEDITOR.dom.elementPath(c.getParent()),
                b = new CKEDITOR.dom.elementPath(i.getParent()),
                d = null,
                e = null,
                f = 0;
              f < a.elements.length;
    ...
    function q(a) {
      ...
      for (f in c)
        if (
          !(
            (f == "class" || this._.definition.fullMatch) &&
            a.getAttribute(f) != E(f, c[f])
          )
        ) {
          e = a.hasAttribute(f);
          a.removeAttribute(f);
      ...
      for (var h in b)
        if (
          !(this._.definition.fullMatch && a.getStyle(h) != E(h, b[h], true))
        ) {
          e = e || !!a.getStyle(h);
          a.removeStyle(h);
        }
    ...
    function w(a) {
      for (
        var b = n(this), c = a.getElementsByTag(this.element), d = c.count();
        --d >= 0;
    ...
    if (this._.stylesDefinitions) b(this._.stylesDefinitions);
      ...
      if (a === false) b(null);
        ...
        CKEDITOR.stylesSet.addExternal(
          f,
          a[1] ? a.slice(1).join(":") : CKEDITOR.getUrl("styles.js"),
          ""
        );
  ...
  (function () {
    function b(a, b, c) {
      ...
      if (h.equals(i.getPrevious())) {
        b.startOffset =
          b.startOffset - h.getLength() - a.getPrevious().getLength();
        h = a.getNext();
              ...
              if (h)
                for (var l = 0; a[e + l + 1]; ) {
                  for (
                    var m = j.document,
                      h = 0,
                      i = m.getById(c[l].endNode),
                      m = m.getById(c[l + 1].startNode);
                    ;
                    ...
                    if (m.equals(i)) h = 1;
                      ...
                      b(i) ||
                      (i.type == CKEDITOR.NODE_ELEMENT && i.isBlockBoundary())
                    )
                      continue;
                    break;
                  }
    ...
    function c(a) {
      ...
      if (c)
        for (
          ...
          if (
            d.ie &&
            (f.replace(/^ie/, "") == d.version || (d.quirks && f == "iequirks"))
          )
            f = "ie";
          if (d[f]) {
            a = a + ("_" + c[e]);
    ...
    function d(a, b, c) {
      ...
      for (var h = 0; h < a.length; h++)
        if (CKEDITOR.env.webkit)
          ...
          for (d = 0; d < c.length; d++) f = f.replace(c[d][0], c[d][1]);
          CKEDITOR.env.ie
            ? (a[h].$.styleSheet.cssText = a[h].$.styleSheet.cssText + f)
            : (a[h].$.innerHTML = a[h].$.innerHTML + f);
        }
    }
    var e = {};
    CKEDITOR.skin = {
  ...
  (function () {
    if (CKEDITOR.env.webkit) CKEDITOR.env.hc = false;
      ...
      try {
        CKEDITOR.env.hc =
          b.getComputedStyle("border-top-color") ==
          b.getComputedStyle("border-right-color");
      } catch (c) {
...
*/
    ...
    var b = (function () {
        return function (b, e) {
          for (var a = b.match(/[^#]./g), c = 0; 3 > c; c++) {
            ...
            d = (
              "0" +
              (0 > e ? 0 | (d * (1 + e)) : 0 | (d + (255 - d) * e)).toString(16)
            ).slice(-2);
            f[h] = d;
          }
          return "#" + a.join("");
              ...
              CKEDITOR.ui.dialog.uiElement.call(
                ...
                function () {
                  ...
                  "horizontal" != a.labelLayout
                    ? f.push(
                        '<label class="cke_dialog_ui_labeled_label' + d + '" ',
                        ' id="' + c.labelId + '"',
                ...
                function () {
                  for (
                    var d = [],
                      ...
                      g = a.id
                        ? a.id + "_radio"
                        : CKEDITOR.tools.getNextId() + "_radio",
                      k = 0;
                    k < a.items.length;
                    k++
                  ) {
            ...
            if (!(3 > arguments.length)) {
              ...
              CKEDITOR.ui.dialog.labeledElement.call(
                ...
                function () {
                  ...
                  for (
                    var k = 0, j;
                    k < a.items.length && (j = a.items[k]);
                    k++
                  )
                    h.push(
                      '<option value="',
                      CKEDITOR.tools
                        .htmlEncode(j[1] !== void 0 ? j[1] : j[0])
                        .replace(/"/g, "&quot;"),
                      '" /> ',
  ...
  (function () {
    ...
    function R(a) {
      var a = CKEDITOR.dom.element.createFromHtml(
          CKEDITOR.addTemplate("dialog", S).output({
      ...
      if (CKEDITOR.env.ie && !CKEDITOR.env.ie6Compat) {
        ...
        CKEDITOR.dom.element
          .createFromHtml(
            '<iframe frameBorder="0" class="cke_iframe_shim" src="' +
              e +
              '" tabIndex="-1"></iframe>'
          )
    ...
    var s = CKEDITOR.tools.cssLength,
      S =
        '<div class="cke_reset_all {editorId} {editorDialogClass} {hidpi}" dir="{langDir}" lang="{langCode}" role="dialog" aria-labelledby="cke_dialog_title_{id}"><table class="cke_dialog ' +
        CKEDITOR.env.cssClass +
    ...
    CKEDITOR.dialog = function (a, b) {
      ...
      function d(a) {
        ...
        if (!(1 > b.length)) {
          ...
          for (
            var d = (c = (c + a + b.length) % b.length);
            a &&
            !b[d].isFocusable() &&
            !((d = (d + a + b.length) % b.length), d == c);
      ...
      function e(b) {
        if (l == CKEDITOR.dialog._.currentTop) {
          ...
          if (9 == c || c == CKEDITOR.SHIFT + 9)
            (c = c == CKEDITOR.SHIFT + 9),
              l._.tabBarMode
                ? ((c = c ? p.call(l) : u.call(l)),
                  l.selectPage(c),
                  l._.tabs[c][0].focus())
                : d(c ? -1 : 1),
              (o = 1);
      ...
      CKEDITOR.event.call(this);
      this.definition = f = CKEDITOR.fire(
        "dialogDefinition",
        { name: b, definition: f },
        a
      ).definition;
      ...
      this.on(
        ...
        function (b) {
          C(function (c) {
            if (c.isChanged())
              return (
                confirm(a.lang.common.confirmCancel) || (b.data.hide = !1), !0
              );
          });
        },
        this,
      ...
      this.on("hide", function () {
        ...
        (CKEDITOR.env.opera || CKEDITOR.env.gecko) &&
          v.removeListener("keypress", g);
        C(function (a) {
          Q.apply(a);
        });
      });
      ...
      U(this);
      V(this);
      new CKEDITOR.dom.text(f.title, CKEDITOR.document).appendTo(
        this.parts.title
      );
      ...
      this.parts.tabs.on(
        ...
        function (a) {
          ...
          b.hasClass("cke_dialog_tab") &&
            ...
            this._.tabBarMode &&
              ((this._.tabBarMode = !1), (this._.currentFocusIndex = -1), d(1)),
            a.data.preventDefault());
        },
        this
      );
    ...
    CKEDITOR.dialog.prototype = {
      ...
      resize: (function () {
        return function (a, b) {
          if (
            !this._.contentSize ||
            !(this._.contentSize.width == a && this._.contentSize.height == b)
          )
      ...
      move: function (a, b, c) {
        ...
        if (
          !g ||
          !this._.position ||
          !(this._.position.x == a && this._.position.y == b)
        )
      ...
      addPage: function (a) {
        if (
          ...
          for (
            var b = [],
              c = a.label
                ? ' title="' + CKEDITOR.tools.htmlEncode(a.label) + '"'
                : "",
            ...
            !d.notAllowed && "hbox" != d.type && "vbox" != d.type && f++,
              (e[d.id] = d),
          ...
          a.accessKey &&
            (O(this, this, "CTRL+" + a.accessKey, Y, Z),
      ...
      hidePage: function (a) {
        ...
        b &&
          1 != this._.pageCount &&
          b.isVisible() &&
          (a == this._.currentTabId && this.selectPage(p.call(this)),
          b.hide(),
          this._.pageCount--,
          this.updateStyle());
      },
    ...
    var G,
      ...
      X = function (a) {
        for (var b in t) {
          for (var c = t[b], d = c.length - 1; 0 <= d; d--)
        ...
        uiElement: function (a, b, c, d, e, g, f) {
          if (!(4 > arguments.length)) {
            ...
            this.accessKeyUp &&
              this.accessKeyDown &&
              b.accessKey &&
              O(this, a, "CTRL+" + b.accessKey);
            var p = this;
            a.on("load", function () {
              var b = p.getInputElement();
              if (b) {
                var c =
                  p.type in { checkbox: 1, ratio: 1 } &&
                  CKEDITOR.env.ie &&
        ...
        functions: function () {
          ...
          return function () {
            ...
            for (g = 0; g < e.length; g++)
              i = d == CKEDITOR.VALIDATE_AND ? i && e[g](b) : i || e[g](b);
            return !i ? c : !0;
          };
        },
        regex: function (a, b) {
  ...
  (function () {
      ...
      if (!a.isReadOnly() && !a.equals(d.editable())) {
        ...
        if (
          ...
          a.removeStyle("direction"),
            b
              ? (a.removeAttribute("dir"),
                f != a.getComputedStyle("direction") &&
        ...
        exec: function (f) {
          ...
          if (c && c.length) {
            for (
              ...
              if (
                !i ||
                (i && !(i.type == CKEDITOR.NODE_ELEMENT && i.getName() in o))
              )
                i = r(g, p, b);
              i && n(i, a, f, h);
              ...
              k.evaluator = function (a) {
                return !!(
                  ...
                  a.getName() in p &&
                  !(
                    a.getName() == (b == CKEDITOR.ENTER_P ? "p" : "div") &&
                    a.getParent().type == CKEDITOR.NODE_ELEMENT &&
                    "blockquote" == a.getParent().getName()
                  ) &&
                  a.getPosition(l) & CKEDITOR.POSITION_FOLLOWING &&
                  (a.getPosition(m) &
                    (CKEDITOR.POSITION_PRECEDING +
                      CKEDITOR.POSITION_CONTAINS)) ==
                    CKEDITOR.POSITION_PRECEDING
    ...
    for (
      var j = CKEDITOR.dom.element.prototype,
        l = ["setStyle", "removeStyle", "setAttribute", "removeAttribute"],
        k = 0;
      k < l.length;
      k++
    )
          ...
          if (a == CKEDITOR.TRISTATE_OFF) {
            ...
            for (b = e.length - 1; 0 <= b; b--) {
              ...
              a: {
                d = c;
                for (
                  var f = 0, k = d.getChildCount(), j = void 0;
                  f < k && (j = d.getChild(f));
                  f++
                )
  ...
  (function () {
    function w(a) {
      function b() {
        ...
        CKEDITOR.env.ie &&
          d.on("paste", function (d) {
            r ||
              ...
              u(d),
              k("paste") || a.openDialog("paste"));
          });
        CKEDITOR.env.ie &&
          (d.on("contextmenu", h, null, null, 0),
          d.on(
            "beforepaste",
            function (a) {
        ...
        var v;
        d.attachListener(
          CKEDITOR.env.ie ? d : a.document.getDocumentElement(),
          "mouseup",
          function () {
      ...
      function l() {
        if (CKEDITOR.env.ie && !CKEDITOR.env.quirks) {
          var d = a.getSelection(),
            ...
            e;
          if (
            d.getType() == CKEDITOR.SELECTION_ELEMENT &&
        ...
        if (!c.getById("cke_pastebin")) {
            ...
            : (CKEDITOR.env.webkit
                ? (e.append(j),
                  ...
                  e.is("body") ||
                    ...
                    (g = i.getDocumentPosition().y)))
                : e
                    .getAscendant(
                      CKEDITOR.env.ie || CKEDITOR.env.opera ? "body" : "html",
                      1
                    )
                    .append(j),
              j.setStyles({
          ...
          setTimeout(function () {
            if (CKEDITOR.env.webkit || CKEDITOR.env.opera)
              CKEDITOR.document[
                CKEDITOR.env.webkit ? "getBody" : "getDocumentElement"
              ]().$.scrollTop = m;
            f && f.removeListener();
      ...
      function o() {
        if (CKEDITOR.env.ie) {
          ...
          try {
            if (
              a.editable().fire(q) &&
              !a.document.$.execCommand("Paste", !1, null)
            )
              throw 0;
          } catch (b) {
            return !1;
      ...
      function u(d) {
        ...
        i(d, function (a) {
          a = a.replace(/<span[^>]+data-cke-bookmark[^<]*?<\/span>/gi, "");
          c && g(b.type, a, 0, 1);
        });
      }
      function s() {
      ...
      function n(b) {
        ...
        if ("Paste" == b) {
          ...
          (b = a.getSelection()),
            (c = b.getRanges()),
            (c =
              b.getType() != CKEDITOR.SELECTION_NONE &&
      ...
      a.getClipboardData = function (b, c) {
        ...
        !1 === o() &&
          ...
          f && a.fire("pasteDialog", i)
            ? (a.on("pasteDialogCommit", l),
    ...
    function y(a, b) {
      ...
      CKEDITOR.env.webkit &&
        ...
        (b = b.replace(/<\/?div>/g, "")));
      if (
        (CKEDITOR.env.gecko || CKEDITOR.env.opera) &&
        ...
        a.on(
          ...
          function (a) {
            ...
            CKEDITOR.env.ie
              ...
              : CKEDITOR.env.webkit
              ? (b = b.replace(/<\/(\w+)><div><br><\/div>$/, function (b, c) {
                  if (c in f) {
  ...
  (function () {
    var c =
      '<a id="{id}" class="cke_button cke_button__{name} cke_button_{state} {cls}"' +
    ...
    CKEDITOR.env.gecko &&
      (c += ' onblur="this.style.cssText = this.style.cssText;"');
    var c =
        c +
        ...
        this.getHolderElement = function () {
          ...
          if (!a) {
            if (this.isFramed) {
              ...
              a.on(
                "key" + (CKEDITOR.env.opera ? "press" : "down"),
                function (a) {
      ...
      _: {
        markItem: function (a) {
          -1 != a &&
            ...
            (CKEDITOR.env.webkit || CKEDITOR.env.opera) &&
      ...
      proto: {
        ...
        onKeyDown: function (a) {
          ...
          switch (b) {
            case "next":
              for (
                var a = this._.focusIndex,
                  b = this.element.getElementsByTag("a"),
                  c;
                (c = b.getItem(++a));
  ...
  (function () {
    function o(a, b, c, h, g) {
      var g = CKEDITOR.tools.genKey(
        ...
        e = i[g];
      e ||
        ((e = i[g] = new CKEDITOR.ui.panel(b, h)),
        (e.element = c.append(
          CKEDITOR.dom.element.createFromHtml(e.render(a), b)
        )),
      ...
      proto: {
        ...
        showBlock: function (a, b, c, h, g) {
          ...
          var d = this.element,
            ...
            a = CKEDITOR.env.ie
              ? a
              : new CKEDITOR.dom.window(a.$.contentWindow),
            j = d.getDocument(),
              ...
              var a = CKEDITOR.tools.bind(function () {
                ...
                if (k.autoSize) {
                  ...
                  CKEDITOR.env.ie &&
                    ...
                    (a =
                      a +
                      ((d.$.offsetWidth || 0) - (d.$.clientWidth || 0) + 3));
                  ...
                  CKEDITOR.env.ie &&
                    ...
                    (a =
                      a +
                      ((d.$.offsetHeight || 0) - (d.$.clientHeight || 0) + 3));
                ...
                if (CKEDITOR.env.ie) {
                  ...
                  b.getComputedStyle("direction") == "rtl" &&
                    (f = CKEDITOR.env.ie8Compat
                      ? f -
                        d.getDocument().getDocumentElement().$.scrollLeft * 2
                      : f - (a.$.scrollWidth - a.$.clientWidth));
                }
                var a = d.getFirst(),
                  j;
                (j = a.getCustomData("activePanel")) &&
                  j.onHide &&
                  j.onHide.call(this, 1);
  ...
  CKEDITOR.plugins.add("colorbutton", {
    ...
    init: function (c) {
      ...
      function o(l, g, e) {
        var h = [],
          ...
          j = CKEDITOR.tools.addFunction(function (a, b) {
            if ("?" == a) {
              ...
              c.fire("saveSnapshot");
              c.removeStyle(
                new CKEDITOR.style(i["colorButton_" + b + "Style"], {
                  color: "inherit",
                })
              );
              if (a) {
                ...
                f.childRule =
                  "back" == b
                    ...
                    : function (a) {
                        return (
                          !(a.is("a") || a.getElementsByTag("a").count()) ||
                          n(a)
                        );
                      };
        ...
        h.push(
          '<a class="cke_colorauto" _cke_focus=1 hidefocus=true title="',
          f.auto,
          ...
          e,
          '"></span></td><td colspan=7 align=center>',
          f.auto,
        ...
        for (e = 0; e < k.length; e++) {
          ...
          h.push(
            '<td><a class="cke_colorbox" _cke_focus=1 hidefocus=true title="',
            a,
            '" onclick="CKEDITOR.tools.callFunction(',
            j,
            ",'",
            ...
            "'); return false;\" href=\"javascript:void('",
            a,
            '\')" role="option"><span class="cke_colorbox" style="background-color:#',
            d,
            '"></span></a></td>'
          );
        }
        ((c.plugins.colordialog && void 0 === i.colorButton_enableMore) ||
          i.colorButton_enableMore) &&
          h.push(
            '</tr><tr><td colspan=8 align=center><a class="cke_colormore" _cke_focus=1 hidefocus=true title="',
            f.more,
            '" onclick="CKEDITOR.tools.callFunction(',
            j,
            ",'?','",
      ...
      CKEDITOR.env.hc ||
        (m("TextColor", "fore", f.textColorTitle, 10),
        m("BGColor", "back", f.bgColorTitle, 20));
    },
  });
  ...
  CKEDITOR.plugins.add("menu", {
    ...
    beforeInit: function (k) {
      for (
        var g = k.config.menu_groups.split(","),
          m = (k._.menuGroups = {}),
          l = (k._.menuItems = {}),
          a = 0;
        a < g.length;
          ...
          for (var e = 0; e < j.length; e++) {
            ...
            if (i)
              for (var f in i) {
                ...
                if (
                  h &&
                  (!h.command || this.editor.getCommand(h.command).state)
                )
      ...
      proto: {
        ...
        show: function (a, b, c, j) {
          ...
          var b = b || ("rtl" == this.editor.lang.dir ? 2 : 1),
            ...
            h = this._.element;
          if (!f) {
            f = this._.panel = new CKEDITOR.ui.floatPanel(
              this.editor,
            ...
            d[38] = "prev";
            d[CKEDITOR.SHIFT + 9] = "prev";
            d["rtl" == i.lang.dir ? 37 : 39] = CKEDITOR.env.ie
              ? "mouseup"
              : "click";
          ...
          for (
            ...
            var n = e[l];
            m != n.group &&
              (d.push('<div class="cke_menuseparator" role="separator"></div>'),
              (m = n.group));
            n.render(this, l, d);
          }
          d.push("</div>");
          ...
          addTarget: function (b, d) {
            if (CKEDITOR.env.opera && !("oncontextmenu" in document.body)) {
              ...
              b.on("mousedown", function (a) {
                a = a.data;
                if (2 != a.$.button)
                  a.getKeystroke() == CKEDITOR.CTRL + 1 &&
                    b.fire("contextmenu", a);
                else if (
                  !d ||
      ...
      if (!1 !== a.resize_enabled) {
        var c = null,
          ...
          j = function (d) {
            ...
            i &&
              (e = Math.max(a.resize_minWidth, Math.min(c, a.resize_maxWidth)));
            l &&
              (m = Math.max(
                a.resize_minHeight,
                Math.min(d, a.resize_maxHeight)
              ));
            b.resize(i ? e : null, m);
          },
          k = function () {
            ...
            b.document &&
              (b.document.removeListener("mousemove", j),
          ...
          p = CKEDITOR.tools.addFunction(function (d) {
            ...
            b.document &&
              (b.document.on("mousemove", j), b.document.on("mouseup", k));
  ...
  (function () {
    function w(a) {
      function d() {
        for (
          var b = i(),
            e = CKEDITOR.tools.clone(a.config.toolbarGroups) || n(a),
            f = 0;
          f < e.length;
          f++
        ) {
        ...
        a.on("uiSpace", function (c) {
          if (c.data.space == a.config.toolbarLocation) {
            ...
            var d = CKEDITOR.tools.getNextId(),
              b = [
                ...
                '<span id="' +
                  ...
                  '" class="cke_toolbox" role="group" aria-labelledby="',
                d,
            ...
            a.config.toolbarCanCollapse &&
              a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE &&
              b.push(
                '<span class="cke_toolbox_main"' +
                  (d ? ">" : ' style="display:none">')
              );
            for (
              var n = a.toolbox.toolbars, f = w(a), k = 0;
              k < f.length;
              k++
            ) {
              var j,
                    ...
                    if (o)
                      if (o.type == CKEDITOR.UI_SEPARATOR) g = e && o;
                        ...
                        if (!l) {
                          ...
                          var p = n.push(l) - 1;
                          0 < p &&
                            ((l.previous = n[p - 1]), (l.previous.next = l));
                        }
                        u
                          ? e ||
                            (b.push(
            ...
            if (
              ...
              b.push(
                '" onclick="CKEDITOR.tools.callFunction(' + v + ')">',
    ...
    CKEDITOR.ui.prototype.addToolbarGroup = function (a, d, i) {
      ...
      if (i) {
        if (
          (i = CKEDITOR.tools.search(c, function (a) {
            return a.name == i;
          }))
        ) {
          !i.groups && (i.groups = []);
  ...
  (function () {
    ...
    function m(a, d) {
      ...
      var m = CKEDITOR.tools.addFunction(o),
        r = CKEDITOR.tools.addFunction(function (b, e) {
          ...
          switch (e.getKeystroke()) {
            ...
            case 9:
              return (
                (f = CKEDITOR.document.getById(c + (b + 1))) ||
                  (f = CKEDITOR.document.getById(c + "0")),
                f.focus(),
                !1
              );
            case f ? 37 : 39:
            case CKEDITOR.SHIFT + 9:
              return (
                (f = CKEDITOR.document.getById(c + (b - 1))) ||
                  (f = CKEDITOR.document.getById(
                    c + (a._.elementsPath.list.length - 1)
                  )),
                f.focus(),
                !1
              );
      ...
      a.on("selectionChange", function (b) {
        for (
          ...
          j ||
            ((j = f.push(c) - 1),
            (k = a.lang.elementspath.eleTitle.replace(/%1/, g)),
            (g = s.output({
              id: q + j,
              label: k,
              text: g,
    ...
    CKEDITOR.env.gecko &&
      (d += ' onblur="this.style.cssText = this.style.cssText;"');
    var s = CKEDITOR.addTemplate(
      "pathItem",
        ...
        if ((b = b || q(e))) {
          ...
          if (j && h) {
            if (a && (a.is("li") || a.getParent().is("li"))) {
              ...
              if (d.is("li"))
                ...
                if (e)
                  if (
                    ((d = f.createElement(c == CKEDITOR.ENTER_P ? "p" : "div")),
                    l && d.setAttribute("dir", j),
                    n && d.setAttribute("style", n),
                    h && d.setAttribute("class", h),
                    a.moveChildren(d),
                    i || m)
                  )
            ...
            if (a && a.getParent().is("blockquote")) {
              ...
              a.getPrevious().getFirst(CKEDITOR.dom.walker.invisible(1)) ||
          ...
          if ((h = b.splitBlock(k))) {
            ...
            if (!e && !j)
              ...
              d
                ? i && !d.is("li") && d.renameNode(k)
                : g && g.is("li")
                ? (d = g)
                : ((d = f.createElement(k)),
                  c && (m = c.getDirection()) && d.setAttribute("dir", m));
              if ((f = h.elementPath)) {
                i = 0;
                for (k = f.elements.length; i < k; i++) {
                  ...
                  CKEDITOR.dtd.$removeEmpty[g.getName()] &&
                    ((g = g.clone()), d.moveChildren(g), d.append(g));
                }
              }
              CKEDITOR.env.ie || d.appendBogus();
            ...
            : (!i && j && r.test(h)
                ? (j = a.getDirection())
                  ? ((f = f.createElement("div")),
                    f.setAttribute("dir", j),
                    f.insertAfter(a),
                    b.setStart(f, 0))
                  : (f.createElement("br").insertAfter(a),
                    CKEDITOR.env.gecko && f.createText("").insertAfter(a),
                    b.setStartAt(
                      a.getNext(),
                      CKEDITOR.env.ie
                        ? CKEDITOR.POSITION_BEFORE_START
                ...
                : ((a =
                  ...
                  CKEDITOR.env.ie
                    ...
                    : (f.createText("﻿").insertAfter(a),
                      j && a.getParent().appendBogus(),
                      (a.getNext().$.nodeValue = ""),
                      b.setStartAt(
                        a.getNext(),
                        CKEDITOR.POSITION_AFTER_START
  ...
  (function () {
    ...
    function k() {
      ...
      var d =
          c.config["filebrowser" + i(a.getName()) + "WindowWidth"] ||
          c.config.filebrowserWindowWidth ||
          "80%",
        a =
          c.config["filebrowser" + i(a.getName()) + "WindowHeight"] ||
        ...
        for (var e, g = b.length; g--; )
          if (
            ...
            if (
              ...
              void 0 === f &&
                ((f = a.config["filebrowser" + i(c) + "BrowseUrl"]),
              ...
              ((f = e.filebrowser.url),
              void 0 === f &&
                ((f = a.config["filebrowser" + i(c) + "UploadUrl"]),
    ...
    function n(a, c) {
      ...
      if (
        !("function" == typeof c && !1 === c.call(this._.filebrowserSe)) &&
  ...
  CKEDITOR.plugins.add("find", {
    ...
    init: function (a) {
      ...
      b.canUndo = !1;
      b.readOnly = 1;
      a.addCommand("replace", new CKEDITOR.dialogCommand("replace")).canUndo =
        !1;
      a.ui.addButton &&
        (a.ui.addButton("Find", {
  ...
  (function () {
    ...
    CKEDITOR.editor.prototype.createFakeElement = function (a, b, c, d) {
      ...
      CKEDITOR.env.hc ||
        (b.src = CKEDITOR.getUrl(k.path + "images/spacer.gif"));
          ...
          b.addRules(
            {
              elements: {
                "cke:object": function (b) {
                  var c = b.attributes;
                  if (
                    (!c.classid || !("" + c.classid).toLowerCase()) &&
                    !d(b)
                  ) {
  ...
  (function () {
          ...
          return function (d) {
            if ((r = a.editable()))
              if (
                ...
                m + n <= c.top
                  ? e("top")
                  : m + n > h.height - c.bottom
                  ? e("pin")
                  : e("bottom");
                var d = h.width / 2,
                  d =
                    0 < c.left && c.right < h.width && c.width > k.width
    ...
    var u = CKEDITOR.addTemplate(
        "floatcontainer",
        '<div id="cke_{name}" class="cke {id} cke_reset_all cke_chrome cke_editor_{name} cke_float cke_{langDir} ' +
          CKEDITOR.env.cssClass +
          '" dir="{langDir}" title="' +
          (CKEDITOR.env.gecko ? " " : "") +
          '" lang="{langCode}" role="application" style="{style}" aria-labelledby="cke_{name}_arialbl"><span id="cke_{name}_arialbl" class="cke_voice_label">{voiceLabel}</span><div class="cke_inner"><div id="{topId}" class="cke_top" role="presentation">{content}</div></div></div>'
      ),
  ...
  (function () {
    ...
    CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
      ...
      proto: {
        ...
        render: function (a, b) {
          function j() {
            var d = this.modes[a.mode]
              ? CKEDITOR.TRISTATE_OFF
              : CKEDITOR.TRISTATE_DISABLED;
            this.setState(
              a.readOnly && !this.readOnly ? CKEDITOR.TRISTATE_DISABLED : d
            );
            this.setValue("");
          }
          var c = CKEDITOR.env,
      ...
      a.ui.addRichCombo(b, {
        ...
        onRender: function () {
          a.on(
            ...
            function (a) {
              for (
                var b = this.getValue(), a = a.data.path.elements, c = 0, d;
                c < a.length;
                c++
              ) {
                d = a[c];
  ...
  CKEDITOR.plugins.add("forms", {
    ...
    init: function (b) {
      ...
      b.contextMenu &&
        (!b.blockless &&
          b.contextMenu.addListener(function (g, c, a) {
      ...
      b.on("doubleclick", function (a) {
        ...
        if (!b.blockless && c.is("form")) a.data.dialog = "form";
          ...
          c.is("img") &&
          c.data("cke-real-element-type") == "hiddenfield"
        )
  ...
  CKEDITOR.env.ie &&
    (CKEDITOR.dom.element.prototype.hasAttribute = CKEDITOR.tools.override(
      CKEDITOR.dom.element.prototype.hasAttribute,
      function (b) {
        return function (a) {
  ...
  CKEDITOR.htmlWriter = CKEDITOR.tools.createClass({
    ...
    proto: {
      ...
      attribute: function (b, a) {
        "string" == typeof a &&
          (this.forceSimpleAmpersand && (a = a.replace(/&amp;/g, "&")),
  ...
  (function () {
    function k(a) {
      ...
      c.contentEditable = !0;
      CKEDITOR.env.ie &&
        ((c.hideFocus = !0), (c.disabled = !0), c.removeAttribute("disabled"));
      delete this._.isLoadingData;
      this.$ = c;
      b = new CKEDITOR.dom.document(b);
      this.setup();
      if (CKEDITOR.env.ie)
        b.getDocumentElement().addClass(b.$.compatMode),
          d.config.enterMode != CKEDITOR.ENTER_P &&
            b.on("selectionchange", function () {
              var a = b.getBody(),
                c = d.getSelection(),
                e = c && c.getRanges()[0];
              e &&
                a.getHtml().match(/^<p>&nbsp;<\/p>$/i) &&
                e.startContainer.equals(a) &&
                setTimeout(function () {
      ...
      try {
        d.document.$.execCommand(
          ...
          !1,
          !d.config.disableNativeTableHandles
        );
      } catch (g) {}
        ...
        this.attachListener(this, "keydown", function (a) {
          ...
          if (b == 33 || b == 34)
            if (CKEDITOR.env.ie)
              ...
              var c = d.createRange();
              c[b == 33 ? "moveToElementEditStart" : "moveToElementEditEnd"](
                this
              );
              c.select();
              a.data.preventDefault();
      ...
      CKEDITOR.env.ie &&
        this.attachListener(b, "blur", function () {
          try {
            b.$.selection.empty();
          } catch (a) {}
        });
      d.document
        ...
        .getItem(0)
        .data("cke-title", d.document.$.title);
        ...
        a.addMode("wysiwyg", function (d) {
          ...
          var c =
            ...
            c = CKEDITOR.env.air
              ...
              : "",
            e = CKEDITOR.dom.element.createFromHtml(
              '<iframe src="' + c + '" frameBorder="0"></iframe>'
            );
          ...
          var f = CKEDITOR.tools.getNextId(),
            i = CKEDITOR.dom.element.createFromHtml(
              '<span id="' + f + '" class="cke_voice_label">' + h + "</span>"
            );
          g.append(i, 1);
          ...
          CKEDITOR.env.webkit &&
            ...
            e.setCustomData("onResize", c),
            CKEDITOR.document.getWindow().on("resize", c));
          a.fire("ariaWidget", e);
        });
      },
    });
      ...
      proto: {
        setData: function (a, d) {
          ...
          if (d) this.setHtml(a), b.fire("dataReady");
            ...
            var h = c.baseHref
              ? '<base href="' + c.baseHref + '" data-cke-temp="1" />'
              : "";
            e &&
              (a = a
            ...
            e
              ? (/<body[\s|>]/.test(a) || (a = "<body>" + a),
                ...
                /<head[\s|>]/.test(a)
                  ? /<title[\s|>]/.test(a) ||
                    (a = a.replace(/<head[^>]*>/, "$&<title></title>"))
                  : (a = a.replace(
                      /<html[^>]*>/,
                      "$&<head><title></title></head>"
                    )),
                h && (a = a.replace(/<head>/, "$&" + h)),
                (a = a.replace(/<\/head\s*>/, f + "$&")),
                (a = g + a))
              : (a =
                  c.docType +
                  '<html dir="' +
        ...
        getData: function (a) {
          ...
          var a = this.editor,
            ...
            g = this.getDocument(),
            b = b
              ? g.getDocumentElement().getOuterHtml()
              : g.getBody().getHtml();
          CKEDITOR.env.gecko &&
            ...
            20: {
              refresh: function (a, b) {
                ...
                return this.isIndent
                  ...
                  : e
                  ? CKEDITOR[
                      (parseInt(e.getStyle(i(e)), 10) || 0) <= 0
                        ? "TRISTATE_DISABLED"
                        : "TRISTATE_OFF"
                    ]
                  : f;
  ...
  (function () {
    function s(e) {
      function g(b) {
        for (
          var f = d.startContainer, a = d.endContainer;
        ...
        for (
          var h = n.isIndent ? 1 : -1,
            a = f[0],
            f = f[f.length - 1],
            c = CKEDITOR.plugins.list.listToArray(b, o),
            g = c[f.getCustomData("listarray_index")].indent,
          ...
          if (((c[a].indent += h), 0 < h)) {
            var l = c[a].parent;
            c[a].parent = new CKEDITOR.dom.element(
              l.getName(),
              l.getDocument()
            );
          }
        for (
          a = f.getCustomData("listarray_index") + 1;
          a < c.length && c[a].indent > g;
          a++
        )
          c[a].indent += h;
        f = CKEDITOR.plugins.list.arrayToList(
          c,
          o,
          null,
          e.config.enterMode,
        ...
        if (!n.isIndent) {
          ...
          if ((i = b.getParent()) && i.is("li"))
            for (
              var h = f.listNode.getChildren(), m = [], j, a = h.count() - 1;
              0 <= a;
              a--
            )
              (j = h.getItem(a)) && j.is && j.is("li") && m.push(j);
        }
      ...
      for (
        var n = this,
          ...
          k = this.context,
          l = e.getSelection(),
          l = (l && l.getRanges(1)).createIterator(),
          d;
        (d = l.getNextRange());
        ...
        b &&
          ...
          d.startContainer.getName() in k &&
          ((c = new CKEDITOR.dom.walker(d)),
          (c.evaluator = i),
          (d.startContainer = c.next()));
        b &&
          d.endContainer.type == CKEDITOR.NODE_ELEMENT &&
          d.endContainer.getName() in k &&
          ((c = new CKEDITOR.dom.walker(d)),
          (c.evaluator = i),
          (d.endContainer = c.previous()));
        if (b) return g(b);
      }
      return 0;
    }
  ...
  (function () {
    ...
    f.prototype = {
      exec: function (a) {
        ...
        if (c) {
          for (
            ...
            for (
              f.enlargeBr = b != CKEDITOR.ENTER_BR;
              (h = f.getNextParagraph(b == CKEDITOR.ENTER_P ? "p" : "div"));
              ...
              var j =
                  e &&
                  (h.$.className = CKEDITOR.tools.ltrim(
                    h.$.className.replace(this.cssClassRegex, "")
                  )),
                m =
                  this.state == CKEDITOR.TRISTATE_OFF &&
                  (!i || l(h, !0) != this.value);
              e
                ? m
                  ? h.addClass(e)
                  : j || h.removeAttribute("class")
                : m && h.setStyle("text-align", this.value);
            }
          }
          a.focus();
          a.forceNextSelectionCheck();
      ...
      refresh: function (a, c) {
        ...
        this.setState(
          "body" != b.getName() &&
            l(b, this.editor.config.useComputedState) == this.value
            ? CKEDITOR.TRISTATE_ON
            : CKEDITOR.TRISTATE_OFF
        );
      },
  ...
  CKEDITOR.plugins.add("link", {
    ...
    init: function (b) {
      ...
      CKEDITOR.dialog.isTabEnabled(b, "link", "target") &&
        (a = a.replace("]", ",target,onclick]"));
      b.addCommand(
        "link",
  ...
  CKEDITOR.plugins.link = {
    getSelectedLink: function (b) {
      ...
      return d && d.is("a")
        ...
        : (a = a.getRanges(!0)[0])
        ? (a.shrink(CKEDITOR.SHRINK_TEXT),
          b.elementPath(a.getCommonAncestor()).contains("a", 1))
        : null;
    },
    ...
    tryRestoreFakeAnchor: function (b, a) {
      if (
        ...
        "anchor" == a.data("cke-real-element-type")
      ) {
  ...
  CKEDITOR.removeAnchorCommand.prototype = {
    exec: function (b) {
      ...
      if (
        ...
        c.hasAttribute("href")
          ? (c.removeAttributes({ name: 1, "data-cke-saved-name": 1 }),
            c.removeClass("cke_anchor"))
          : c.remove(1);
      a.selectBookmarks(d);
    },
    requiredContent: "a[name]",
  ...
  (function () {
    function C(c, j, f) {
      function b(b) {
        if (
          (d = a[b ? "getFirst" : "getLast"]()) &&
          (!d.is || !d.isBlockBoundary()) &&
          (m = j.root[b ? "getPrevious" : "getNext"](
      ...
      for (
        var i = CKEDITOR.plugins.list.listToArray(j.root, f), e = [], h = 0;
        h < j.contents.length;
        h++
      ) {
        var g = j.contents[h];
        if (
          (g = g.getAscendant("li", !0)) &&
          !g.getCustomData("list_item_processed")
        )
          e.push(g),
      ...
      var a = CKEDITOR.plugins.list.arrayToList(
          i,
          f,
          null,
          c.config.enterMode,
          j.root.getAttribute("dir")
        ).listNode,
        d,
        m;
      b(!0);
    ...
    function y(c, j, f, b) {
      for (var i, e; (i = c[b ? "getLast" : "getFirst"](D)); )
        (e = i.getDirection(1)) !== j.getDirection(1) &&
          i.setAttribute("dir", e),
          i.remove(),
    ...
    function B(c) {
      return (
        c.type == CKEDITOR.NODE_ELEMENT &&
        (c.getName() in CKEDITOR.dtd.$block ||
          c.getName() in CKEDITOR.dtd.$listItem) &&
    ...
    function v(c, j, f) {
      ...
      h
        ? (h = h.getBogus()) && h.remove()
        : g && (h = g.getPrevious(q)) && u(h) && h.remove();
      (h = b.getLast()) &&
        h.type == CKEDITOR.NODE_ELEMENT &&
        h.is("br") &&
        h.remove();
      ...
      for (; f.checkStartOfBlock() && f.checkEndOfBlock(); )
        (g = f.startPath()),
          ...
          b.is("li") &&
            ((e = b.getParent()),
            b.equals(e.getLast(q)) && b.equals(e.getFirst(q)) && (b = e)),
      ...
      listToArray: function (c, j, f, b, i) {
        ...
        for (var e = 0, h = c.getChildCount(); e < h; e++) {
          ...
          if ("li" == g.$.nodeName.toLowerCase()) {
            ...
            i
              ? (a.grandparent = i)
              : ((a.grandparent = c.getParent()),
                a.grandparent &&
                  "li" == a.grandparent.$.nodeName.toLowerCase() &&
                  (a.grandparent = a.grandparent.getParent()));
            j &&
              CKEDITOR.dom.element.setMarker(j, g, "listarray_index", f.length);
            f.push(a);
            for (var d = 0, m = g.getChildCount(), k; d < m; d++)
              (k = g.getChild(d)),
                k.type == CKEDITOR.NODE_ELEMENT && r[k.getName()]
      ...
      arrayToList: function (c, j, f, b, i) {
        ...
        for (
          ...
          if (o.indent == m) {
            ...
            (l = c[d - 1].element.getDirection(1)),
              ...
              !k.getChildCount() &&
                CKEDITOR.env.ie &&
                !(7 < h.$.documentMode) &&
                k.append(h.createText(" ")),
              k.append(d.listNode),
              (d = d.nextIndex);
          else if (-1 == o.indent && !f && e) {
            r[e.getName()]
              ? ((k = o.element.clone(!1, !0)),
                n != e.getDirection(1) && k.setAttribute("dir", n))
            ...
            for (e = 0; e < x; e++) {
              ...
              if (t.type == CKEDITOR.NODE_ELEMENT && t.isBlockBoundary()) {
                ...
                w &&
                  (l ||
                    ((l = h.createElement(p)), a && l.setAttribute("dir", n)),
                  u && l.setAttribute("style", u),
                  z && l.setAttribute("class", z),
                  l.append(t.clone(1, 1)));
            ...
            k.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT &&
              ...
              ((n = k.getLast()) &&
                ...
                "_moz" == n.getAttribute("type") &&
                n.remove(),
              (!k.getLast(q) ||
                !(
                  n.type == CKEDITOR.NODE_ELEMENT &&
                  n.getName() in CKEDITOR.dtd.$block
                )) &&
        ...
        if (j)
          for (c = g.getFirst(); c; ) {
            if (
              c.type == CKEDITOR.NODE_ELEMENT &&
              (CKEDITOR.dom.element.clearMarkers(j, c),
              c.getName() in CKEDITOR.dtd.$listItem &&
    ...
    x.prototype = {
        ...
        if (this.state == CKEDITOR.TRISTATE_OFF) {
          ...
          if (i.getFirst(q)) {
            ...
            j.enterMode == CKEDITOR.ENTER_BR
              ? i.appendBogus()
              : b[0].fixBlock(1, j.enterMode == CKEDITOR.ENTER_P ? "p" : "div"),
              f.selectRanges(b);
        }
        for (
          var j = f.createBookmarks(!0),
            i = [],
            h = {},
            b = b.createIterator(),
            g = 0;
          ...
          e = e.createIterator();
          for (
            e.forceBrBreak = this.state == CKEDITOR.TRISTATE_OFF;
            (a = e.getNextParagraph());

          )
            if (!a.getCustomData("list_block")) {
              CKEDITOR.dom.element.setMarker(h, a, "list_block", 1);
              for (
                var k = c.elementPath(a),
                  d = k.elements,
                  m = 0,
                  k = k.blockLimit,
                  n,
              ...
              m ||
                ((m = k),
                m.getCustomData("list_group_object_" + g)
        ...
        for (n = []; 0 < i.length; )
          if (((d = i.shift()), this.state == CKEDITOR.TRISTATE_OFF))
            if (r[d.root.getName()]) {
              ...
              for (
                var l = b.root.getDocument(), p = void 0, o = void 0, e = 0;
                e < k.length;
                e++
              ) {
                var s = k[e].getCustomData("listarray_index"),
                  p = m[s].parent;
                p.is(this.type) ||
                  ((o = l.createElement(this.type)),
                  p.copyAttributes(o, { start: 1, type: 1 }),
              ...
              1 == k.length &&
                ...
                k[0].moveChildren && k[0].moveChildren(d),
                k[0].append(d),
                (k[0] = d));
              ...
              if (!(1 > g.length)) {
                ...
                for (p = e = void 0; g.length; )
                  (e = g.shift()),
                    ...
                    e.is("pre") || G.test(e.getName())
                      ? e.appendTo(p)
                      : (e.copyAttributes(p),
                        d &&
                          e.getDirection() &&
                          (p.removeStyle("direction"),
      ...
      refresh: function (c, j) {
        ...
        f && b.contains(f)
          ? this.setState(
              f.is(this.type) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF
            )
          : this.setState(CKEDITOR.TRISTATE_OFF);
      },
    };
    CKEDITOR.plugins.add("list", {
      ...
      init: function (c) {
        c.blockless ||
          ...
          c.addCommand("bulletedlist", new x("bulletedlist", "ul")),
          c.ui.addButton &&
              ...
              if (b.collapsed) {
                ...
                if (e) {
                  ...
                  if (d) {
                    ...
                    (f = i.contains(r)) &&
                    b.checkBoundaryOfElement(f, CKEDITOR.START)
                  ) {
                    d = f.getFirst(q);
  ...
  (function () {
    ...
    function I(a) {
      var b = a.element,
        d;
      return b && m(b)
        ? (d = b.getAscendant(a.triggers, !0)) &&
          !d.contains(a.editable) &&
          !d.equals(a.editable)
          ? d
          : null
        : null;
    ...
    function da(a) {
      ...
      q(d, {
        ...
        lineChildren: [
          q(
            ...
            ),
            {
              ...
              looks: [
                "top:-8px;" +
                  CKEDITOR.tools.cssVendorPrefix("border-radius", "2px", 1),
                "top:-17px;" +
        ...
        place: function () {
          ...
          e && g
            ? (k.top =
                e.size.margin.bottom === g.size.margin.top
                  ? 0 | (e.size.bottom + e.size.margin.bottom / 2)
                  : e.size.margin.bottom < g.size.margin.top
                  ? e.size.bottom + e.size.margin.bottom
                  : e.size.bottom + e.size.margin.bottom - g.size.margin.top)
            : e
            ? g || (k.top = e.size.bottom + e.size.margin.bottom)
            : (k.top = g.size.top - g.size.margin.top);
          d.is(x) || (k.top > b.scroll.y - 15 && k.top < b.scroll.y + 5)
            ? ((k.top = a.inInlineMode ? 0 : b.scroll.y), this.look(x))
            : d.is(y) ||
              (k.top > b.pane.bottom - 5 && k.top < b.pane.bottom + 15)
        ...
        look: function (a) {
          if (this.oldLook != a) {
            for (var b = this.lineChildren.length, d; b--; )
              (d = this.lineChildren[b]).setAttribute(
                "style",
                d.base + d.looks[0 | (a / 2)]
              );
            this.oldLook = a;
          }
        },
      ...
      d.lineChildren[0].on("mouseup", function (b) {
        ...
        L(
          ...
          function (b) {
            ...
            b[d.is(D) ? "insertBefore" : "insertAfter"](
              d.is(D) ? d.lower : d.upper
            );
          },
          !0
        );
    ...
    function L(a, b, d) {
      ...
      n.ie && a.enterMode == CKEDITOR.ENTER_BR
        ? (c = a.doc.createText(E))
        : ((c = new K(a.enterBehavior, a.doc)),
          a.enterMode != CKEDITOR.ENTER_BR && a.doc.createText(E).appendTo(c));
        ...
        exec: (function () {
          ...
          return function (e) {
            ...
            if (
              ...
              f.is(a.triggers) &&
              f.is(ea) &&
              (!r(a, f, !b) || ((c = r(a, f, !b)) && m(c) && c.is(a.triggers)))
                ? d(f)
                : ((c = I(a, e)),
                  m(c) &&
                    (r(a, c, !b)
                      ? (e = r(a, c, !b)) && m(e) && e.is(a.triggers) && d(c)
                      : d(c)));
            }
          };
        })(),
    ...
    function U(a) {
      return !!{ absolute: 1, fixed: 1, relative: 1 }[
    ...
    function V(a) {
      ...
      if (!b) return null;
      v(a, b) &&
        (b = a.line.wrap[c ? "getPrevious" : "getNext"](function (a) {
          return !(z(a) || A(a));
        }));
      if (!m(b) || p(b) || !F(a, b)) return null;
      o(a, b);
      return !c && 0 <= b.size.top && 0 < d.y && d.y < b.size.top + f
        ? ((a = a.inInlineMode || 0 === e.scroll.y ? x : s),
          new u([null, b, D, G, a]))
        : c &&
        ...
        ? ((a =
            a.inInlineMode ||
            (b.size.bottom > e.pane.height - f && b.size.bottom < e.pane.height)
              ? y
              : s),
          new u([b, null, W, G, a]))
        : null;
    ...
    function X(a) {
      ...
      if (g) {
        ...
        f.equals(a.editable[j ? "getLast" : "getFirst"](a.isRelevant))
          ? (C(a),
            j &&
            b.y > f.size.bottom - e &&
            b.y < d.pane.height &&
    ...
    function N(a, b, d, e) {
      for (
        ...
        (h[t[l]] = parseInt(f("border-" + t[l] + "-width"), 10) || 0),
          (g[t[l]] = parseInt(f("padding-" + t[l]), 10) || 0),
          (j[t[l]] = parseInt(f("margin-" + t[l]), 10) || 0);
      (!d || e) && H(a, e);
      ...
      a.inInlineMode &&
        (i.scroll = { top: b.$.scrollTop, left: b.$.scrollLeft });
      return q({ border: h, padding: g, margin: j, ignoreScroll: d }, i, !0);
    }
    function o(a, b, d) {
      ...
      init: function (a) {
        ...
        a.on(
          ...
          function () {
            ...
            q(
              c,
              { editable: b, inInlineMode: b.isInline(), doc: e, win: f },
              !0
            );
            c.boundary = c.inInlineMode
              ? c.editable
              : c.doc.getDocumentElement();
            b.is(w.$inline) ||
              (c.inInlineMode &&
                !U(b) &&
                b.setStyles({ position: "relative", top: null, left: null }),
              da.call(this, c),
              H(c),
              b.attachListener(a, "beforeUndoImage", function () {
                c.line.detach();
              }),
              b.attachListener(
                a,
              ...
              b.attachListener(
                c.inInlineMode ? e : e.getWindow().getFrame(),
                "mouseout",
                function (b) {
                  if ("wysiwyg" == a.mode)
                    if (c.inInlineMode) {
                  ...
                  if (!("wysiwyg" != a.mode || a.readOnly || g)) {
                    ...
                    g = setTimeout(function () {
                      ...
                      if (
                        ...
                        (c.trigger = V(c) || X(c) || aa(c))
                          ? c.line.attach().place()
                          : ((c.trigger = null), c.line.detach()),
                          (j = !1);
                    }, 30);
                  }
                }
              ...
              a.addCommand("accessPreviousSpace", S(c)),
              a.addCommand("accessNextSpace", S(c, !0)),
              a.setKeystroke([
              ...
              a.on("loadSnapshot", function () {
                for (
                  var b = a.document.getElementsByTag(c.enterBehavior),
                    d,
                    e = b.count();
                  e--;
                  ...
                  if (
                    (d = b.getItem(e)).hasAttribute("data-cke-magicline-hot")
                  ) {
                    c.hotNode = d;
                    c.lastCmdDirection =
                      "true" === d.getAttribute("data-cke-magicline-dir")
                        ? !0
                        : !1;
                    break;
                  }
      ...
      aa = (function () {
        function a(a) {
          ...
          if (!(a.mouse.y > f.size.top && a.mouse.y < c.size.bottom))
            return null;
          for (
            var e = Number.MAX_VALUE, j, g, i, l;
            c && !c.equals(f) && (g = f.getNext(a.isRelevant));

          )
            (j = Math.abs(ca(a, f, g) - a.mouse.y)),
              j < e && ((e = j), (i = f), (l = g)),
              (f = g),
              o(a, f);
          if (
            !i ||
            !l ||
            !(a.mouse.y > i.size.top && a.mouse.y < l.size.bottom)
          )
            return null;
          h.upper = i;
          h.lower = l;
  ...
  CKEDITOR.config.magicline_keystrokePrevious =
    CKEDITOR.CTRL + CKEDITOR.SHIFT + 219;
  CKEDITOR.config.magicline_keystrokeNext =
    CKEDITOR.CTRL + CKEDITOR.SHIFT + 221;
  (function () {
    function l(a) {
    ...
    function o(a, e) {
      if (
        a &&
        !(a.type != CKEDITOR.NODE_ELEMENT || "form" != a.getName()) &&
        0 < e.length
      )
          ...
          a.addCommand("maximize", {
            ...
            exec: function () {
              ...
              if (this.state == CKEDITOR.TRISTATE_OFF) {
                ...
                g = [g, h];
                for (c = 0; c < g.length; c++)
                  p(g[c], g[c].getCustomData("maximize_saved_styles")),
                    g[c].removeCustomData("maximize_saved_styles");
                for (c = a.container; (c = c.getParent()); )
                  p(c, c.getCustomData("maximize_saved_styles")),
              ...
              "wysiwyg" == a.mode
                ? j
                  ? (CKEDITOR.env.gecko && q(a),
                    a.getSelection().selectRanges(j),
                    (i = a.getSelection().getStartElement()) &&
                      i.scrollIntoView(!0))
                  : d.$.scrollTo(k.x, k.y)
                : (j && ((i.selectionStart = j[0]), (i.selectionEnd = j[1])),
                  (i.scrollLeft = k[0]),
                  (i.scrollTop = k[1]));
              j = k = null;
              l = this.state;
  ...
  CKEDITOR.plugins.add("pagebreak", {
    ...
    onLoad: function () {
      var a = [
        ...
        "clear: both;width:100%; _width:99.9%;border-top: #999999 1px dotted;border-bottom: #999999 1px dotted;padding:0;height: 5px;cursor: default;}",
      ]
        .join("")
        .replace(/;/g, " !important;");
        ...
        a.addRules({
          elements: {
            div: function (a) {
              ...
              if (
                (d = d && "span" == d.name && d.attributes.style) &&
                /page-break-after\s*:\s*always/i.test(e) &&
                /display\s*:\s*none/i.test(d)
              )
  ...
  CKEDITOR.plugins.pagebreakCmd = {
    exec: function (a) {
      var b = a.lang.pagebreak.alt,
        b = CKEDITOR.dom.element.createFromHtml(
          '<div style="page-break-after: always;"contenteditable="false" title="' +
            b +
            '" aria-label="' +
            b +
    ...
    allowedContent: {
      ...
      span: {
        match: function (a) {
          return (
            (a = a.parent) && "div" == a.name && a.styles["page-break-after"]
          );
        },
        styles: "display",
      },
  ...
  (function () {
    function h(a, d, f) {
      ...
      b
        ? f()
        : ((a = CKEDITOR.getUrl(
            a.config.pasteFromWordCleanupFile || d + "filter/default.js"
          )),
        ...
        a.on(
          ...
          function (b) {
            ...
            if (
              c &&
              (d ||
                /(class=\"?Mso|style=\"[^\"]*\bmso\-|w:WordDocument)/.test(c))
            ) {
      ...
      i = {
        ...
        exec: function (a) {
          ...
          if (b.fullPage)
            ...
            d &&
              (d.getAttribute("id") &&
                (b += 'id="' + d.getAttribute("id") + '" '),
              d.getAttribute("class") &&
                (b += 'class="' + d.getAttribute("class") + '" '));
            g =
              a.config.docType +
              '<html dir="' +
              a.config.contentsLangDirection +
          ...
          CKEDITOR.env.gecko &&
            ((window._cke_htmlToLoad = a.dataValue), (c = h + "preview.html"));
          c = window.open(
            c,
            null,
  ...
  CKEDITOR.plugins.print = {
    exec: function (a) {
      CKEDITOR.env.opera ||
        (CKEDITOR.env.gecko
          ? a.window.$.print()
          : a.document.$.execCommand("Print"));
    },
    canUndo: !1,
    readOnly: 1,
    modes: { wysiwyg: !CKEDITOR.env.opera },
  };
        ...
        exec: function (a) {
          for (
            ...
            if (j) {
              d(j);
              for (
                b = b.getNextSourceNode(!0, CKEDITOR.NODE_ELEMENT);
                b && !b.equals(j);
  ...
  (function () {
    ...
    CKEDITOR.plugins.add("showblocks", {
      onLoad: function () {
        function a(a) {
          return ".%1.%2 p,.%1.%2 div,.%1.%2 pre,.%1.%2 address,.%1.%2 blockquote,.%1.%2 h1,.%1.%2 h2,.%1.%2 h3,.%1.%2 h4,.%1.%2 h5,.%1.%2 h6{background-position: top %3;padding-%3: 8px;}"
            .replace(/%1/g, "cke_show_blocks")
            .replace(/%2/g, "cke_contents_" + a)
            .replace(/%3/g, "rtl" == a ? "right" : "left");
        }
        CKEDITOR.addCss(
          ".%2 p,.%2 div,.%2 pre,.%2 address,.%2 blockquote,.%2 h1,.%2 h2,.%2 h3,.%2 h4,.%2 h5,.%2 h6{background-repeat: no-repeat;border: 1px dotted gray;padding-top: 8px;}.%2 p{%1p.png);}.%2 div{%1div.png);}.%2 pre{%1pre.png);}.%2 address{%1address.png);}.%2 blockquote{%1blockquote.png);}.%2 h1{%1h1.png);}.%2 h2{%1h2.png);}.%2 h3{%1h3.png);}.%2 h4{%1h4.png);}.%2 h5{%1h5.png);}.%2 h6{%1h6.png);}"
            .replace(
              /%1/g,
              "background-image: url(" +
      ...
      onLoad: function () {
        ...
        a = (
          CKEDITOR.env.ie6Compat
            ...
            : ".%1 table.%2,;.%1 table.%2 > tr > td, .%1 table.%2 > tr > th,;.%1 table.%2 > tbody > tr > td, .%1 table.%2 > tbody > tr > th,;.%1 table.%2 > thead > tr > td, .%1 table.%2 > thead > tr > th,;.%1 table.%2 > tfoot > tr > td, .%1 table.%2 > tfoot > tr > th;{;border : #d3d3d3 1px dotted;}".split(
                ";"
              )
        )
          .join("")
  ...
  (function () {
    ...
    var i = "",
      r = function () {
        ...
        function c(b) {
          ...
          c &&
            (d.setPaused(b, !c.disabled),
            d.setControlId(b, c.id),
            c.destroy(!0),
            delete d.instances[b.name],
            f && a());
        }
        var b = this,
          f = function () {
            if (
              !(
                "undefined" != typeof d.instances[b.name] ||
                null != d.instances[b.name]
              )
            ) {
              var a = b.config,
                c = {};
              c.srcNodeRef =
                "BODY" == b.editable().$.nodeName
        ...
        b.on("contentDomUnload", function () {
          for (
            var a = CKEDITOR.document.getElementsByTag("script"),
              b = /^dojoIoScript(\d+)$/i,
              c =
                /^https?:\/\/svc\.webspellchecker\.net\/spellcheck\/script\/ssrv\.cgi/i,
              d = 0;
            d < a.count();
            d++
          ) {
        ...
        b.on(
          ...
          function () {
            var a = d.getScayt(b);
            d.isScaytEnabled(b) &&
              (CKEDITOR.env.ie && b.getSelection().unlock(!0),
              window.setTimeout(function () {
                a.focus();
                a.refresh();
              }, 10));
    ...
    CKEDITOR.plugins.scayt = {
      ...
      setControlInfo: function (a, c) {
        a &&
          a.name &&
          "object" != typeof this.controlInfo[a.name] &&
          (this.controlInfo[a.name] = {});
        for (var b in c) this.controlInfo[a.name][b] = c[b];
      },
      isControlRestored: function (a) {
        return a && a.name && this.controlInfo[a.name]
          ? this.controlInfo[a.name].restored
          : !1;
      },
      ...
      getUiTabs: function (a) {
        ...
        for (var d = 0; 4 > d; d++)
          c[d] =
            "undefined" != typeof window.scayt &&
            "undefined" != typeof window.scayt.uiTags
              ? parseInt(b[d], 10) && window.scayt.uiTags[d]
              : parseInt(b[d], 10);
      ...
      loadEngine: function (a) {
        ...
        var c = document.location.protocol,
          ...
          c =
            ...
            c + "//svc.webspellchecker.net/scayt26/loader__base.js",
          b = d.parseUrl(c).path + "/";
        void 0 == window.scayt
        ...
        a.ui.add("Scayt", CKEDITOR.UI_MENUBUTTON, {
          ...
          onMenu: function () {
            ...
            return {
              ...
              scaytOptions:
                b && c[0] ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
              scaytLangs:
                b && c[1] ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
              scaytDict:
                b && c[2] ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
              scaytAbout:
                b && c[3] ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED,
              scaytWSC: c[4]
                ? CKEDITOR.TRISTATE_OFF
                : CKEDITOR.TRISTATE_DISABLED,
            };
        ...
        c.ui.addRichCombo("Styles", {
          ...
          onOpen: function () {
            ...
            a[CKEDITOR.STYLE_BLOCK] ||
              this.hideGroup(f["panelTitle" + CKEDITOR.STYLE_BLOCK]);
            a[CKEDITOR.STYLE_INLINE] ||
              this.hideGroup(f["panelTitle" + CKEDITOR.STYLE_INLINE]);
            a[CKEDITOR.STYLE_OBJECT] ||
              this.hideGroup(f["panelTitle" + CKEDITOR.STYLE_OBJECT]);
          },
          reset: function () {
            g = {};
            i = [];
  ...
  (function () {
    ...
    function o(e, d) {
      for (
        ...
        1 < a[h].rowSpan && g && a[h] == g[h]
          ? ((i = a[h]), (i.rowSpan += 1))
          : ((i = new CKEDITOR.dom.element(a[h]).clone()),
            i.removeAttribute("rowSpan"),
            !CKEDITOR.env.ie && i.appendBogus(),
            c.append(i),
            (i = i.$));
        h += i.colSpan - 1;
    ...
    function q(e) {
      if (e instanceof CKEDITOR.dom.selection) {
        for (
          ...
          for (
            var g = c[f], h = new CKEDITOR.dom.element(b.$.rows[f]), i = 0;
            i < g.length;
            i++
          ) {
    ...
    function r(e, d) {
      for (var b = d ? Infinity : 0, c = 0; c < e.length; c++) {
        ...
        a = e[c];
        for (
          var f = d, g = a.getParent().$.cells, h = 0, i = 0;
          i < g.length;
          i++
        ) {
          var j = g[i],
    ...
    function s(e, d, b) {
      ...
      if (d) {
        ...
        try {
          ...
          n =
            g["up" == d ? j - m : "down" == d ? j + m : j][
              "left" == d ? l - f : "right" == d ? l + f : l
            ];
        } catch (z) {
          return !1;
        }
              ...
              for (n = e; n <= j; n++)
                for (k = 0; k < d.length; k++)
                  (c = d[k]),
                    ...
                    c.$ &&
                      (1 == c.$.colSpan ? c.remove() : (c.$.colSpan -= 1),
                      (k += c.$.rowSpan - 1),
                      b.$.cells.length || l.push(b));
              j = a.$.rows[0] && a.$.rows[0].cells;
              e = new CKEDITOR.dom.element(
                j[e] || (e ? j[e - 1] : a.$.parentNode)
              );
              l.length == o && a.remove();
              e && m(e, !0);
            },
            ...
            tablecell: {
              ...
              getItems: function () {
                ...
                return {
                  ...
                  tablecell_merge: s(a, null, !0)
                    ? CKEDITOR.TRISTATE_OFF
                    : CKEDITOR.TRISTATE_DISABLED,
                  tablecell_merge_right: s(a, "right", !0)
                    ? CKEDITOR.TRISTATE_OFF
                    : CKEDITOR.TRISTATE_DISABLED,
                  tablecell_merge_down: s(a, "down", !0)
                    ? CKEDITOR.TRISTATE_OFF
                    : CKEDITOR.TRISTATE_DISABLED,
                  tablecell_split_vertical: w(a, !0)
                    ? CKEDITOR.TRISTATE_OFF
                    : CKEDITOR.TRISTATE_DISABLED,
  ...
  CKEDITOR.tools.buildTableMap = function (p) {
    for (var p = p.$.rows, o = -1, q = [], r = 0; r < p.length; r++) {
      ...
      for (var k = -1, u = 0; u < p[r].cells.length; u++) {
        ...
        for (k++; q[o][k]; ) k++;
        for (
          var m = isNaN(t.colSpan) ? 1 : t.colSpan,
            t = isNaN(t.rowSpan) ? 1 : t.rowSpan,
            v = 0;
          v < t;
          v++
        ) {
  ...
  (function () {
    ...
    CKEDITOR.plugins.add("undo", {
      init: function (a) {
        ...
        b.onChange = function () {
          e.setState(
            b.undoable() ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED
          );
          f.setState(
            b.redoable() ? CKEDITOR.TRISTATE_OFF : CKEDITOR.TRISTATE_DISABLED
          );
        };
        ...
        if (c || a) {
          ...
          for (var d = 0; d < c.length; d++) {
            var b = c[d],
              e = a[d];
            if (
              b.startOffset != e.startOffset ||
              b.endOffset != e.endOffset ||
              !CKEDITOR.tools.arrayCompare(b.start, e.start) ||
              !CKEDITOR.tools.arrayCompare(b.end, e.end)
            )
              return !1;
          }
        }
    ...
    g.prototype = {
      type: function (a, c) {
        ...
        (this.wasCharacter = c)
          ? ((this.modifiersCount = 0),
            this.typesCount++,
            25 < this.typesCount
              ? (this.save(!1, null, !1), (this.typesCount = 1))
              : setTimeout(function () {
                  b.fire("change");
                }, 0))
          : ((this.typesCount = 0),
            this.modifiersCount++,
            25 < this.modifiersCount
      ...
      restoreImage: function (a) {
        ...
        a.bookmarks
          ...
          : CKEDITOR.env.ie &&
            ((d = this.editor.document.getBody().$.createTextRange()),
            d.collapse(!0),
            d.select());
        this.locked = 0;
        this.index = a.index;
      ...
      update: function () {
        this.locked ||
          this.snapshots.splice(
            this.index,
            1,
            (this.currentImage = new f(this.editor))
          );
      },
      lock: function () {
        if (this.locked) this.locked.level++;
          ...
          this.locked = {
            update:
              this.currentImage && this.currentImage.equalsContent(a)
                ? a
                : null,
            level: 1,
          };
  ...
  CKEDITOR.config.plugins =
    "dialogui,dialog,about,a11yhelp,dialogadvtab,basicstyles,bidi,blockquote,clipboard,button,panelbutton,panel,floatpanel,colorbutton,colordialog,templates,menu,contextmenu,div,resize,toolbar,elementspath,enterkey,entities,popup,filebrowser,find,fakeobjects,flash,floatingspace,listblock,richcombo,font,forms,format,horizontalrule,htmlwriter,iframe,wysiwygarea,image,indent,indentblock,indentlist,smiley,justify,link,list,liststyle,magicline,maximize,newpage,pagebreak,pastetext,pastefromword,preview,print,removeformat,save,selectall,showblocks,showborders,sourcearea,specialchar,menubutton,scayt,stylescombo,tab,table,tabletools,undo,wsc";
