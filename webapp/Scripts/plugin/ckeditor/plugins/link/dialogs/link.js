  ...
  var w = CKEDITOR.plugins.link,
    ...
    I = function (a, g) {
      ...
      if (g) {
        ...
        if (d)
          d.match(D)
            ? (b.target.type = b.target.name = d)
            : ((b.target.type = "frame"), (b.target.name = d));
        else if (
          (d =
            (d = g.data("cke-pa-onclick") || g.getAttribute("onclick")) &&
            d.match(G))
        ) {
          b.target.type = "popup";
          for (b.target.name = d[1]; (c = H.exec(d[2])); )
            ("yes" == c[2] || "1" == c[2]) &&
            !(c[1] in { height: 1, width: 1, top: 1, left: 1 })
              ? (b.target[c[1]] = !0)
        ...
        b.adv.advName =
          g.data("cke-saved-name") || g.getAttribute("name") || "";
        d("advLangCode", "lang");
        d("advTabIndex", "tabindex");
        d("advTitle", "title");
        d("advContentType", "type");
        CKEDITOR.plugins.link.synAnchorSelector
          ? (b.adv.advCSSClasses = v(g))
          : d("advCSSClasses", "class");
      ...
      if (CKEDITOR.plugins.link.emptyAnchorFix) {
        ...
        for (e = f.count(); c < e; c++)
          if (
            ((h = f.getItem(c)),
            h.data("cke-saved-name") || h.hasAttribute("name"))
          )
            d.push({
        ...
        for (e = f.count(); c < e; c++)
          (h = f.getItem(c)),
            (d[c] = { name: h.getAttribute("name"), id: h.getAttribute("id") });
      }
  ...
  return {
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    validate: function () {
                      var a = this.getDialog();
                      if (
                        a.getContentElement("info", "linkType") &&
                        a.getValueOf("info", "linkType") != "url"
                      )
                        return true;
                ...
                children: [
                  ...
                  },
                  {
                    ...
                    validate: CKEDITOR.dialog.validate.inlineStyle(
                      n.lang.common.invalidInlineStyle
                    ),
                    setup: k,
                    commit: m,
                  },
    ...
    onShow: function () {
      var a = this.getParentEditor(),
        b = a.getSelection(),
        c = null;
      (c = w.getSelectedLink(a)) && c.hasAttribute("href")
        ? b.selectElement(c)
        : (c = null);
    ...
    onOk: function () {
      ...
      switch (c.type || "url") {
        case "url":
          var e =
              c.url && c.url.protocol != void 0 ? c.url.protocol : "http://",
      ...
      if (c.target)
        if (c.target.type == "popup") {
          for (
            var e = ["window.open(this.href, '", c.target.name || "", "', '"],
              j = [
                "resizable",
                "status",
                "location",
      ...
      if (this._.selectedElement) {
        ...
        if (i == f || (c.type == "email" && f.indexOf("@") != -1))
          d.setHtml(
            c.type == "email" ? c.email.address : a["data-cke-saved-href"]
          );
        e.selectElement(d);
