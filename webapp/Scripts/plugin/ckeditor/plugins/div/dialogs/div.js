(function () {
  function p(a, k, o) {
    if (!k.is || !k.getCustomData("block_processed"))
      k.is && CKEDITOR.dom.element.setMarker(o, k, "block_processed", !0),
        a.push(k);
  }
  function n(a, k) {
    function o() {
    ...
    return {
              ...
              children: [
                {
                  ...
                  onChange: function () {
                    ...
                    this.commit(h, !0);
                    for (
                      var d = [].concat(d), b = d.length, i, e = 0;
                      e < b;
                      e++
                    )
                  ...
                  setup: function (a) {
                    for (var c in l)
                      l[c].checkElementRemovable(a, !0) && this.setValue(c, 1);
                  },
                  commit: function (a) {
                    var c;
                    (c = this.getValue())
      ...
      onOk: function () {
        if ("editdiv" == k) m = [this._element];
          ...
          for (g = 0; g < e.length; g++)
            for (j = e[g].createIterator(); (b = j.getNextParagraph()); )
              if (b.getName() in n) {
                ...
                for (; !q[b.getName()] && !b.equals(e[g].root); )
                  b = b.getParent();
                p(h, b, c);
              }
          ...
          for (g = 0; g < e.length; g++) {
            ...
            for (b = 0; b < e[g].length; b++)
              if (
                ((f = e[g][b]),
                !f.getCustomData || !f.getCustomData("block_processed"))
              )
                f.is &&
                  CKEDITOR.dom.element.setMarker(c, f, "block_processed", !0),
                  b || j.insertBefore(f),
                  j.append(f);
            CKEDITOR.dom.element.clearAllMarkers(c);
            d.push(j);
        ...
        d = m.length;
        for (c = 0; c < d; c++)
          this.commitContent(m[c]),
            !m[c].getAttribute("style") && m[c].removeAttribute("style");
        this.hide();
      },
      onHide: function () {
