  ...
  var r = function (c, j) {
    ...
    var f = 1,
      ...
      w = function () {
        ...
        b.lockRatio &&
          ((d = b.originalElement),
          "true" == d.getCustomData("isReady") &&
            ("txtHeight" == this.id
              ? (a &&
                  "0" != a &&
                  (a = Math.round(d.$.width * (a / d.$.height))),
                isNaN(a) || b.setValueOf("info", "txtWidth", a))
              : (a &&
                  "0" != a &&
                  (a = Math.round(d.$.height * (a / d.$.width))),
      ...
      l = function (a, b) {
        ...
        a.lockRatio
          ? e.removeClass("cke_btn_unlocked")
          : e.addClass("cke_btn_unlocked");
    ...
    return {
      ...
      onShow: function () {
        ...
        if (d) {
          ...
          if (1 == c.count()) {
            ...
            if ("img" == g || "input" == g)
              (this.imageElement = c.getItem(0)),
                "img" == this.imageElement.getName()
        ...
        this.imageEditMode
          ? ((this.cleanImageElement = this.imageElement),
            ...
            this.setupContent(f, this.imageElement))
      ...
      onOk: function () {
        if (this.imageEditMode) {
          ...
          "image" == j && "input" == a && confirm(c.lang.image.button2Img)
            ...
            ? ((this.imageElement = c.document.createElement("input")),
        ...
        this.imageEditMode
          ? !this.linkEditMode && this.addLink
            ...
            : this.linkEditMode &&
              !this.addLink &&
              (c.getSelection().selectElement(this.linkElement),
              c.insertElement(this.imageElement))
          : this.addLink
          ? this.linkEditMode
            ? c.insertElement(this.imageElement)
      ...
      onLoad: function () {
        ...
        this.getContentElement("info", "ratioLock") &&
          (this.addFocusable(a.getById(u), 5),
          this.addFocusable(a.getById(p), 5));
        this.commitContent = r;
      },
      onHide: function () {
        this.preview && this.commitContent(8, this.preview);
        this.originalElement &&
          (this.originalElement.removeListener("load", q),
                              ...
                              commit: function (a, b, d) {
                                ...
                                a == f
                                  ...
                                  ? c.match(k)
                                    ...
                                    : ((a = this.getDialog().originalElement),
                      ...
                      children: [
                        {
                          ...
                          setup: function (a, b) {
                            if (a == f) {
                              ...
                              d =
                                (d =
                                  (d = b.getStyle("border-width")) &&
                                  d.match(/^(\d+px)(?: \1 \1 \1)?$/)) &&
                                parseInt(d[1], 10);
                              isNaN(parseInt(d, 10)) &&
                                (d = b.getAttribute("border"));
                              this.setValue(d);
                            }
                          },
                          commit: function (a, b, d) {
                            ...
                            a == f || 4 == a
                              ? (isNaN(c)
                                ...
                                !d && a == f && b.removeAttribute("border"))
                              : 8 == a &&
                          ...
                          commit: function (a, b, c) {
                            ...
                            a == f || 4 == a
                              ? (isNaN(e)
                                  ...
                                  : (b.setStyle(
                                      "margin-left",
                                      CKEDITOR.tools.cssLength(e)
                                    ),
                                    b.setStyle(
                                      "margin-right",
                                      CKEDITOR.tools.cssLength(e)
                                    )),
                                !c && a == f && b.removeAttribute("hspace"))
                              : 8 == a &&
                          ...
                          commit: function (a, b, c) {
                            ...
                            a == f || 4 == a
                              ? (isNaN(e)
                                ...
                                !c && a == f && b.removeAttribute("vspace"))
                              : 8 == a &&
