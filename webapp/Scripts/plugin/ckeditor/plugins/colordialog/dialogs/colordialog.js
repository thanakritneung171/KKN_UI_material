...
CKEDITOR.dialog.add("colordialog", function (t) {
  ...
  function v(a) {
    ...
    if ("td" == c.getName() && (e = c.getChild(0).getHtml()))
      q(a),
        b ? (g = c) : (w = c),
        b &&
          (c.setStyle("border-color", y(e)),
          c.setStyle("border-style", "dotted")),
  ...
  function z(a) {
    ...
    switch (e) {
      case 38:
        if ((a = c.getParent().getPrevious()))
          (a = a.getChild([c.getIndex()])), a.focus();
        b.preventDefault();
        break;
      case 40:
      ...
      case d ? 37 : 39:
        if ((a = c.getNext())) 1 == a.type && (a.focus(), b.preventDefault(!0));
          ...
          if ((a = a.getChild([0])) && 1 == a.type)
            a.focus(), b.preventDefault(!0);
        break;
      case d ? 39 : 37:
            ...
            children: [
              {
                ...
                focus: function () {
                  (
                    g || this.getElement().getElementsByTag("td").getItem(0)
                  ).focus();
                },
              },
              x,
