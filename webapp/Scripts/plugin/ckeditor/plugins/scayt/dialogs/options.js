...
CKEDITOR.dialog.add("scaytcheck", function (j) {
  ...
  function x(b, a) {
    if (b) {
      ...
      if (void 0 == e) b.checked = b.value == a.toString();
        ...
        for (var d = 0; d < e; d++)
          (b[d].checked = !1),
            b[d].value == a.toString() && (b[d].checked = !0);
    }
  }
  function n(b) {
    f.getById("dic_message_" + a).setHtml(
  ...
  var s = !0,
    ...
    u = 0,
    m = [
      "dic_create_" + a + ",dic_restore_" + a,
      "dic_rename_" + a + ",dic_delete_" + a,
    ],
  ...
  var A = function () {
      ...
      for (e = i.length; c < e; c += 1)
        if ((d = f.getById(i[c]))) d.on("click", b, this);
    },
    y = function () {
      var b = this;
      if (1 == l[0])
        for (var g = w(), e = 0, d = g.length; e < d; e++) {
          ...
          if (
            i &&
            ((g[e].checked = !1),
            1 == b.options[h.split("_")[0]] && (g[e].checked = !0),
            s)
          )
            i.on("click", function () {
