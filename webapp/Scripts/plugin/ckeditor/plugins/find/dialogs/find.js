    ...
    n = function (c, g) {
      ...
      var z =
        ...
        e = {
            ...
            for (var i = new w(a, !b), j = 0, k = "%"; null !== k; ) {
              ...
              if (2 == j) {
                if (d) {
                  ...
                  h = new l(h, !0);
                  m = new l(m, !0);
                  if (!x(h.back().character) || !x(m.next().character))
                    continue;
                }
          ...
          replaceCounter: 0,
          replace: function (a, b, d, f, e, g, i) {
            o = 1;
            a = 0;
            if (
              this.matchRange &&
              ...
              return function (e) {
                ...
                if (c) {
                  var j,
                    ...
                    h = p.length;
                  for (k = 0; k < h; k++)
                    (i = this.getContentElement(u[e], p[k][e])),
                      (j = this.getContentElement(u[g], p[k][g])),
