!(function (a) {
  var b = function (b, c) {
    ...
    (this.min = this.element.data("slider-min") || c.min),
      (this.max = this.element.data("slider-max") || c.max),
      (this.step = this.element.data("slider-step") || c.step),
      (this.value = this.element.data("slider-value") || c.value),
  ...
  (b.prototype = {
    ...
    mousedown: function (b) {
      ...
      (this.percentage[this.dragged] = c),
        this.layout(),
        this.touchCapable
          ? a(document).on({
    ...
    mouseup: function (b) {
      ...
      return (
        this.element
          .trigger({ type: "slideStop", value: c })
          .data("value", c)
          .prop("value", c),
        !1
      );
    ...
    (a.fn.slider = function (c, d) {
      return this.each(function () {
        ...
        f ||
          e.data(
            "slider",
            (f = new b(this, a.extend({}, a.fn.slider.defaults, g)))
          ),
