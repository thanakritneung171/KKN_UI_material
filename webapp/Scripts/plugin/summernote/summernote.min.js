!(function (a) {
  ...
  var b,
    ...
    j = (function () {
      var b = function (b) {
        ...
        k = function (b) {
          ...
          var e;
          return (
            (e = c.is(".note-editor, .note-air-editor")
              ? c
              : a("#note-editor-" + g.last(c.attr("id").split("-")))),
            d(e)
          );
        },
        l = function (a) {
        ...
        Z = function (a, c) {
          ...
          if (0 === a.offset) {
            ...
            Y(a.node)
              ? ((d = a.node.childNodes[a.offset - 1]), (e = E(d)))
        ...
        $ = function (a, c) {
          ...
          if (E(a.node) === a.offset) {
            ...
            Y(a.node)
              ...
              : ((d = a.node), (e = c ? E(a.node) : a.offset + 1));
          return { node: d, offset: e };
        },
        _ = function (a, b) {
    ...
    k = (function () {
      var b = function (a, b) {
          ...
          if (0 !== c && j.isText(h[c - 1])) {
            ...
            for (
              var m = l.text.replace(/[\r\n]/g, "").length;
              m > k.nodeValue.length && k.nextSibling;
            ...
            b &&
              k.nextSibling &&
              j.isText(k.nextSibling) &&
              m === k.nodeValue.length &&
              ((m -= k.nodeValue.length), (k = k.nextSibling)),
              (e = k),
              (c = m);
          }
        ...
        d = function (b, h, i, k) {
          ...
          (this.getPoints = function () {
            ...
            (this.normalize = function () {
              var a = function (a) {
                  return (
                    j.isVisiblePoint(a) ||
                      (a = j.isLeftEdgePoint(a)
                        ? j.nextPointUntil(a, j.isVisiblePoint)
                        : j.prevPointUntil(a, j.isVisiblePoint)),
                    a
                  );
                },
                ...
                j.walkPoint(
                  ...
                  function (b) {
                    if (!j.isEditable(b.node)) {
                      var e;
                      d
                        ? (j.isLeftEdgePoint(b) && k.push(b.node),
                          j.isRightEdgePoint(b) &&
                            g.contains(k, b.node) &&
                            (e = b.node))
                        : (e = c ? j.ancestor(b.node, a) : b.node),
                        e && a(e) && i.push(e);
                    }
                  },
                  !0
            ...
            (this.expand = function (a) {
              ...
              return (
                c && ((f.sc = c), (f.so = 0)),
                e && ((f.ec = e), (f.eo = j.nodeLength(e))),
                new d(f.sc, f.so, f.ec, f.eo)
              );
            }),
            ...
            (this.splitText = function () {
              ...
              return (
                j.isText(i) &&
                  !j.isEdgePoint(this.getEndPoint()) &&
                  i.splitText(k),
                j.isText(b) &&
                  !j.isEdgePoint(this.getStartPoint()) &&
                  ((c.sc = b.splitText(h)),
                  (c.so = 0),
                  a && ((c.ec = c.sc), (c.eo = k - h))),
            ...
            (this.deleteContents = function () {
              ...
              return (
                a.each(c, function (a, b) {
                  var c = b.parentNode;
                  e.node !== c && 1 === j.nodeLength(c) && f.push(c),
                    j.remove(b, !1);
                }),
          ...
          (this.isOnEditable = m(j.isEditable)),
            (this.isOnList = m(j.isList)),
            (this.isOnAnchor = m(j.isAnchor)),
            ...
            (this.wrapBodyInlineWithPara = function () {
              ...
              if (j.isInline(b)) {
                ...
                (a = g.last(c)),
                  j.isInline(a) || (a = c[c.length - 2] || b.childNodes[h]);
              } else a = b.childNodes[h > 0 ? h - 1 : 0];
              var e = j.listPrev(a, j.isParaInline).reverse();
              if (
                ((e = e.concat(j.listNext(a.nextSibling, j.isParaInline))),
                e.length)
              ) {
            ...
            (this.bookmark = function (a) {
              return {
                s: { path: j.makeOffsetPath(a, b), offset: h },
                e: { path: j.makeOffsetPath(a, i), offset: k },
              };
            }),
      ...
      return {
        create: function (a, c, f, g) {
          if (arguments.length) 2 === arguments.length && ((f = a), (g = c));
            ...
            j.isText(n.node) &&
              j.isLeftEdgePoint(n) &&
              j.isTextNode(o.node) &&
              j.isRightEdgePoint(o) &&
              o.node.nextSibling === n.node &&
              (n = o),
              (a = n.cont),
              (c = n.offset),
              (f = o.cont),
        ...
        createFromNode: function (a) {
          var b = a,
            ...
            e = j.nodeLength(d);
          return (
            j.isVoid(b) && ((c = j.listPrev(b).length - 1), (b = b.parentNode)),
            j.isBR(d)
              ? ((e = j.listPrev(d).length - 1), (d = d.parentNode))
              : j.isVoid(d) && ((e = j.listPrev(d).length), (d = d.parentNode)),
            this.create(b, c, d, e)
          );
        },
      ...
      var b = [],
        ...
        f = function (b) {
          null !== b.contents && a.html(b.contents),
            null !== b.bookmark && k.createFromBookmark(d, b.bookmark).select();
        };
      (this.undo = function () {
        c > 0 && (c--, f(b[c]));
      }),
      ...
      (this.stylePara = function (b, c) {
        ...
        (this.styleNodes = function (b, c) {
          ...
          var i = j.makePredByNodeName(d),
            k = a.map(b.nodes(j.isText, { fullyContains: !0 }), function (a) {
        ...
        (this.current = function (c, d) {
          var e = a(j.isText(c.sc) ? c.sc.parentNode : c.sc),
            ...
            g = b(e, f) || {};
          if (
            ((g["font-size"] = parseInt(g["font-size"], 10)),
            (g["font-bold"] = document.queryCommandState("bold")
              ? "bold"
              : "normal"),
            (g["font-italic"] = document.queryCommandState("italic")
              ? "italic"
              : "normal"),
            (g["font-underline"] = document.queryCommandState("underline")
              ? "underline"
              : "normal"),
            (g["font-strikethrough"] = document.queryCommandState(
              "strikeThrough"
            )
              ? "strikethrough"
              : "normal"),
            (g["font-superscript"] = document.queryCommandState("superscript")
              ? "superscript"
              : "normal"),
            (g["font-subscript"] = document.queryCommandState("subscript")
              ? "subscript"
              : "normal"),
            c.isOnList())
          ) {
          ...
          if (k && k.style["line-height"])
            ...
            var l =
              parseInt(g["line-height"], 10) / parseInt(g["font-size"], 10);
            g["line-height"] = l.toFixed(1);
          }
          return (
            (g.image = j.isImg(d) && d),
            (g.anchor = c.isOnAnchor() && j.ancestor(c.sc, j.isAnchor)),
            (g.ancestors = j.listAncestor(c.sc, j.isEditable)),
            (g.range = c),
            g
          );
        });
    ...
    q = function () {
      (this.insertTab = function (a, b, c) {
        ...
        (this.insertParagraph = function () {
          ...
          var c,
            d = j.ancestor(b.sc, j.isPara);
          if (d) {
            c = j.splitTree(d, b.getStartPoint());
            var e = j.listDescendant(d, j.isEmptyAnchor);
            (e = e.concat(j.listDescendant(c, j.isEmptyAnchor))),
              a.each(e, function (a, b) {
                j.remove(b);
              });
          } else {
            ...
            (c = a(j.emptyPara)[0]),
              f ? b.sc.insertBefore(c, f) : b.sc.appendChild(c);
          }
      ...
      (this.insertOrderedList = function () {
        ...
        (this.indent = function () {
          ...
          a.each(e, function (c, d) {
            var e = g.head(d);
            j.isLi(e)
              ? b.wrapList(d, e.parentNode.nodeName)
        ...
        (this.toggleList = function (b) {
          ...
          if (g.find(e, j.isPurePara)) {
            ...
            var m = d
              .nodes(j.isList, { includeAncestor: !0 })
              .filter(function (c) {
        ...
        (this.wrapList = function (b, c) {
          ...
          return (
            ...
            j.appendChildNodes(i, b),
            h && (j.appendChildNodes(i, g.from(h.childNodes)), j.remove(h)),
            b
          );
        }),
              ...
              var f = g.head(e),
                ...
                k =
                  i.childNodes.length > 1
                    ? j.splitTree(
                        i,
                        { node: h.parentNode, offset: j.position(h) + 1 },
                        !0
                      )
                    : null,
                l = j.splitTree(
                  i,
                  { node: f.parentNode, offset: j.position(f) },
                  !0
                );
              (e = c
                ? j.listDescendant(l, j.isLi)
                : g.from(l.childNodes).filter(j.isLi)),
                (c || !j.isList(i.parentNode)) &&
    ...
    t = function () {
      ...
      for (
        var l = (this.beforeCommand = function (a) {
            h(a);
          }),
      ...
      (this.tab = function (a, b) {
        var e = k.create();
        e.isCollapsed() && e.isOnCell()
          ? c.tab(e)
          : (l(a), d.insertTab(a, e, b.tabsize), n(a));
      }),
        (this.untab = function () {
          var a = k.create();
        ...
        (this.insertImage = function (a, b, c) {
          m.createImage(b, c)
            .then(function (b) {
              l(a),
                b.css({ display: "", width: Math.min(a.width(), b.width()) }),
                k.create().insertNode(b[0]),
                k.createFromNode(b[0]).collapse().select(),
                n(a);
            })
            .fail(function () {
      ...
      (this.fontSize = function (c, d) {
        ...
        (this.insertTable = function (a, b) {
          ...
          var e = k.create();
          (e = e.deleteContents()),
            e.insertNode(c.createTable(d[0], d[1])),
            n(a);
        }),
    ...
    u = function () {
      (this.update = function (b, c) {
        ...
        if (c.image) {
          ...
          var i = g.attr("style");
          return (
            f('button[data-event="resize"][data-value="1"]', function () {
        ...
        o.find(".note-current-fontsize").text(c["font-size"]),
          ...
          if (j.isControlSizing(d.target)) {
            ...
            c
              .on("mousemove", function (a) {
                b.invoke(
                  "editor.resizeTo",
                  { x: a.clientX - m.left, y: a.clientY - (m.top - n) },
                  l,
                  !a.shiftKey
                ),
                  b.invoke("handle.update", f, { image: k }, o),
                  b.invoke("popover.update", g, { image: k }, o);
              })
              .one("mouseup", function () {
      ...
      (this.sync = function (b) {
        ...
        (this.activate = function (c) {
          var d = c.editor(),
            ...
            l = d.data("options");
          if (
            (h.val(j.html(g, l.prettifyHtml)),
            h.height(g.height()),
            a.invoke("toolbar.updateCodeview", f, !0),
            a.invoke("popover.hide", i),
            a.invoke("handle.hide", k),
            d.addClass("codeview"),
            h.focus(),
            e.hasCodeMirror)
          ) {
        ...
        (this.deactivate = function (b) {
          ...
          f.html(j.value(g, h.prettifyHtml) || j.emptyPara),
            f.height(h.height ? g.height() : "auto"),
            c.removeClass("codeview"),
            f.focus(),
            a.invoke("toolbar.updateCodeview", d, !1);
        });
    },
    C = function (b) {
      var c = a(document);
      (this.attach = function (a, b) {
        b.airMode || b.disableDragAndDrop
            ...
            h
              .on("drop", function (c) {
                ...
                d && d.files && d.files.length
                  ? (g.editable().focus(), b.insertImages(g, d.files))
                  : e
                  ? a(e).each(function () {
                      g.editable().focus(),
                  ...
                  : f &&
                    (g.editable().focus(),
                    b.invoke("editor.insertText", g.editable(), f));
              })
              .on("dragover", !1);
        });
    },
    D = function (b) {
      ...
      var c = function (c) {
        ...
        if (!d || !d.items || !d.items.length) {
          ...
          return (
            b.invoke("editor.saveNode", f),
            b.invoke("editor.saveRange", f),
            f.html(""),
            void setTimeout(function () {
              ...
              if (c.length && -1 !== c[0].src.indexOf("data:")) {
                for (
                  ...
                  h[i] = g.charCodeAt(i);
                var j = new Blob([h], { type: "image/png" });
                (j.name = "clipboard.png"),
                  b.invoke("editor.restoreNode", f),
                  b.invoke("editor.restoreRange", f),
                  b.insertImages(e, [j]),
                  b.invoke("editor.afterCommand", f);
              } else {
                var k = f.html();
                b.invoke("editor.restoreNode", f),
                  b.invoke("editor.restoreRange", f);
        ...
        k && b.insertImages(e, [i.getAsFile()]),
          b.invoke("editor.afterCommand", f);
      };
    },
    E = function (b) {
    ...
    F = function (b) {
      ...
      (this.show = function (a) {
        ...
        b.invoke("editor.saveRange", d),
          this.showImageDialog(d, c)
            .then(function (c) {
              b.invoke("editor.restoreRange", d),
                "string" == typeof c
                  ? b.invoke("editor.insertImage", d, c)
                  : b.insertImages(a, c);
            })
            .fail(function () {
              b.invoke("editor.restoreRange", d);
      ...
      (this.invoke = function () {
        ...
        (this.insertImages = function (c, d) {
          var e = c.editor(),
            ...
            i = e.data("options");
          h.onImageUpload
            ? (h.onImageUpload(d, b.editor, f), q(g, "image.upload")([d]))
            : a.each(d, function (a, c) {
                var d = c.name;
                i.maximumImageFileSize && i.maximumImageFileSize < c.size
                  ? h.onImageUploadError
                    ? (h.onImageUploadError(
                        i.langInfo.image.maximumFileSizeError
                      ),
                      q(
                        g,
                        "image.upload.error"
                      )(i.langInfo.image.maximumFileSizeError))
                    : alert(i.langInfo.image.maximumFileSizeError)
                  : m
                      .readFileAsDataURL(c)
                      .then(function (a) {
      ...
      var c = {
        ...
        k = function (d) {
          ...
          if (e.length) {
            ...
            if (
              -1 !==
              a.inArray(i, ["resize", "floatMe", "removeMedia", "imageShape"])
            ) {
              var n = m.handle().find(".note-control-selection");
              h = a(n.data("target"));
            }
            if (
              (l && e.parents(".popover").hide(),
              a.isFunction(a.summernote.pluginEvents[i]))
            )
              a.summernote.pluginEvents[i](d, b.editor, m, k);
            else if (b.editor[i]) {
              var o = m.editable();
        ...
        p = function (b, c) {
          ...
          var k = { c: Math.ceil(d.x / l) || 1, r: Math.ceil(d.y / l) || 1 };
          h.css({ width: k.c + "em", height: k.r + "em" }),
            g.attr("data-value", k.c + "x" + k.r),
            3 < k.c &&
              k.c < c.insertTableMaxSize.col &&
              i.css({ width: k.c + 1 + "em" }),
            3 < k.r &&
              k.r < c.insertTableMaxSize.row &&
      ...
      (this.bindKeyMap = function (d, e) {
        ...
        g.on("keydown", function (h) {
          ...
          if (k)
            if (a.summernote.pluginEvents[k]) {
              ...
              b.editor[k]
                ? (b.editor[k](g, f.data("options")), h.preventDefault())
                : c[k] && (c[k].call(this, d), h.preventDefault());
          else n.isEdit(h.keyCode) && b.editor.afterCommand(g);
        });
      }),
        (this.attach = function (a, c) {
          c.shortcuts && this.bindKeyMap(a, c.keyMap[e.isMac ? "mac" : "pc"]),
            a.editable().on("mousedown", d),
            a.editable().on("keyup mouseup", f),
            a.editable().on("scroll", h),
            b.clipboard.attach(a, c),
            b.handle.attach(a, c),
            a.popover().on("click", k),
            a.popover().on("mousedown", i),
            b.dragAndDrop.attach(a, c),
            c.airMode ||
              (a.toolbar().on("click", k),
              a.toolbar().on("mousedown", i),
              b.statusbar.attach(a, c));
          ...
          if (
            (a.editable().data("NoteHistory", q),
            c.onenter &&
              a.editable().keypress(function (a) {
                a.keyCode === n.ENTER && c.onenter(a);
              }),
            c.onfocus && a.editable().focus(c.onfocus),
            c.onblur && a.editable().blur(c.onblur),
            c.onkeyup && a.editable().keyup(c.onkeyup),
            c.onkeydown && a.editable().keydown(c.onkeydown),
            c.onpaste && a.editable().on("paste", c.onpaste),
            c.onToolbarClick && a.toolbar().click(c.onToolbarClick),
            c.onChange)
          ) {
            var r = function () {
        ...
        (this.attachCustomEvent = function (b, c) {
          var d = b.holder(),
            f = b.editable();
          if (
            (f.on("mousedown", q(d, "mousedown")),
            f.on("keyup mouseup", q(d, "update")),
            f.on("scroll", q(d, "scroll")),
            ...
            f.blur(q(d, "blur")),
            f.keyup(q(d, "keyup")),
            f.keydown(q(d, "keydown")),
            f.on("paste", q(d, "paste")),
            c.airMode ||
              (b.toolbar().click(q(d, "toolbar.click")),
              b.popover().click(q(d, "popover.click"))),
            e.isMSIE)
          ) {
            var h =
              "DOMCharacterDataModified DOMSubtreeModified DOMNodeInserted";
          ...
          j.isTextarea(g.head(d)) &&
            d.closest("form").submit(function (a) {
              var b = d.code();
              q(d, "submit").call(this, a, b);
            }),
            q(d, "init")();
          for (var i = 0, k = a.summernote.plugins.length; k > i; i++)
            a.isFunction(a.summernote.plugins[i].init) &&
              a.summernote.plugins[i].init(b);
        }),
    ...
    I = function () {
      var b = function (a, b) {
        ...
        g = function (a, b, c, d) {
          return (
            ...
            c +
            "</div>" +
            (d ? '<div class="modal-footer">' + d + "</div>" : "") +
            "</form></div></div></div>"
          );
        },
        h = {
          ...
          table: function (a, b) {
            var d =
              '<ul class="note-table dropdown-menu"><div class="note-dimension-picker"><div class="note-dimension-picker-mousecatcher" data-event="insertTable" data-value="1x1"></div><div class="note-dimension-picker-highlighted"></div><div class="note-dimension-picker-unhighlighted"></div></div><div class="note-dimension-display"> 1 x 1 </div></ul>';
          ...
          fontname: function (a, c) {
            var d = [],
              f = c.fontNames.reduce(function (a, b) {
                return e.isFontInstalled(b) ||
                  -1 !== c.fontNamesIgnoreCheck.indexOf(b)
                  ? (d.push(b),
                    a +
          ...
          color: function (a, c) {
            var d =
                '<i class="' +
                c.iconPrefix +
                'font" style="color:black;background-color:yellow;"></i>',
              e = b(d, {
              ...
              g = b("", { title: a.color.more, dropdown: f });
            return e + g;
          },
          bold: function (a, b) {
        ...
        i = function (e, f) {
          var g = function () {
            ...
            j = function () {
              for (
                var b = a("<div />"), c = 0, g = f.airPopover.length;
                g > c;
                c++
              ) {
                for (
                  var i = f.airPopover[c],
                    j = a('<div class="note-' + i[0] + ' btn-group">'),
                    k = 0,
                    l = i[1].length;
                  l > k;
                  k++
        ...
        l = function (a, b) {
          ...
          return (
            ...
            d.join('</div><div class="note-shortcut-row row">') +
            "</div>"
          );
        },
        m = function (a) {
        ...
        r = function (a, b) {
          ...
          return (
            b.extraKeys && d.push("<div " + c + ">" + q(a, b) + "</div>"),
        ...
        t = {
          image: function (a, b) {
            ...
            if (b.maximumImageFileSize) {
              var d = Math.floor(
                ...
                e =
                  1 * (b.maximumImageFileSize / Math.pow(1024, d)).toFixed(2) +
                  " " +
                  " KMGTP"[d] +
                  "B";
            ...
            var f =
                '<div class="form-group row-fluid note-group-select-from-files"><label>' +
                a.image.selectFromFiles +
                '</label><input class="note-image-input" type="file" name="files" accept="image/*" multiple="multiple" />' +
                c +
                '</div><div class="form-group row-fluid"><label>' +
                a.image.url +
                '</label><input class="note-image-url form-control span12" type="text" /></div>',
              h =
          ...
          link: function (a, b) {
            var c =
                ...
                '</label><input class="note-link-text form-control span12" type="text" /></div><div class="form-group row-fluid"><label>' +
                a.link.url +
          ...
          help: function (a, b) {
            var c =
              ...
              '<p class="text-center"><a href="//summernote.org/" target="_blank">Summernote 0.6.4</a> \xb7 <a href="//github.com/summernote/summernote" target="_blank">Project</a> \xb7 <a href="//github.com/summernote/summernote/issues" target="_blank">Issues</a></p>';
      ...
      (this.createLayoutByAirMode = function (b, c) {
        ...
        b.addClass("note-air-editor note-editable"),
          b.attr({ id: "note-editor-" + h, contentEditable: !0 });
        var j = document.body,
          l = a(i(d, c));
        ...
        (this.createLayoutByFrame = function (b, c) {
          ...
          var g = !b.is(":disabled"),
            l = a(
              '<div class="note-editable" contentEditable="' + g + '"></div>'
            ).prependTo(f);
          c.height && l.height(c.height),
            c.direction && l.attr("dir", c.direction);
          var m = b.attr("placeholder") || c.placeholder;
          m && l.attr("data-placeholder", m),
            l.html(j.html(b)),
            a('<textarea class="note-codable"></textarea>').prependTo(f);
          for (
            var n = a('<div class="note-toolbar btn-toolbar" />'),
              o = 0,
              p = c.toolbar.length;
            p > o;
            o++
            ...
            for (
              var q = c.toolbar[o][0],
                r = c.toolbar[o][1],
                s = a('<div class="note-' + q + ' btn-group" />'),
                t = 0,
                w = r.length;
              w > t;
              t++
