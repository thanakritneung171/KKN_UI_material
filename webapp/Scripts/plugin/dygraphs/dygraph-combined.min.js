...
(Date.ext = {}),
  (Date.ext.util = {}),
  (Date.ext.util.xPad = function (a, b, c) {
    for (
  ...
  (Date.ext.formats = {
    ...
    V: function (a) {
      var b = parseInt(Date.ext.formats.W(a), 10),
        ...
        d = b + (c > 4 || 1 >= c ? 0 : 1);
      return (
        53 == d && new Date("" + a.getFullYear() + "/12/31").getDay() < 4
          ? (d = 1)
          : 0 === d &&
            (d = Date.ext.formats.V(
              new Date("" + (a.getFullYear() - 1) + "/12/31")
            )),
        Date.ext.util.xPad(d, 0)
      );
    },
    w: "getDay",
    W: function (a) {
  ...
  (Date.prototype.strftime = function (a) {
    this.locale in Date.ext.locales ||
      (this.locale.replace(/-[a-zA-Z]+$/, "") in Date.ext.locales
        ...
        : (this.locale = "en-GB"));
    for (var b = this; a.match(/%[cDhnrRtTxXzZ]/); )
      a = a.replace(/%([cDhnrRtTxXzZ])/g, function (a, c) {
    ...
    var c = a.replace(/%([aAbBCdegGHIjmMpPSuUVwWyY%])/g, function (a, c) {
      ...
      return "string" == typeof d
        ...
        : "function" == typeof d
        ? d.call(b, b)
        : "object" == typeof d && "string" == typeof d[0]
        ? Date.ext.util.xPad(b[d[0]](), d[1])
        : c;
    });
    return (b = null), c;
  }),
      ...
      return a.arguments && a.stack
        ...
        ? a.stacktrace
          ? a.message.indexOf("\n") > -1 &&
            ...
            ? "opera9"
            : a.stack
            ? a.stacktrace.indexOf("called from line") < 0
              ? "opera10b"
              : "opera11"
            : "opera10a"
          : "opera9"
    ...
    instrumentFunction: function (a, b, c) {
      ...
      (a[b] = function () {
        return (
          ...
          a[b]._instrumented.apply(this, arguments)
        );
      }),
        (a[b]._instrumented = d);
    },
    deinstrumentFunction: function (a, b) {
      a[b].constructor === Function &&
        a[b]._instrumented &&
        a[b]._instrumented.constructor === Function &&
    ...
    other: function (a) {
      for (
        ...
        (b = e.test(a.toString()) ? RegExp.$1 || d : d),
          (c = Array.prototype.slice.call(a.arguments || [])),
      ...
      for (var b = [], c = Array.prototype.slice, d = 0; d < a.length; ++d) {
        ...
        void 0 === e
          ...
          : e.constructor &&
            (e.constructor === Array
              ? e.length < 3
                ? (b[d] = "[" + this.stringifyArguments(e) + "]")
                : (b[d] =
                    "[" +
                    this.stringifyArguments(c.call(e, 0, 1)) +
                    "..." +
                    this.stringifyArguments(c.call(e, -1)) +
                    "]")
    ...
    findFunctionName: function (a, b) {
      for (
        var c,
          ...
          e,
          f = /function\s+([^(]*?)\s*\(([^)]*)\)/,
          g = /['"]?([0-9A-Za-z_]+)['"]?\s*[:=]\s*function\b/,
          h = /['"]?([0-9A-Za-z_]+)['"]?\s*[:=]\s*(?:eval|new Function)\b/,
          i = "",
          j = Math.min(b, 20),
          k = 0;
        j > k;
  ...
  (CanvasRenderingContext2D.prototype.installPattern = function (a) {
    if ("undefined" != typeof this.isPatternInstalled)
            ...
            for (var r = b[0], s = 0; p > s; ) {
              ...
              (s += b[1] ? b[1] : t),
                s > p
                  ? ((b = [r, s - p]), (s = p))
                  : (b = [(r + 1) % a.length, 0]),
                r % 2 === 0 ? e.call(this, s, 0) : f.call(this, s, 0),
                (r = (r + 1) % a.length);
            }
...
var DygraphOptions = (function () {
    ...
    return (
          ...
          if (c) {
            for (var d = 0, e = 0; e < this.labels_.length; e++) {
              var f = this.labels_[e],
                ...
                i = g.axis;
              "object" == typeof i &&
                ((h = ++d), (this.yAxes_[h] = { series: [f], options: i })),
                i || this.yAxes_[0].series.push(f),
                (this.series_[f] = { idx: e, yAxis: h, options: g });
            }
            for (var e = 0; e < this.labels_.length; e++) {
              var f = this.labels_[e],
                ...
                i = g.axis;
              if ("string" == typeof i) {
                if (!this.series_.hasOwnProperty(i))
                  return void Dygraph.error(
                    "Series " +
                      f +
                      " wants to share a y-axis with series " +
                      i +
            ...
            for (var e = 0; e < this.labels_.length; e++) {
              ...
              (this.series_[f] = { idx: e, yAxis: h, options: g }),
                this.yAxes_[h]
                  ? this.yAxes_[h].series.push(f)
                  : (this.yAxes_[h] = { series: [f], options: {} });
            }
          var j = this.user_.axes || {};
          Dygraph.update(this.yAxes_[0].options, j.y || {}),
            this.yAxes_.length > 1 &&
              Dygraph.update(this.yAxes_[1].options, j.y2 || {}),
      ...
      (a.prototype.getGlobalDefault_ = function (a) {
        return this.global_.hasOwnProperty(a)
          ? this.global_[a]
          : Dygraph.DEFAULT_ATTRS.hasOwnProperty(a)
          ? Dygraph.DEFAULT_ATTRS[a]
          : null;
      }),
      ...
      (a.prototype.getForSeries = function (a, b) {
        if (
          b === this.dygraph_.getHighlightSeries() &&
          this.highlightSeries_.hasOwnProperty(a)
        )
          return this.highlightSeries_[a];
...
(DygraphLayout.prototype.attr_ = function (a) {
  ...
  (DygraphLayout.prototype.setAnnotations = function (a) {
    ...
    for (
      ...
      var d = {};
      if (!a[c].xval && void 0 === a[c].x)
        return void this.dygraph_.error(
          "Annotations must have an 'x' property"
        );
      if (
        a[c].icon &&
        (!a[c].hasOwnProperty("width") || !a[c].hasOwnProperty("height"))
      )
        return void this.dygraph_.error(
          "Must set width and height when setting annotation.icon property"
        );
      Dygraph.update(d, a[c]),
        d.xval || (d.xval = b(d.x)),
  ...
  (DygraphLayout.prototype._evaluateLimits = function () {
    ...
    for (var c = 0; c < this.yAxes_.length; c++) {
      var d = this.yAxes_[c];
      (d.minyval = d.computedValueRange[0]),
        (d.maxyval = d.computedValueRange[1]),
        (d.yrange = d.maxyval - d.minyval),
        (d.yscale = 0 !== d.yrange ? 1 / d.yrange : 1),
        d.g.attr_("logscale") &&
          ((d.ylogrange = Dygraph.log10(d.maxyval) - Dygraph.log10(d.minyval)),
          (d.ylogscale = 0 !== d.ylogrange ? 1 / d.ylogrange : 1),
          (!isFinite(d.ylogrange) || isNaN(d.ylogrange)) &&
            d.g.error(
              "axis " +
                c +
                " of graph at " +
  ...
  (DygraphLayout._calcYNormal = function (a, b, c) {
    return c
      ? 1 - (Dygraph.log10(b) - Dygraph.log10(a.minyval)) * a.ylogscale
      : 1 - (b - a.minyval) * a.yscale;
  }),
  (DygraphLayout.prototype._evaluateLineCharts = function () {
    for (
      var a = this.attr_("connectSeparatedPoints"),
        b = this.attr_("stackedGraph"),
        c = this.attr_("errorBars") || this.attr_("customBars"),
        d = 0;
      ...
      for (
        var e = this.points[d],
          f = this.setNames[d],
          g = this.dygraph_.axisPropertiesForSeries(f),
          h = this.dygraph_.attributes_.getForSeries("logscale", f),
          i = 0;
        i < e.length;
        i++
      ) {
        ...
        var k = j.yval;
        b &&
          ((j.y_stacked = DygraphLayout._calcYNormal(g, j.yval_stacked, h)),
          null === k || isNaN(k) || (k = j.yval_stacked)),
          null === k && ((k = NaN), a || (j.yval = NaN)),
          (j.y = DygraphLayout._calcYNormal(g, k, h)),
          c &&
            ((j.y_top = DygraphLayout._calcYNormal(g, k - j.yval_minus, h)),
            (j.y_bottom = DygraphLayout._calcYNormal(g, k + j.yval_plus, h)));
      }
  }),
  ...
  (DygraphLayout.prototype._evaluateLineTicks = function () {
    var a, b, c, d;
    for (this.xticks = [], a = 0; a < this.xTicks_.length; a++)
      (b = this.xTicks_[a]),
        (c = b.label),
        (d = this.xscale * (b.v - this.minxval)),
        d >= 0 && 1 >= d && this.xticks.push([d, c]);
    for (this.yticks = [], a = 0; a < this.yAxes_.length; a++)
      for (var e = this.yAxes_[a], f = 0; f < e.ticks.length; f++)
        (b = e.ticks[f]),
          (c = b.label),
          (d = this.dygraph_.toPercentYCoord(b.v, a)),
          d >= 0 && 1 >= d && this.yticks.push([a, d, c]);
  }),
...
var DygraphCanvasRenderer = function (a, b, c, d) {
  if (
    ...
    !this.isIE && !DygraphCanvasRenderer.isSupported(this.element))
  )
    throw "Canvas is not supported.";
  if (
    ((this.area = d.getPlotArea()),
    (this.container.style.position = "relative"),
    (this.container.style.width = this.width + "px"),
    this.dygraph_.isUsingExcanvas_)
  )
    this._createIEClipArea();
  else if (!Dygraph.isAndroid()) {
    var e = this.dygraph_.canvas_ctx_;
    e.beginPath(),
      e.rect(this.area.x, this.area.y, this.area.w, this.area.h),
      e.clip(),
      (e = this.dygraph_.hidden_ctx_),
      e.beginPath(),
      e.rect(this.area.x, this.area.y, this.area.w, this.area.h),
      e.clip();
  }
...
(DygraphCanvasRenderer.prototype.attr_ = function (a, b) {
  ...
  (DygraphCanvasRenderer.prototype.clear = function () {
    ...
    if (this.isIE)
      try {
        this.clearDelay && (this.clearDelay.cancel(), (this.clearDelay = null)),
  ...
  (DygraphCanvasRenderer.prototype._createIEClipArea = function () {
    function a(a) {
      if (0 !== a.w && 0 !== a.h) {
        ...
        (d.className = b),
          ...
          (d.style.height = a.h + "px"),
          c.appendChild(d);
      }
    }
    for (
      var b = "dygraph-clip-div",
        c = this.dygraph_.graphDiv,
        d = c.childNodes.length - 1;
      d >= 0;
      d--
    )
      c.childNodes[d].className == b && c.removeChild(c.childNodes[d]);
    for (
      var e = document.bgColor, f = this.dygraph_.graphDiv;
      f != document;
    ...
    var h = this.area;
    a({ x: 0, y: 0, w: h.x, h: this.height }),
      a({ x: h.x, y: 0, w: this.width - h.x, h: h.y }),
      a({ x: h.x + h.w, y: 0, w: this.width - h.x - h.w, h: this.height }),
      a({
        x: h.x,
        y: h.y + h.h,
        w: this.width - h.x,
  ...
  (DygraphCanvasRenderer._drawStyledLine = function (a, b, c, d, e, f, g) {
    ...
    var j = h.getOption("drawGapEdgePoints", a.setName),
      k = a.points,
      l = Dygraph.createIterator(
        k,
        0,
        k.length,
        DygraphCanvasRenderer._getIteratorPredicate(
          h.getOption("connectSeparatedPoints")
        )
      ),
      m = d && d.length >= 2,
      n = a.drawingContext;
    ...
    DygraphCanvasRenderer._drawPointsOnLine(a, o, f, b, g),
      m && n.uninstallPattern(),
      n.restore();
  }),
  (DygraphCanvasRenderer._drawSeries = function (a, b, c, d, e, f, g, h) {
    ...
    for (
      var q = b.array_, r = b.end_, s = b.predicate_, t = b.start_;
      r > t;
      t++
    ) {
      if (((j = q[t]), s)) {
      ...
      if (null === j.canvasy || j.canvasy != j.canvasy)
        g && null !== k && (p.moveTo(k, l), p.lineTo(j.canvasx, l)),
          (k = l = null);
      else {
        if (((i = !1), f || !k)) {
        ...
        null !== k
          ? c &&
            (g && (p.moveTo(k, l), p.lineTo(j.canvasx, l)),
            p.lineTo(j.canvasx, j.canvasy))
          : p.moveTo(j.canvasx, j.canvasy),
          (e || i) && n.push([j.canvasx, j.canvasy, j.idx]),
          (k = j.canvasx),
          (l = j.canvasy);
      }
      o = !1;
  ...
  (DygraphCanvasRenderer.prototype._updatePoints = function () {
    for (var a = this.layout.points, b = a.length; b--; )
      for (var c = a[b], d = c.length; d--; ) {
        var e = c[d];
        (e.canvasx = this.area.w * e.x + this.area.x),
          (e.canvasy = this.area.h * e.y + this.area.y);
      }
  }),
  (DygraphCanvasRenderer.prototype._renderLineChart = function (a, b) {
    var c,
      d,
      e = b || this.elementContext,
  ...
  (DygraphCanvasRenderer._linePlotter = function (a) {
    ...
    e &&
      ...
      DygraphCanvasRenderer._drawStyledLine(
        a,
        b.getOption("strokeBorderColor", c),
        d + 2 * e,
        g,
        h,
        f,
      ...
      DygraphCanvasRenderer._drawStyledLine(a, a.color, d, g, h, f, i);
  }),
    ...
    if (d) {
      ...
      var f,
        ...
        l = Dygraph.createIterator(
          ...
          k.length,
          DygraphCanvasRenderer._getIteratorPredicate(
            b.getOption("connectSeparatedPoints")
          )
        ),
        m = NaN,
        n = NaN,
      ...
      for (
        ...
        var s = l.next();
        (!j && r(s.y)) || (j && !isNaN(n) && r(n))
          ? (m = NaN)
          : (j
              ? ((f = [s.y_bottom, s.y_top]), (n = s.y))
              : (f = [s.y_bottom, s.y_top]),
            (f[0] = a.plotArea.h * f[0] + a.plotArea.y),
            (f[1] = a.plotArea.h * f[1] + a.plotArea.y),
            isNaN(m) ||
              (j
                ? (g.moveTo(m, o[0]),
                  g.lineTo(s.canvasx, o[0]),
                  g.lineTo(s.canvasx, o[1]))
                : (g.moveTo(m, o[0]),
                  g.lineTo(s.canvasx, f[0]),
                  g.lineTo(s.canvasx, f[1])),
              g.lineTo(m, o[1]),
              g.closePath()),
            (o = f),
            (m = s.canvasx));
  ...
  (DygraphCanvasRenderer._fillPlotter = function (a) {
    if (!a.singleSeriesName && 0 === a.seriesIndex) {
      for (
        var b = a.dygraph, c = b.getLabels().slice(1), d = c.length;
        d >= 0;
        d--
      )
        b.visibility()[d] || c.splice(d, 1);
      var e = (function () {
      ...
      if (e)
        for (
          var f,
            ...
            j = a.allSeriesPoints,
            k = j.length,
            l = b.getOption("fillAlpha"),
            m = b.getOption("stackedGraph"),
            n = b.getColors(),
            o = {},
            p = k - 1;
          p >= 0;
            ...
            for (var C, D = !0; x.hasNext; ) {
              ...
              if (Dygraph.isOK(E.y)) {
                if (m) {
                  ...
                  var F;
                  (F = void 0 === f ? u : g ? f[0] : f),
                    (v = [E.canvasy, F]),
                    r
                      ? -1 === z[0]
                        ? (o[E.canvasx] = [E.canvasy, u])
                        : (o[E.canvasx] = [E.canvasy, z[0]])
                      : (o[E.canvasx] = E.canvasy);
                } else v = [E.canvasy, u];
                isNaN(y) ||
                  (h.moveTo(y, z[0]),
                  r ? h.lineTo(E.canvasx, z[0]) : h.lineTo(E.canvasx, v[0]),
                  g && f
                    ? h.lineTo(E.canvasx, f[1])
                    : h.lineTo(E.canvasx, v[1]),
                  h.lineTo(y, z[1]),
                  h.closePath()),
                  (z = v),
                  (y = E.canvasx);
                ...
                (y = NaN),
                  null === E.y_stacked ||
                    isNaN(E.y_stacked) ||
                    (o[E.canvasx] = i.h * E.y_stacked + i.y);
            }
            (g = r), h.fill();
          }
        }
...
(Dygraph.NAME = "Dygraph"),
  ...
  (Dygraph.numberValueFormatter = function (a, b, c, d) {
    var e = b("sigFigs");
    if (null !== e) return Dygraph.floatFormat(a, e);
    var f,
      g = b("digitsAfterDecimal"),
      h = b("maxNumberWidth"),
      i = b("labelsKMB"),
      j = b("labelsKMG2");
    if (
      ((f =
        0 !== a &&
        (Math.abs(a) >= Math.pow(10, h) || Math.abs(a) < Math.pow(10, -g))
          ? a.toExponential(g)
          : "" + Dygraph.round_(a, g)),
      i || j)
    ) {
      var k,
        l = [],
        m = [];
      i && ((k = 1e3), (l = Dygraph.KMB_LABELS)),
        j &&
          (i &&
            Dygraph.warn("Setting both labelsKMB and labelsKMG2. Pick one!"),
          (k = 1024),
          (l = Dygraph.KMG2_BIG_LABELS),
          (m = Dygraph.KMG2_SMALL_LABELS));
      for (
        var n = Math.abs(a), o = Dygraph.pow(k, l.length), p = l.length - 1;
        p >= 0;
        p--, o /= k
      )
        if (n >= o) {
          f = Dygraph.round_(a / o, g) + l[p];
          break;
        }
      if (j) {
        var q = String(a.toExponential()).split("e-");
        2 === q.length &&
          q[1] >= 3 &&
          q[1] <= 24 &&
          ((f =
            q[1] % 3 > 0
              ? Dygraph.round_(q[0] / Dygraph.pow(10, q[1] % 3), g)
              : Number(q[0]).toFixed(2)),
          (f += m[Math.floor(q[1] / 3) - 1]));
      }
    }
    return f;
  }),
  ...
  (Dygraph.dateAxisFormatter = function (a, b) {
    ...
    var c =
      ...
      a.getSeconds() +
      a.getMilliseconds();
    return 0 === c || b >= Dygraph.DAILY
      ? new Date(a.getTime() + 36e5).strftime("%d%b")
      : Dygraph.hmsString_(a.getTime());
  }),
  ...
  (Dygraph.prototype.__old_init__ = function (a, b, c, d) {
    if (null !== c) {
      for (var e = ["Date"], f = 0; f < c.length; f++) e.push(c[f]);
      Dygraph.update(d, { labels: e });
    }
    this.__init__(a, b, d);
  }),
  (Dygraph.prototype.__init__ = function (a, b, c) {
    ...
    (this.isUsingExcanvas_ = "undefined" != typeof G_vmlCanvasManager),
      (this.maindiv_ = a),
      (this.file_ = b),
      (this.rollPeriod_ = c.rollPeriod || Dygraph.DEFAULT_ROLL_PERIOD),
      (this.previousVerticalX_ = -1),
      (this.fractions_ = c.fractions || !1),
      (this.dateWindow_ = c.dateWindow || null),
      (this.annotations_ = []),
      (this.zoomed_x_ = !1),
      (this.zoomed_y_ = !1),
      (a.innerHTML = ""),
      "" === a.style.width && c.width && (a.style.width = c.width + "px"),
      "" === a.style.height && c.height && (a.style.height = c.height + "px"),
      "" === a.style.height &&
        0 === a.clientHeight &&
        ((a.style.height = Dygraph.DEFAULT_HEIGHT + "px"),
        "" === a.style.width && (a.style.width = Dygraph.DEFAULT_WIDTH + "px")),
      (this.width_ = a.clientWidth || c.width || 0),
      (this.height_ = a.clientHeight || c.height || 0),
      c.stackedGraph && (c.fillGraph = !0),
      (this.user_attrs_ = {}),
      Dygraph.update(this.user_attrs_, c),
      (this.attrs_ = {}),
      ...
      (this.plugins_ = []);
    for (
      var e = Dygraph.PLUGINS.concat(this.getOption("plugins")), f = 0;
      f < e.length;
      f++
    ) {
      var g = e[f],
        h = new g(),
        i = { plugin: h, events: {}, options: {}, pluginOptions: {} },
        j = h.activate(this);
    ...
    for (var f = 0; f < this.plugins_.length; f++) {
      ...
      for (var k in l.events)
        if (l.events.hasOwnProperty(k)) {
          var m = l.events[k],
            n = [l.plugin, m];
          k in this.eventListeners_
            ? this.eventListeners_[k].push(n)
            : (this.eventListeners_[k] = [n]);
        }
    }
  ...
  (Dygraph.prototype.optionsViewForAxis_ = function (a) {
    ...
    return function (c) {
      ...
      return d && d[a] && d[a].hasOwnProperty(c)
        ? d[a][c]
        : "undefined" != typeof b.user_attrs_[c]
        ? b.user_attrs_[c]
        : ((d = b.attrs_.axes),
          d && d[a] && d[a].hasOwnProperty(c)
            ? d[a][c]
            : "y" == a && b.axes_[0].hasOwnProperty(c)
            ? b.axes_[0][c]
            : "y2" == a && b.axes_[1].hasOwnProperty(c)
            ? b.axes_[1][c]
            : b.attr_(c));
    };
  }),
  ...
  (Dygraph.prototype.yAxisRange = function (a) {
    if (("undefined" == typeof a && (a = 0), 0 > a || a >= this.axes_.length))
      return null;
    var b = this.axes_[a];
    return [b.computedValueRange[0], b.computedValueRange[1]];
  }),
  (Dygraph.prototype.yAxisRanges = function () {
    for (var a = [], b = 0; b < this.axes_.length; b++)
  ...
  (Dygraph.prototype.toDataYCoord = function (a, b) {
    ...
    if (
      ...
      this.attributes_.getForAxis("logscale", b))
    ) {
      var e = (a - c.y) / c.h,
        f = Dygraph.log10(d[1]),
  ...
  (Dygraph.prototype.getValue = function (a, b) {
    return 0 > a || a > this.rawData_.length
      ? null
      : 0 > b || b > this.rawData_[a].length
      ? null
      : this.rawData_[a][b];
  }),
  (Dygraph.prototype.createInterface_ = function () {
    ...
    (this.mouseMoveHandler_ = function (a) {
      ...
      (this.mouseOutHandler_ = function (a) {
        ...
        Dygraph.isNodeContainedBy(c, b.graphDiv) &&
          !Dygraph.isNodeContainedBy(d, b.graphDiv) &&
          b.mouseOut_(a);
      }),
      ...
      this.resizeHandler_ ||
        ((this.resizeHandler_ = function (a) {
          b.resize();
        }),
  ...
  (Dygraph.prototype.createDragInterface_ = function () {
    var a = {
        ...
        initializeMouseDown: function (a, b, c) {
          a.preventDefault
            ...
            (c.px = Dygraph.findPosX(b.canvas_)),
            (c.py = Dygraph.findPosY(b.canvas_)),
            (c.dragStartX = b.dragGetX_(a, c)),
            (c.dragStartY = b.dragGetY_(a, c)),
            (c.cancelNextDblclick = !1),
            c.tarp.cover();
        },
      },
    ...
    for (var e in b)
      b.hasOwnProperty(e) &&
        this.addAndTrackEvent(this.mouseEventElement_, e, d(b[e]));
    var f = function (b) {
      if (
        ((a.isZooming || a.isPanning) &&
          ((a.isZooming = !1), (a.dragStartX = null), (a.dragStartY = null)),
        a.isPanning)
      ) {
        (a.isPanning = !1), (a.draggingDate = null), (a.dateRange = null);
        for (var d = 0; d < c.axes_.length; d++)
          delete c.axes_[d].draggingValue, delete c.axes_[d].dragValueRange;
      }
      a.tarp.uncover();
    };
  ...
  (Dygraph.prototype.drawZoomRect_ = function (a, b, c, d, e, f, g, h) {
    ...
    f == Dygraph.HORIZONTAL
      ...
      a == Dygraph.HORIZONTAL
        ? c &&
          b &&
          ((i.fillStyle = "rgba(128,128,128,0.33)"),
          i.fillRect(
            Math.min(b, c),
            this.layout_.getPlotArea().y,
            Math.abs(c - b),
      ...
      this.isUsingExcanvas_ &&
        (this.currentZoomRectArgs_ = [a, b, c, d, e, 0, 0, 0]);
  }),
  ...
  (Dygraph.prototype.resetZoom = function () {
    ...
    for (var d = 0; d < this.axes_.length; d++)
      "undefined" != typeof this.axes_[d].valueWindow &&
        null !== this.axes_[d].valueWindow &&
        ((a = !0), (c = !0));
    if ((this.clearSelection(), a)) {
      ...
      if (!this.attr_("animatedZooms")) {
        for (this.dateWindow_ = null, d = 0; d < this.axes_.length; d++)
          null !== this.axes_[d].valueWindow &&
            delete this.axes_[d].valueWindow;
        return (
          this.drawGraph_(),
          void (
            this.attr_("zoomCallback") &&
            this.attr_("zoomCallback")(e, f, this.yAxisRanges())
          )
        );
      }
      var g = null,
      ...
      if ((b && ((g = this.xAxisRange()), (h = [e, f])), c)) {
        ...
        var k = this.gatherDatasets_(this.rolledSeries_, null),
          l = k.extremes;
        for (
          this.computeYAxisRanges_(l), j = [], d = 0;
          d < this.axes_.length;
          d++
        ) {
          var m = this.axes_[d];
          j.push(
            null !== m.valueRange && void 0 !== m.valueRange
              ? m.valueRange
              : m.extremeRange
          );
        }
      ...
      this.doAnimatedZoom(g, h, i, j, function () {
        n.dateWindow_ = null;
        for (var a = 0; a < n.axes_.length; a++)
          null !== n.axes_[a].valueWindow && delete n.axes_[a].valueWindow;
        n.attr_("zoomCallback") &&
          n.attr_("zoomCallback")(e, f, n.yAxisRanges());
      });
    }
  }),
  (Dygraph.prototype.doAnimatedZoom = function (a, b, c, d, e) {
    var f,
      g,
      h = this.attr_("animatedZooms") ? Dygraph.ANIMATION_STEPS : 1,
      i = [],
      j = [];
    if (null !== a && null !== b)
      for (f = 1; h >= f; f++)
        (g = Dygraph.zoomAnimationFunction(f, h)),
          (i[f - 1] = [a[0] * (1 - g) + g * b[0], a[1] * (1 - g) + g * b[1]]);
    if (null !== c && null !== d)
      for (f = 1; h >= f; f++) {
        g = Dygraph.zoomAnimationFunction(f, h);
        for (var k = [], l = 0; l < this.axes_.length; l++)
          k.push([
            c[l][0] * (1 - g) + g * d[l][0],
            c[l][1] * (1 - g) + g * d[l][1],
          ]);
  ...
  (Dygraph.prototype.findClosestRow = function (a) {
    for (
      var b = 1 / 0, c = -1, d = this.layout_.points, e = 0;
      e < d.length;
      e++
    )
  ...
  (Dygraph.prototype.findClosestPoint = function (a, b) {
    for (
      var c, d, e, f, g, h, i, j = 1 / 0, k = this.layout_.points.length - 1;
      k >= 0;
      --k
    )
      for (var l = this.layout_.points[k], m = 0; m < l.length; ++m)
        (f = l[m]),
          Dygraph.isValidPoint(f) &&
            ((d = f.canvasx - a),
            (e = f.canvasy - b),
            (c = d * d + e * e),
            j > c && ((j = c), (g = f), (h = k), (i = f.idx)));
    var n = this.layout_.setNames[h];
    return { row: i, seriesName: n, point: g };
  }),
  (Dygraph.prototype.findStackedPoint = function (a, b) {
    for (
      var c, d, e = this.findClosestRow(a), f = 0;
      f < this.layout_.points.length;
      ++f
    ) {
    ...
    return { row: e, seriesName: p, point: c };
  }),
  (Dygraph.prototype.mouseMove_ = function (a) {
    ...
    if (void 0 !== b && null !== b) {
      ...
      if (f && !this.isSeriesLocked()) {
        var h;
        (h = this.attr_("stackedGraph")
          ? this.findStackedPoint(d, e)
          : this.findClosestPoint(d, e)),
      ...
      j &&
        g &&
        j(a, this.lastx_, this.selPoints_, this.lastRow_, this.highlightSet_);
    }
  }),
    ...
    Dygraph.repeatAndCleanup(
      function (c) {
        g.animateId == f &&
          ...
          0 === g.fadeLevel
            ? g.clearSelection()
            : g.updateSelection_(g.fadeLevel / b));
      },
      e,
      c,
      function () {}
  ...
  (Dygraph.prototype.updateSelection_ = function (a) {
    ...
    if (this.attr_("highlightSeriesOpts")) {
      ...
      if (d) {
        ...
        (c.fillStyle = "rgba(255,255,255," + d + ")"),
          c.fillRect(0, 0, this.width_, this.height_);
      }
    ...
    if (
      ...
      for (c.save(), b = 0; b < this.selPoints_.length; b++) {
        ...
        if (Dygraph.isOK(k.canvasy)) {
          ...
          m || (m = Dygraph.Circles.DEFAULT),
            (c.lineWidth = this.attr_("strokeWidth", k.name)),
            (c.strokeStyle = n),
            (c.fillStyle = n),
            m(this.g, k.name, c, j, k.canvasy, n, l, k.idx);
        }
      }
  ...
  (Dygraph.prototype.setSelection = function (a, b, c) {
    ...
    return (
      this.selPoints_.length
        ...
        : (this.lastx_ = -1),
      void 0 !== b &&
        (this.highlightSet_ !== b && (d = !0), (this.highlightSet_ = b)),
      void 0 !== c && (this.lockedSet_ = c),
      d && this.updateSelection_(void 0),
      d
    );
  }),
  (Dygraph.prototype.mouseOut_ = function (a) {
    this.attr_("unhighlightCallback") && this.attr_("unhighlightCallback")(a),
      this.attr_("hideOverlayOnMouseOut") &&
        !this.lockedSet_ &&
        this.clearSelection();
  }),
  ...
  (Dygraph.seriesToPoints_ = function (a, b, c, d) {
    for (var e = [], f = 0; f < a.length; ++f) {
      ...
      b &&
        ((j.y_top = NaN),
        (j.y_bottom = NaN),
        (j.yval_minus = DygraphLayout.parseFloat_(g[1][1])),
        (j.yval_plus = DygraphLayout.parseFloat_(g[1][2]))),
        e.push(j);
    }
    return e;
  }),
    ...
    for (
      ...
      isNaN(m) || null === m
        ? (i(j),
          (m =
            f && g && "none" != d
              ? f.yval + (g.yval - f.yval) * ((l - f.xval) / (g.xval - f.xval))
              : f && "all" == d
              ? f.yval
              : g && "all" == d
              ? g.yval
      ...
      if (this.visibility()[c - 1]) {
        if (b) {
          ...
          for (d = 0; d < e.length; d++)
            e[d][0] >= o && null === q && (q = d), e[d][0] <= p && (r = d);
          null === q && (q = 0);
        ...
        this.attr_("stackedGraph") &&
          Dygraph.stackPoints_(x, h, w, this.attr_("stackedGraphNaNFill")),
          (i[v] = w),
          (g[c] = x);
      }
    return { points: g, extremes: i, boundaryIds: f };
  }),
  (Dygraph.prototype.drawGraph_ = function () {
    ...
    for (var g = 0, h = 1; h < d.length; h++)
      (this.setIndexByName_[f[h]] = h),
        this.visibility()[h - 1] &&
          (this.layout_.addDataset(f[h], d[h]), (this.datasetIndex_[h] = g++));
    ...
    if (
      ...
      this.renderGraph_(b),
      this.attr_("timingName"))
    ) {
      var j = new Date();
      Dygraph.info(
        this.attr_("timingName") + " - drawGraph: " + (j - a) + "ms"
      );
    }
  }),
  ...
  (Dygraph.prototype.computeYAxes_ = function () {
    ...
    if (
      void 0 !== this.axes_ &&
      this.user_attrs_.hasOwnProperty("valueRange") === !1
    )
      for (a = [], c = 0; c < this.axes_.length; c++)
        a.push(this.axes_[c].valueWindow);
    for (this.axes_ = [], b = 0; b < this.attributes_.numAxes(); b++)
      (d = { g: this }),
        Dygraph.update(d, this.attributes_.axisOptions(b)),
        (this.axes_[b] = d);
    if (
      ((e = this.attr_("valueRange")),
      e && (this.axes_[0].valueRange = e),
      void 0 !== a)
    ) {
    ...
    for (b = 0; b < this.axes_.length; b++)
      if (0 === b)
        (d = this.optionsViewForAxis_("y" + (b ? "2" : ""))),
          (e = d("valueRange")),
          e && (this.axes_[b].valueRange = e);
      else {
        var g = this.user_attrs_.axes;
        g &&
          g.y2 &&
          ((e = g.y2.valueRange), e && (this.axes_[b].valueRange = e));
      }
  }),
  ...
  (Dygraph.prototype.computeYAxisRanges_ = function (a) {
    for (
      ...
      if (
        ((d = this.attributes_.seriesForAxis(i)),
        (b = !0),
        (e = 0.1),
        null !== this.attr_("yRangePad") &&
          ((b = !1), (e = this.attr_("yRangePad") / this.plotter_.area.h)),
        0 === d.length)
      )
        j.extremeRange = [0, 1];
      else {
        for (var n, o, p = 1 / 0, q = -(1 / 0), r = 0; r < d.length; r++)
          a.hasOwnProperty(d[r]) &&
            ((n = a[d[r]][0]),
            null !== n && (p = Math.min(n, p)),
            (o = a[d[r]][1]),
            null !== o && (q = Math.max(o, q)));
        l && !k && (p > 0 && (p = 0), 0 > q && (q = 0)),
          p == 1 / 0 && (p = 0),
          q == -(1 / 0) && (q = 1),
          (c = q - p),
          0 === c && (0 !== q ? (c = Math.abs(q)) : ((q = 1), (c = 1)));
        var s, t;
        if (k)
          if (b) (s = q + e * c), (t = p);
          else {
          ...
          (s = q + e * c),
            ...
            b &&
              ...
              (0 > t && p >= 0 && (t = 0), s > 0 && 0 >= q && (s = 0));
        j.extremeRange = [t, s];
      }
      if (j.valueWindow)
        j.computedValueRange = [j.valueWindow[0], j.valueWindow[1]];
      ...
      if (m) {
        ...
        var x = this.optionsViewForAxis_("y" + (i ? "2" : "")),
          y = x("ticker");
        (j.ticks = y(
          j.computedValueRange[0],
          j.computedValueRange[1],
          this.height_,
          x,
          this
        )),
      ...
      if (!j.independentTicks) {
        for (
          var x = this.optionsViewForAxis_("y" + (i ? "2" : "")),
            y = x("ticker"),
            z = f.ticks,
            A = f.computedValueRange[1] - f.computedValueRange[0],
            B = j.computedValueRange[1] - j.computedValueRange[0],
            C = [],
            D = 0;
          D < z.length;
          D++
  ...
  (Dygraph.prototype.extractSeries_ = function (a, b, c) {
    for (
      var d = [],
        e = this.attr_("errorBars"),
        f = this.attr_("customBars"),
        g = 0;
      g < a.length;
      g++
    ) {
      ...
      null !== i
        ? d.push([h, i])
        : d.push([h, e ? [null, null] : f ? [null, null, null] : i]);
    }
    return d;
  }),
    ...
    if (this.fractions_) {
        ...
        if (this.attr_("errorBars"))
          if (this.attr_("wilsonInterval"))
            if (n) {
              ...
              (c = (r + (l * l) / (2 * n) - t) / u),
                (d = (r + (l * l) / (2 * n) + t) / u),
                (k[e] = [p, [r * o, (r - c) * o, (d - r) * o]]);
            } else k[e] = [p, [0, 0, 0]];
          else
            (j = n ? l * Math.sqrt((q * (1 - q)) / n) : 1),
              (k[e] = [p, [o * q, o * j, o * j]]);
        else k[e] = [p, o * q];
      }
      ...
      for (e = 0; e < a.length; e++) {
        ...
        w
          ...
          : (k[e] = [a[e][0], [null, null, null]]);
      }
    } else if (this.attr_("errorBars"))
      for (e = 0; e < a.length; e++) {
        h = 0;
        var z = 0;
        for (i = 0, f = Math.max(0, e - b + 1); e + 1 > f; f++)
          (g = a[f][1][0]),
            null === g ||
              isNaN(g) ||
              (i++, (h += a[f][1][0]), (z += Math.pow(a[f][1][1], 2)));
        if (i)
          (j = Math.sqrt(z) / i), (k[e] = [a[e][0], [h / i, l * j, l * j]]);
        else {
      ...
      if (1 == b) return a;
      for (e = 0; e < a.length; e++) {
        for (h = 0, i = 0, f = Math.max(0, e - b + 1); e + 1 > f; f++)
          (g = a[f][1]), null === g || isNaN(g) || (i++, (h += a[f][1]));
        i ? (k[e] = [a[e][0], h / i]) : (k[e] = [a[e][0], null]);
      }
    }
    return k;
  }),
  (Dygraph.prototype.detectTypeFromString_ = function (a) {
    ...
    isNaN(parseFloat(a))
      ? (b = !0)
      : 8 == a.length && a > "19700101" && "20371231" > a && (b = !0),
  ...
  (Dygraph.prototype.parseCSV_ = function (a) {
    var b,
      ...
      f = a.split(e || "\n"),
      g = this.attr_("delimiter");
    -1 == f[0].indexOf(g) && f[0].indexOf("	") >= 0 && (g = "	");
    var h = 0;
    "labels" in this.user_attrs_ ||
      ((h = 1),
      (this.attrs_.labels = f[0].split(g)),
      this.attributes_.reparseSeries());
    for (
      var i, j = 0, k = !1, l = this.attr_("labels").length, m = !1, n = h;
      n < f.length;
      n++
    ) {
      var o = f[n];
      if (((j = n), 0 !== o.length && "#" != o[0])) {
        ...
        if (!(p.length < 2)) {
          ...
          if (
            (k ||
              (this.detectTypeFromString_(p[0]),
              (i = this.attr_("xValueParser")),
              (k = !0)),
            (q[0] = i(p[0], this)),
            this.fractions_)
          )
              ...
              (b = p[c].split("/")),
                2 != b.length
                  ? (this.error(
                    ...
                    (q[c] = [0, 0]))
                  : (q[c] = [
                      this.parseFloat_(b[0], n, o),
                      this.parseFloat_(b[1], n, o),
                    ]);
          else if (this.attr_("errorBars"))
            for (
              p.length % 2 != 1 &&
              ...
              q[(c + 1) / 2] = [
                this.parseFloat_(p[c], n, o),
                this.parseFloat_(p[c + 1], n, o),
              ];
          else if (this.attr_("customBars"))
            for (c = 1; c < p.length; c++) {
              var r = p[c];
          ...
          if (
            (d.length > 0 && q[0] < d[d.length - 1][0] && (m = !0),
            q.length != l &&
              this.error(
  ...
  (Dygraph.prototype.parseArray_ = function (a) {
    ...
    if (0 === a[0].length)
      return this.error("Data set cannot contain an empty row"), null;
    var b;
    ...
    if (Dygraph.isDateLike(a[0][0])) {
      ...
      for (b = 0; b < a.length; b++) {
        if (0 === d[b].length)
          return this.error("Row " + (1 + b) + " of data is empty"), null;
        if (
          null === d[b][0] ||
          "function" != typeof d[b][0].getTime ||
          isNaN(d[b][0].getTime())
        )
          return (
            this.error("x value in row " + (1 + b) + " is not a Date"), null
          );
        d[b][0] = d[b][0].getTime();
      }
      return d;
    ...
    return (
      ...
      (this.attrs_.axes.x.ticker = Dygraph.numericLinearTicks),
      (this.attrs_.axes.x.axisLabelFormatter =
        Dygraph.numberAxisLabelFormatter),
      a
    );
  }),
  (Dygraph.prototype.parseDataTable_ = function (a) {
    var b = function (a) {
        ...
        for (a = Math.floor(a / 26); a > 0; )
          (b = String.fromCharCode(65 + ((a - 1) % 26)) + b.toLowerCase()),
            (a = Math.floor((a - 1) / 26));
        return b;
      },
    ...
    for (f = 0; f < h.length; f++)
      m.push(a.getColumnLabel(h[f])), this.attr_("errorBars") && (f += 1);
    ...
    for (f = 0; d > f; f++) {
      ...
      if ("undefined" != typeof a.getValue(f, 0) && null !== a.getValue(f, 0)) {
        if (
          ("date" == e || "datetime" == e
            ? q.push(a.getValue(f, 0).getTime())
            : q.push(a.getValue(f, 0)),
          this.attr_("errorBars"))
        )
          for (g = 0; c - 1 > g; g++)
            q.push([a.getValue(f, 1 + 2 * g), a.getValue(f, 2 + 2 * g)]);
        else {
          for (g = 0; g < h.length; g++) {
            var r = h[g];
            if (
              (q.push(a.getValue(f, r)),
              j && i.hasOwnProperty(r) && null !== a.getValue(f, i[r][0]))
            ) {
              var s = {};
              (s.series = a.getColumnLabel(r)),
                (s.xval = q[0]),
                (s.shortText = b(p.length)),
                (s.text = "");
    ...
    o &&
      ...
      (this.rawData_ = n),
      p.length > 0 && this.setAnnotations(p, !0),
      this.attributes_.reparseSeries();
  }),
  (Dygraph.prototype.start_ = function () {
    var a = this.file_;
    if (("function" == typeof a && (a = a()), Dygraph.isArrayLike(a)))
      (this.rawData_ = this.parseArray_(a)), this.predraw_();
    else if ("object" == typeof a && "function" == typeof a.getColumnRange)
      this.parseDataTable_(a), this.predraw_();
  ...
  (Dygraph.prototype.updateOptions = function (a, b) {
    ...
    "rollPeriod" in d && (this.rollPeriod_ = d.rollPeriod),
      "dateWindow" in d &&
        ((this.dateWindow_ = d.dateWindow),
        "isZoomedIgnoreProgrammaticZoom" in d ||
          (this.zoomed_x_ = null !== d.dateWindow)),
      "valueRange" in d &&
        !("isZoomedIgnoreProgrammaticZoom" in d) &&
        (this.zoomed_y_ = null !== d.valueRange);
    var e = Dygraph.isPixelChangingOptionList(this.attr_("labels"), d);
    Dygraph.updateDeep(this.user_attrs_, d),
      this.attributes_.reparseSeries(),
      c
        ? ((this.file_ = c), b || this.start_())
        : b || (e ? this.predraw_() : this.renderGraph_(!1));
  }),
  (Dygraph.mapLegacyOptions_ = function (a) {
    ...
    return (
      e("xValueFormatter", "x", "valueFormatter"),
      e("pixelsPerXLabel", "x", "pixelsPerLabel"),
      e("xAxisLabelFormatter", "x", "axisLabelFormatter"),
      e("xTicker", "x", "ticker"),
      e("yValueFormatter", "y", "valueFormatter"),
      e("pixelsPerYLabel", "y", "pixelsPerLabel"),
      e("yAxisLabelFormatter", "y", "axisLabelFormatter"),
      e("yTicker", "y", "ticker"),
      b
    );
  }),
  (Dygraph.prototype.resize = function (a, b) {
    if (!this.resize_lock) {
      ...
      var c = this.width_,
        d = this.height_;
      a
        ? ((this.maindiv_.style.width = a + "px"),
          (this.maindiv_.style.height = b + "px"),
          (this.width_ = a),
          (this.height_ = b))
        : ((this.width_ = this.maindiv_.clientWidth),
          (this.height_ = this.maindiv_.clientHeight)),
        (c != this.width_ || d != this.height_) &&
  ...
  (Dygraph.prototype.visibility = function () {
    for (
      this.attr_("visibility") || (this.attrs_.visibility = []);
      this.attr_("visibility").length < this.numColumns() - 1;
  ...
  (Dygraph.addAnnotationRule = function () {
    if (!Dygraph.addedAnnotationCSS) {
      var a =
          "border: 1px solid black; background-color: white; text-align: center;",
...
(Dygraph.LOG_SCALE = 10),
  ...
  (Dygraph.log = function (a, b) {
    ...
    if ("undefined" != typeof printStackTrace)
      try {
        for (
          c = printStackTrace({ guess: !1 });
          -1 != c[0].indexOf("stacktrace");
  ...
  (Dygraph.prototype.addAndTrackEvent = function (a, b, c) {
    Dygraph.addEvent(a, b, c),
      this.registeredEvents_.push({ elem: a, type: b, fn: c });
  }),
      ...
      for (var c = a; ; ) {
        ...
        if (
          (window.getComputedStyle &&
            (d = window.getComputedStyle(c, null).borderLeft || "0"),
          (b += parseInt(d, 10)),
          (b += c.offsetLeft),
          !c.offsetParent)
        )
  ...
  (Dygraph.findPosY = function (a) {
    ...
    if (a.offsetParent)
      for (var c = a; ; ) {
        ...
        if (
          (window.getComputedStyle &&
            (d = window.getComputedStyle(c, null).borderTop || "0"),
          (b += parseInt(d, 10)),
          (b += c.offsetTop),
          !c.offsetParent)
        )
  ...
  (Dygraph.binarySearch = function (a, b, c, d, e) {
    if (
      ((null === d || void 0 === d || null === e || void 0 === e) &&
        ((d = 0), (e = b.length - 1)),
      d > e)
    )
      return -1;
    ...
    return i == a
      ...
      ? c > 0 && ((f = h - 1), g(f) && b[f] < a)
        ? h
        : Dygraph.binarySearch(a, b, c, d, h - 1)
      : a > i
      ? 0 > c && ((f = h + 1), g(f) && b[f] > a)
        ? h
        : Dygraph.binarySearch(a, b, c, h + 1, e)
      : -1;
  }),
  (Dygraph.dateParser = function (a) {
    var b, c;
    if (
      (-1 == a.search("-") || -1 != a.search("T") || -1 != a.search("Z")) &&
      ((c = Dygraph.dateStrToMillis(a)), c && !isNaN(c))
    )
      return c;
    if (-1 != a.search("-")) {
      for (b = a.replace("-", "/", "g"); -1 != b.search("-"); )
        b = b.replace("-", "/");
    ...
    return (
      (!c || isNaN(c)) && Dygraph.error("Couldn't parse " + a + " as a date"), c
    );
  }),
    ...
    if ("undefined" != typeof b && null !== b)
      for (var d in b)
        b.hasOwnProperty(d) &&
          (null === b[d]
            ? (a[d] = null)
            : Dygraph.isArrayLike(b[d])
            ? (a[d] = b[d].slice())
            : c(b[d])
            ? (a[d] = b[d])
            : "object" == typeof b[d]
            ? (("object" != typeof a[d] || null === a[d]) && (a[d] = {}),
              Dygraph.updateDeep(a[d], b[d]))
            : (a[d] = b[d]));
    return a;
  }),
  (Dygraph.isArrayLike = function (a) {
    var b = typeof a;
    return ("object" != b &&
      ("function" != b || "function" != typeof a.item)) ||
      null === a ||
  ...
  (Dygraph.clone = function (a) {
    for (var b = [], c = 0; c < a.length; c++)
      Dygraph.isArrayLike(a[c]) ? b.push(Dygraph.clone(a[c])) : b.push(a[c]);
    return b;
  }),
  ...
  (Dygraph.Iterator = function (a, b, c, d) {
    (b = b || 0),
      ...
      (this.array_ = a),
      (this.predicate_ = d),
      (this.end_ = Math.min(a.length, b + c)),
      (this.nextIdx_ = b - 1),
      this.next();
  }),
  (Dygraph.Iterator.prototype.next = function () {
    ...
    return (
      (this.nextIdx_ = b), c || ((this.hasNext = !1), (this.peek = null)), a
    );
  }),
  ...
  (Dygraph.isPixelChangingOptionList = function (a, b) {
    var c = {
      ...
      d = !1,
      e = {};
    if (a) for (var f = 1; f < a.length; f++) e[a[f]] = !0;
    for (var g in b) {
      if (d) break;
  ...
  (Dygraph.shapeFunction_ = function (a, b, c) {
    return function (d, e, f, g, h, i, j) {
      (f.strokeStyle = i),
        (f.fillStyle = "white"),
        Dygraph.regularShape_(f, a, j, g, h, b, c);
    };
  }),
  (Dygraph.Circles = {
  ...
  (Dygraph.IFrameTarp.prototype.cover = function () {
    for (
      var a = document.getElementsByTagName("iframe"), b = 0;
      b < a.length;
      b++
    ) {
      var c = a[b],
  ...
  (Dygraph.detectLineDelimiter = function (a) {
    for (var b = 0; b < a.length; b++) {
      ...
      if ("\r" === c)
        return b + 1 < a.length && "\n" === a.charAt(b + 1) ? "\r\n" : c;
      if ("\n" === c)
        return b + 1 < a.length && "\r" === a.charAt(b + 1) ? "\n\r" : c;
    }
    return null;
  }),
  ...
  (Dygraph.setDateSameTZ = function (a, b) {
    ...
    for (var d in b)
      if (b.hasOwnProperty(d)) {
        ...
        e.call(a, b[d]),
          a.getTimezoneOffset() != c &&
            a.setTime(a.getTime() + 60 * (c - a.getTimezoneOffset()) * 1e3);
      }
  }),
  ...
  (Dygraph.GVizChart.prototype.draw = function (a, b) {
    (this.container.innerHTML = ""),
      "undefined" != typeof this.date_graph && this.date_graph.destroy(),
  ...
  (Dygraph.GVizChart.prototype.getSelection = function () {
    ...
    if (0 > b) return a;
    for (var c = this.date_graph.layout_.points, d = 0; d < c.length; ++d)
      a.push({ row: b, column: d + 1 });
    return a;
  }),
  (Dygraph.Interaction = {}),
  (Dygraph.Interaction.startPan = function (a, b, c) {
    ...
    if (
      ((c.dateRange = f[1] - f[0]),
      (c.initialLeftmostDate = f[0]),
      (c.xUnitsPerPixel = c.dateRange / (b.plotter_.area.w - 1)),
      b.attr_("panEdgeFraction"))
    ) {
    ...
    for (c.is2DPan = !1, c.axes = [], d = 0; d < b.axes_.length; d++) {
      ...
      v
        ? ((t.initialTopValue = Dygraph.log10(u[1])),
          (t.dragValueRange = Dygraph.log10(u[1]) - Dygraph.log10(u[0])))
        : ((t.initialTopValue = u[1]), (t.dragValueRange = u[1] - u[0])),
        (t.unitsPerPixel = t.dragValueRange / (b.plotter_.area.h - 1)),
        c.axes.push(t),
        (e.valueWindow || e.valueRange) && (c.is2DPan = !0);
    }
  }),
  (Dygraph.Interaction.movePan = function (a, b, c) {
    (c.dragEndX = b.dragGetX_(a, c)), (c.dragEndY = b.dragGetY_(a, c));
    var d =
      c.initialLeftmostDate - (c.dragEndX - c.dragStartX) * c.xUnitsPerPixel;
    c.boundedDates && (d = Math.max(d, c.boundedDates[0]));
    var e = d + c.dateRange;
    if (
      (c.boundedDates &&
        e > c.boundedDates[1] &&
        ((d -= e - c.boundedDates[1]), (e = d + c.dateRange)),
      (b.dateWindow_ = [d, e]),
      c.is2DPan)
    )
  ...
  (Dygraph.Interaction.endPan = function (a, b, c) {
    ...
    2 > d &&
      ...
      void 0 !== b.lastx_ &&
      -1 != b.lastx_ &&
      Dygraph.Interaction.treatMouseOpAsClick(b, a, c),
      (c.isPanning = !1),
      (c.is2DPan = !1),
      (c.initialLeftmostDate = null),
      (c.dateRange = null),
      (c.valueRange = null),
      (c.boundedDates = null),
      (c.boundedValues = null),
      (c.axes = null);
  }),
  ...
  (Dygraph.Interaction.moveZoom = function (a, b, c) {
    (c.zoomMoved = !0),
      (c.dragEndX = b.dragGetX_(a, c)),
      (c.dragEndY = b.dragGetY_(a, c));
    var d = Math.abs(c.dragStartX - c.dragEndX),
      e = Math.abs(c.dragStartY - c.dragEndY);
    (c.dragDirection = e / 2 > d ? Dygraph.VERTICAL : Dygraph.HORIZONTAL),
      b.drawZoomRect_(
        c.dragDirection,
        c.dragStartX,
        c.dragEndX,
      ...
      (c.prevEndX = c.dragEndX),
      (c.prevEndY = c.dragEndY),
      (c.prevDragDirection = c.dragDirection);
  }),
  (Dygraph.Interaction.treatMouseOpAsClick = function (a, b, c) {
    ...
    if (e) {
      for (
        var g = -1, h = Number.MAX_VALUE, i = 0;
        i < a.selPoints_.length;
        i++
      ) {
        var j = a.selPoints_[i],
          k =
            Math.pow(j.canvasx - c.dragEndX, 2) +
            Math.pow(j.canvasy - c.dragEndY, 2);
  ...
  (Dygraph.Interaction.startTouch = function (a, b, c) {
    a.preventDefault(),
      a.touches.length > 1 && (c.startTimeForDoubleTapMs = null);
    ...
    if (((c.initialTouches = d), 1 == d.length))
      (c.initialPinchCenter = d[0]), (c.touchDirections = { x: !0, y: !0 });
    else if (d.length >= 2) {
      c.initialPinchCenter = {
        pageX: 0.5 * (d[0].pageX + d[1].pageX),
        pageY: 0.5 * (d[0].pageY + d[1].pageY),
        dataX: 0.5 * (d[0].dataX + d[1].dataX),
        dataY: 0.5 * (d[0].dataY + d[1].dataY),
      };
      var g =
        (180 / Math.PI) *
        Math.atan2(
          c.initialPinchCenter.pageY - d[0].pageY,
          d[0].pageX - c.initialPinchCenter.pageX
        );
      (g = Math.abs(g)),
        g > 90 && (g = 90 - g),
        (c.touchDirections = { x: 67.5 > g, y: g > 22.5 });
    }
    c.initialRange = { x: b.xAxisRange(), y: b.yAxisRange() };
  }),
  (Dygraph.Interaction.moveTouch = function (a, b, c) {
    ...
    for (d = 0; d < a.touches.length; d++) {
      var f = a.touches[d];
      e.push({ pageX: f.pageX, pageY: f.pageY });
    }
    var g,
      h = c.initialTouches,
    ...
    g =
      1 == e.length
        ? e[0]
        : {
            pageX: 0.5 * (e[0].pageX + e[1].pageX),
            pageY: 0.5 * (e[0].pageY + e[1].pageY),
          };
    var j = { pageX: g.pageX - i.pageX, pageY: g.pageY - i.pageY },
      k = c.initialRange.x[1] - c.initialRange.x[0],
      l = c.initialRange.y[0] - c.initialRange.y[1];
    (j.dataX = (j.pageX / b.plotter_.area.w) * k),
      (j.dataY = (j.pageY / b.plotter_.area.h) * l);
    var m, n;
    ...
    (m = Math.min(8, Math.max(0.125, m))),
      (n = Math.min(8, Math.max(0.125, n)));
    var q = !1;
    if (
      (c.touchDirections.x &&
        ((b.dateWindow_ = [
          i.dataX - j.dataX + (c.initialRange.x[0] - i.dataX) / m,
          i.dataX - j.dataX + (c.initialRange.x[1] - i.dataX) / m,
        ]),
        (q = !0)),
      c.touchDirections.y)
    )
      for (d = 0; 1 > d; d++) {
        ...
        s ||
          ((r.valueWindow = [
            i.dataY - j.dataY + (c.initialRange.y[0] - i.dataY) / n,
            i.dataY - j.dataY + (c.initialRange.y[1] - i.dataY) / n,
          ]),
          (q = !0));
      }
  ...
  (Dygraph.Interaction.endTouch = function (a, b, c) {
    if (0 !== a.touches.length) Dygraph.Interaction.startTouch(a, b, c);
      ...
      c.startTimeForDoubleTapMs &&
      d - c.startTimeForDoubleTapMs < 500 &&
      c.doubleTapX &&
      Math.abs(c.doubleTapX - e.screenX) < 50 &&
      c.doubleTapY &&
      Math.abs(c.doubleTapY - e.screenY) < 50
        ? b.resetZoom()
        : ((c.startTimeForDoubleTapMs = d),
          (c.doubleTapX = e.screenX),
          (c.doubleTapY = e.screenY));
    }
  }),
  (Dygraph.Interaction.defaultModel = {
    ...
    mouseout: function (a, b, c) {
      c.isZooming &&
        ((c.dragEndX = null), (c.dragEndY = null), b.clearZoomRect_());
    },
    dblclick: function (a, b, c) {
      return c.cancelNextDblclick
        ? void (c.cancelNextDblclick = !1)
        : void (a.altKey || a.shiftKey || b.resetZoom());
    },
  }),
  ...
  (Dygraph.TickList = void 0),
  (Dygraph.Ticker = void 0),
  (Dygraph.numericLinearTicks = function (a, b, c, d, e, f) {
    var g = function (a) {
  ...
  (Dygraph.numericTicks = function (a, b, c, d, e, f) {
    var g,
      ...
      k = d("pixelsPerLabel"),
      l = [];
    if (f) for (g = 0; g < f.length; g++) l.push({ v: f[g] });
    else {
      if (d("logscale")) {
        j = Math.floor(c / k);
        var m = Dygraph.binarySearch(a, Dygraph.PREFERRED_LOG_TICK_VALUES, 1),
          n = Dygraph.binarySearch(b, Dygraph.PREFERRED_LOG_TICK_VALUES, -1);
        -1 == m && (m = 0),
          -1 == n && (n = Dygraph.PREFERRED_LOG_TICK_VALUES.length - 1);
        var o = null;
        if (n - m >= j / 4) {
          for (var p = n; p >= m; p--) {
            var q = Dygraph.PREFERRED_LOG_TICK_VALUES[p],
              ...
              s = { v: q };
            null === o
              ? (o = { tickValue: q, pixel_coord: r })
              : Math.abs(r - o.pixel_coord) >= k
              ? (o = { tickValue: q, pixel_coord: r })
              : (s.label = ""),
              l.push(s);
          }
      ...
      if (0 === l.length) {
        var t,
          ...
          v = d("labelsKMG2");
        v
          ? ((t = [1, 2, 4, 8, 16, 32, 64, 128, 256]), (u = 16))
          : ((t = [1, 2, 5, 10, 20, 50, 100]), (u = 10));
        var w,
          x,
          y,
          z,
        ...
        for (x > y && (w *= -1), g = 0; j > g; g++)
          (i = x + g * w), l.push({ v: i });
      }
    }
    var E = d("axisLabelFormatter");
    for (g = 0; g < l.length; g++)
      void 0 === l[g].label && (l[g].label = E(l[g].v, 0, d, e));
    return l;
  }),
  ...
  (Dygraph.SHORT_SPACINGS[Dygraph.SECONDLY] = 1e3),
  (Dygraph.SHORT_SPACINGS[Dygraph.TWO_SECONDLY] = 2e3),
  (Dygraph.SHORT_SPACINGS[Dygraph.FIVE_SECONDLY] = 5e3),
  (Dygraph.SHORT_SPACINGS[Dygraph.TEN_SECONDLY] = 1e4),
  (Dygraph.SHORT_SPACINGS[Dygraph.THIRTY_SECONDLY] = 3e4),
  (Dygraph.SHORT_SPACINGS[Dygraph.MINUTELY] = 6e4),
  (Dygraph.SHORT_SPACINGS[Dygraph.TWO_MINUTELY] = 12e4),
  (Dygraph.SHORT_SPACINGS[Dygraph.FIVE_MINUTELY] = 3e5),
  (Dygraph.SHORT_SPACINGS[Dygraph.TEN_MINUTELY] = 6e5),
  (Dygraph.SHORT_SPACINGS[Dygraph.THIRTY_MINUTELY] = 18e5),
  (Dygraph.SHORT_SPACINGS[Dygraph.HOURLY] = 36e5),
  (Dygraph.SHORT_SPACINGS[Dygraph.TWO_HOURLY] = 72e5),
  (Dygraph.SHORT_SPACINGS[Dygraph.SIX_HOURLY] = 216e5),
  (Dygraph.SHORT_SPACINGS[Dygraph.DAILY] = 864e5),
  (Dygraph.SHORT_SPACINGS[Dygraph.WEEKLY] = 6048e5),
  ...
  (Dygraph.pickDateTickGranularity = function (a, b, c, d) {
    for (
      var e = d("pixelsPerLabel"), f = 0;
      f < Dygraph.NUM_GRANULARITIES;
      f++
    ) {
  ...
  (Dygraph.numDateTicks = function (a, b, c) {
    if (c < Dygraph.MONTHLY) {
      ...
      return Math.floor(0.5 + (1 * (b - a)) / d);
    }
    var e = Dygraph.LONG_TICK_PLACEMENTS[c],
      f = 31557807360,
      g = (1 * (b - a)) / f;
    return Math.floor(0.5 + (1 * g * e.months.length) / e.year_mod);
  }),
  (Dygraph.getDateAxis = function (a, b, c, d, e) {
    var f,
      g = d("axisLabelFormatter"),
      h = [];
    if (c < Dygraph.MONTHLY) {
      var i = Dygraph.SHORT_SPACINGS[c],
        j = i / 1e3,
        k = new Date(a);
      Dygraph.setDateSameTZ(k, { ms: 0 });
      var l;
      60 >= j
        ? ((l = k.getSeconds()), Dygraph.setDateSameTZ(k, { s: l - (l % j) }))
        : (Dygraph.setDateSameTZ(k, { s: 0 }),
          (j /= 60),
          60 >= j
            ? ((l = k.getMinutes()),
              Dygraph.setDateSameTZ(k, { m: l - (l % j) }))
            : (Dygraph.setDateSameTZ(k, { m: 0 }),
              (j /= 60),
              24 >= j
                ? ((l = k.getHours()), k.setHours(l - (l % j)))
                : (k.setHours(0),
                  (j /= 24),
                  7 == j && k.setDate(k.getDate() - k.getDay())))),
        (a = k.getTime());
      ...
      for (f = a; b >= f; f += i) {
        if (((k = new Date(f)), n && k.getTimezoneOffset() != m)) {
          ...
          (f += 60 * o * 1e3),
            ...
            new Date(f + i).getTimezoneOffset() != m &&
              ((f += i), (k = new Date(f)), (m = k.getTimezoneOffset()));
        }
        h.push({ v: f, label: g(k, c, d, e) });
      }
    } else {
      var p,
        q = 1;
      c < Dygraph.NUM_GRANULARITIES
        ? ((p = Dygraph.LONG_TICK_PLACEMENTS[c].months),
          (q = Dygraph.LONG_TICK_PLACEMENTS[c].year_mod))
        : Dygraph.warn("Span of dates is too long");
      for (
        var r = new Date(a).getFullYear(),
          s = new Date(b).getFullYear(),
          t = Dygraph.zeropad,
          u = r;
        s >= u;
        u++
        ...
        if (u % q === 0)
          for (var v = 0; v < p.length; v++) {
            var w = u + "/" + t(1 + p[v]) + "/01";
            (f = Dygraph.dateStrToMillis(w)),
              a > f ||
                f > b ||
                h.push({ v: f, label: g(new Date(f), c, d, e) });
          }
    }
    return h;
  }),
          ...
          for (
            var d = a.canvas.parentNode,
              ...
              f = function (a, c, d) {
                return function (e) {
                  ...
                  f.hasOwnProperty(a)
                    ? f[a](f, d, b, e)
                    : b.getOption(c) && b.getOption(c)(f, d, b, e);
                };
              },
              g = a.dygraph.plotter_.area,
              h = {},
              i = 0;
            i < c.length;
            i++
            ...
            if (
              ...
              k.hasOwnProperty("icon") ||
                (m.className = "dygraphDefaultAnnotation"),
                k.hasOwnProperty("cssClass") &&
                  (m.className += " " + k.cssClass);
              ...
              if (k.hasOwnProperty("icon")) {
                ...
                j.annotation.hasOwnProperty("shortText") &&
                  m.appendChild(
                    document.createTextNode(j.annotation.shortText)
                  );
              var r = j.canvasx - o / 2;
              m.style.left = r + "px";
              var s = 0;
              ...
              (m.style.top = s + "px"),
                (m.style.width = o + "px"),
                (m.style.height = p + "px"),
                (m.title = j.annotation.text),
                (m.style.color = b.colorsMap_[j.name]),
                (m.style.borderColor = b.colorsMap_[j.name]),
                (k.div = m),
                b.addAndTrackEvent(
                  m,
                  "click",
                  f("clickHandler", "annotationClickHandler", j, this)
                ),
                b.addAndTrackEvent(
                  m,
                  "mouseover",
                  f("mouseOverHandler", "annotationMouseOverHandler", j, this)
                ),
                b.addAndTrackEvent(
                  m,
                  "mouseout",
                  f("mouseOutHandler", "annotationMouseOutHandler", j, this)
                ),
                b.addAndTrackEvent(
                  m,
                  "dblclick",
                  f("dblClickHandler", "annotationDblClickHandler", j, this)
                ),
                d.appendChild(m),
                this.annotations_.push(m);
              var u = a.drawingContext;
              if (
                (u.save(),
                (u.strokeStyle = b.colorsMap_[j.name]),
                u.beginPath(),
                k.attachAtBottom)
              ) {
                var t = s + p;
                ...
                u.moveTo(j.canvasx, j.canvasy),
                  u.lineTo(j.canvasx, j.canvasy - 2 - l);
    ...
    return (
      ...
      (a.prototype.layout = function (a) {
        ...
        if (b.getOption("drawYAxis")) {
          var c =
            b.getOption("yAxisLabelWidth") + 2 * b.getOption("axisTickSize");
          a.reserveSpaceLeft(c);
        }
        if (b.getOption("drawXAxis")) {
          var d;
          (d = b.getOption("xAxisHeight")
            ? b.getOption("xAxisHeight")
            : b.getOptionForAxis("axisLabelFontSize", "x") +
              2 * b.getOption("axisTickSize")),
        ...
        if (d.getOption("drawXAxis") || d.getOption("drawYAxis")) {
          ...
          if (d.getOption("drawYAxis")) {
            if (q.yticks && q.yticks.length > 0) {
              ...
              for (i = 0; i < q.yticks.length; i++) {
                ...
                0 > w && (w = 0),
                  ...
                  0 === h[0]
                    ? ((e.style.left =
                        r.x -
                        d.getOption("yAxisLabelWidth") -
                        d.getOption("axisTickSize") +
                        "px"),
                      (e.style.textAlign = "right"))
                    : 1 == h[0] &&
                      ((e.style.left =
                        r.x + r.w + d.getOption("axisTickSize") + "px"),
                      (e.style.textAlign = "left")),
                  (e.style.width = d.getOption("yAxisLabelWidth") + "px"),
                  k.appendChild(e),
              ...
              y > m - v &&
                (x.style.top = parseInt(x.style.top, 10) - v / 2 + "px");
            }
            var z;
            ...
            (j.strokeStyle = d.getOptionForAxis("axisLineColor", "y")),
              (j.lineWidth = d.getOptionForAxis("axisLineWidth", "y")),
              j.beginPath(),
              j.moveTo(z, c(r.y)),
              j.lineTo(z, c(r.y + r.h)),
              j.closePath(),
              j.stroke(),
              2 == d.numAxes() &&
                ((j.strokeStyle = d.getOptionForAxis("axisLineColor", "y2")),
                (j.lineWidth = d.getOptionForAxis("axisLineWidth", "y2")),
                j.beginPath(),
                j.moveTo(c(r.x + r.w), c(r.y)),
                j.lineTo(c(r.x + r.w), c(r.y + r.h)),
                j.closePath(),
                j.stroke());
          }
            ...
            if (q.xticks)
              for (i = 0; i < q.xticks.length; i++) {
                (h = q.xticks[i]),
                  ...
                  (e.style.top = g + d.getOption("axisTickSize") + "px");
                var B = f - d.getOption("axisLabelWidth") / 2;
                B + d.getOption("axisLabelWidth") > l &&
                  ((B = l - d.getOption("xAxisLabelWidth")),
                  (e.style.textAlign = "right")),
                  0 > B && ((B = 0), (e.style.textAlign = "left")),
                  (e.style.left = B + "px"),
                  (e.style.width = d.getOption("xAxisLabelWidth") + "px"),
                  k.appendChild(e),
                  this.xlabels_.push(e);
              }
            (j.strokeStyle = d.getOptionForAxis("axisLineColor", "x")),
              (j.lineWidth = d.getOptionForAxis("axisLineWidth", "x")),
              j.beginPath();
            var C;
            if (d.getOption("drawAxesAtZero")) {
  ...
  (Dygraph.Plugins.ChartLabels = (function () {
    ...
    var c = function (a, b, c, d, e) {
      ...
      (f.style.position = "absolute"),
        1 == c ? (f.style.left = "0px") : (f.style.left = b.x + "px"),
        (f.style.top = b.y + "px"),
      ...
      (g.style.position = "absolute"),
        (g.style.width = b.h + "px"),
        (g.style.height = b.w + "px"),
        (g.style.top = b.h / 2 - b.w / 2 + "px"),
        (g.style.left = b.w / 2 - b.h / 2 + "px"),
        (g.style.textAlign = "center");
      var h = "rotate(" + (1 == c ? "-" : "") + "90deg)";
      (g.style.transform = h),
        (g.style.WebkitTransform = h),
        (g.style.MozTransform = h),
        (g.style.OTransform = h),
        (g.style.msTransform = h),
    ...
    return (
        ...
        if (d.getOption("title")) {
          ...
          (this.title_div_ = b(f)),
            ...
            (this.title_div_.style.fontSize =
              d.getOption("titleHeight") - 8 + "px"),
            (this.title_div_.style.fontWeight = "bold"),
            (this.title_div_.style.zIndex = 10);
          var g = document.createElement("div");
          (g.className = "dygraph-label dygraph-title"),
            (g.innerHTML = d.getOption("title")),
            this.title_div_.appendChild(g),
            e.appendChild(this.title_div_);
        }
        if (d.getOption("xlabel")) {
          var h = a.reserveSpaceBottom(d.getOption("xLabelHeight"));
          (this.xlabel_div_ = b(h)),
            (this.xlabel_div_.style.textAlign = "center"),
            (this.xlabel_div_.style.fontSize =
              d.getOption("xLabelHeight") - 2 + "px");
          var g = document.createElement("div");
          (g.className = "dygraph-label dygraph-xlabel"),
            (g.innerHTML = d.getOption("xlabel")),
            this.xlabel_div_.appendChild(g),
            e.appendChild(this.xlabel_div_);
        }
      ...
      (a.prototype.didDrawChart = function (a) {
        var b = a.dygraph;
        this.title_div_ &&
          (this.title_div_.children[0].innerHTML = b.getOption("title")),
          this.xlabel_div_ &&
            (this.xlabel_div_.children[0].innerHTML = b.getOption("xlabel")),
          this.ylabel_div_ &&
    ...
    return (
      ...
      (a.prototype.willDrawChart = function (a) {
        ...
        if (h.getOption("drawYGrid")) {
          for (
            var l = ["y", "y2"], m = [], n = [], o = [], p = [], q = [], f = 0;
            f < l.length;
            f++
          )
            (o[f] = h.getOptionForAxis("drawGrid", l[f])),
              o[f] &&
                ((m[f] = h.getOptionForAxis("gridLineColor", l[f])),
                (n[f] = h.getOptionForAxis("gridLineWidth", l[f])),
                (q[f] = h.getOptionForAxis("gridLinePattern", l[f])),
                (p[f] = q[f] && q[f].length >= 2));
          for (g = j.yticks, i.save(), f = 0; f < g.length; f++) {
            var r = g[f][0];
            o[r] &&
              (p[r] && i.installPattern(q[r]),
              (i.strokeStyle = m[r]),
              (i.lineWidth = n[r]),
              (d = b(k.x)),
              (e = c(k.y + g[f][1] * k.h)),
        ...
        if (h.getOption("drawXGrid") && h.getOptionForAxis("drawGrid", "x")) {
          ...
          var q = h.getOptionForAxis("gridLinePattern", "x"),
            p = q && q.length >= 2;
          for (
            p && i.installPattern(q),
              i.strokeStyle = h.getOptionForAxis("gridLineColor", "x"),
              i.lineWidth = h.getOptionForAxis("gridLineWidth", "x"),
              f = 0;
            f < g.length;
            f++
          )
  ...
  (Dygraph.Plugins.Legend = (function () {
    ...
    a.prototype.activate = function (a) {
      ...
      if (d && null !== d)
        ...
        Dygraph.update(e, a.getOption("labelsDivStyles")),
        ...
        for (var f in e)
          if (e.hasOwnProperty(f))
            try {
              ...
              this.warn(
                "You are using unsupported css properties for your browser in labelsDivStyles"
              );
            }
    ...
    var d = function (a) {
      ...
      b.setAttribute("style", "margin: 0; padding: 0 0 0 1em; border: 0;"),
        a.appendChild(b);
      var c = b.offsetWidth;
    ...
    return (
      ...
      (a.prototype.predraw = function (a) {
        if (this.is_generated_div_) {
          ...
          (this.legend_div_.style.left = b.x + b.w - c - 1 + "px"),
            (this.legend_div_.style.top = b.y + "px"),
      ...
      (b = function (a, b, d, e) {
        ...
        if ("undefined" == typeof b) {
          ...
          for (
            g = a.getOption("labelsSeparateLines"), f = "", h = 1;
            h < k.length;
            h++
          ) {
            ...
            l.visible &&
              ("" !== f && (f += g ? "<br/>" : " "),
              (j = a.getOption("strokePattern", k[h])),
              (i = c(j, l.color, e)),
              (f +=
        ...
        var o = [],
          p = a.numAxes();
        for (h = 0; p > h; h++)
          o[h] = a.optionsViewForAxis_("y" + (h ? 1 + h : ""));
      ...
      (c = function (a, b, c) {
        ...
        if (!a || a.length <= 1)
          return (
            '<div style="display: inline-block; position: relative; bottom: .5ex; padding-left: 1em; height: 1px; border-bottom: 2px solid ' +
            b +
            ';"></div>'
          );
        var e,
        ...
        for (f = 0; i > f; f++)
          for (e = 0; k > e; e += 2)
            (g = l[e % l.length]),
              (h = e < a.length ? l[(e + 1) % l.length] : 0),
              (m +=
                '<div style="display: inline-block; position: relative; bottom: .5ex; margin-right: ' +
                h +
                "em; padding-left: " +
                g +
    ...
    return (
      ...
      (a.prototype.createInterface_ = function () {
        this.createCanvases_(),
          this.isUsingExcanvas_ && this.createIEPanOverlay_(),
      ...
      (a.prototype.removeFromGraph_ = function () {
        ...
        a.removeChild(this.bgcanvas_),
          a.removeChild(this.fgcanvas_),
          a.removeChild(this.leftZoomHandle_),
          a.removeChild(this.rightZoomHandle_),
          (this.graphDiv_ = null);
      }),
      (a.prototype.reserveSpace_ = function (a) {
        this.getOption_("showRangeSelector") &&
          a.reserveSpaceBottom(this.getOption_("rangeSelectorHeight") + 4);
      }),
      ...
      (a.prototype.createZoomHandles_ = function () {
        ...
        (a.className = "dygraph-rangesel-zoomhandle"),
          ...
          this.isMobileDevice_ && ((a.width *= 2), (a.height *= 2)),
      ...
      (a.prototype.initInteraction_ = function () {
        ...
        (a = function (a) {
          ...
          (b = function (a) {
            return (
              ...
              ("mousedown" === a.type || "dragstart" === a.type) &&
                (Dygraph.addEvent(p, "mousemove", c),
                Dygraph.addEvent(p, "mouseup", d)),
          ...
          (c = function (a) {
            ...
            q = a.clientX;
            var c,
              d = o.getZoomHandleStatus_();
            r == o.leftZoomHandle_
              ? ((c = d.leftHandlePos + b),
                (c = Math.min(c, d.rightHandlePos - r.width - 3)),
                (c = Math.max(c, o.canvasRect_.x)))
              : ((c = d.rightHandlePos + b),
                (c = Math.min(c, o.canvasRect_.x + o.canvasRect_.w)),
          ...
          (d = function (a) {
            return s
              ? ((s = !1),
                v.uncover(),
                Dygraph.removeEvent(p, "mousemove", c),
                Dygraph.removeEvent(p, "mouseup", d),
          ...
          (g = function (a) {
            return !t && f(a) && o.getZoomHandleStatus_().isZoomed
              ? (Dygraph.cancelEvent(a),
                (t = !0),
                (q = a.clientX),
                "mousedown" === a.type &&
                  (Dygraph.addEvent(p, "mousemove", h),
                  Dygraph.addEvent(p, "mouseup", i)),
                !0)
              : !1;
          }),
          (h = function (a) {
            ...
            var c = o.getZoomHandleStatus_(),
              ...
              f = e - d;
            d + b <= o.canvasRect_.x
              ? ((d = o.canvasRect_.x), (e = d + f))
              : e + b >= o.canvasRect_.x + o.canvasRect_.w
              ? ((e = o.canvasRect_.x + o.canvasRect_.w), (d = e - f))
              : ((d += b), (e += b));
            var g = o.leftZoomHandle_.width / 2;
            return (
              (o.leftZoomHandle_.style.left = d - g + "px"),
              (o.rightZoomHandle_.style.left = e - g + "px"),
              o.drawInteractiveLayer_(),
              u && j(),
              !0
            );
          ...
          (i = function (a) {
            return t
              ? ((t = !1),
                Dygraph.removeEvent(p, "mousemove", h),
                Dygraph.removeEvent(p, "mouseup", i),
                u || j(),
                !0)
              : !1;
          }),
          (j = function () {
            try {
              (o.isChangingRange_ = !0),
                (o.dygraph_.dateWindow_ = a(o.getZoomHandleStatus_())),
                o.dygraph_.drawGraph_(!1);
            } finally {
              o.isChangingRange_ = !1;
            }
          }),
          ...
          (l = function (a) {
            "touchstart" == a.type && 1 == a.targetTouches.length
              ? b(a.targetTouches[0]) && Dygraph.cancelEvent(a)
              : "touchmove" == a.type && 1 == a.targetTouches.length
              ? c(a.targetTouches[0]) && Dygraph.cancelEvent(a)
              : d(a);
          }),
          (m = function (a) {
            "touchstart" == a.type && 1 == a.targetTouches.length
              ? g(a.targetTouches[0]) && Dygraph.cancelEvent(a)
              : "touchmove" == a.type && 1 == a.targetTouches.length
              ? h(a.targetTouches[0]) && Dygraph.cancelEvent(a)
              : i(a);
          }),
          (n = function (a, b) {
            for (
              var c = ["touchstart", "touchend", "touchmove", "touchcancel"],
                d = 0;
              d < c.length;
              d++
            )
              o.dygraph_.addAndTrackEvent(a, c[d], b);
          }),
        ...
        this.dygraph_.addAndTrackEvent(this.leftZoomHandle_, w, b),
          this.dygraph_.addAndTrackEvent(this.rightZoomHandle_, w, b),
          this.isUsingExcanvas_
            ? this.dygraph_.addAndTrackEvent(this.iePanOverlay_, "mousedown", g)
            : (this.dygraph_.addAndTrackEvent(this.fgcanvas_, "mousedown", g),
              this.dygraph_.addAndTrackEvent(this.fgcanvas_, "mousemove", k)),
          this.hasTouchInterface_ &&
            (n(this.leftZoomHandle_, l),
            n(this.rightZoomHandle_, l),
            n(this.fgcanvas_, m));
      }),
      ...
      (a.prototype.drawMiniPlot_ = function () {
        ...
        if (a || b) {
          ...
          for (var p = 0; p < d.data.length; p++) {
            var q = d.data[p],
              r = null !== q[0] ? (q[0] - h[0]) * j : NaN,
              s = null !== q[1] ? m - (q[1] - d.yMin) * k : NaN;
            isFinite(r) && isFinite(s)
              ? (null === n ? f.lineTo(r, m) : c && f.lineTo(r, o),
                f.lineTo(r, s),
                (n = r),
                (o = s))
              : (null !== n &&
                  (c ? (f.lineTo(r, o), f.lineTo(r, m)) : f.lineTo(n, m)),
                (n = o = null));
          }
          if ((f.lineTo(l, m), f.closePath(), a)) {
            ...
            t.addColorStop(0, "white"),
              t.addColorStop(1, a),
              (this.bgcanvas_ctx_.fillStyle = t),
              f.fill();
          }
          b &&
            ((this.bgcanvas_ctx_.strokeStyle = b),
      ...
      (a.prototype.computeCombinedSeriesAndLimits_ = function () {
        var a,
          ...
          g,
          h,
          i = this.dygraph_.rawData_,
          j = this.getOption_("logscale"),
          k = [];
        for (d = 0; d < i.length; d++)
          if (i[d].length > 1 && null !== i[d][1]) {
            if ((c = "number" != typeof i[d][1]))
              for (a = [], b = [], f = 0; f < i[d][1].length; f++)
                a.push(0), b.push(0);
            break;
          }
        for (d = 0; d < i.length; d++) {
          var l = i[d];
          if (((g = l[0]), c)) for (f = 0; f < a.length; f++) a[f] = b[f] = 0;
          else a = b = 0;
        ...
        if (
          ((k = this.dygraph_.rollingAverage(k, this.dygraph_.rollPeriod_)),
          "number" != typeof k[0][1])
        )
        ...
        for (d = 0; d < k.length; d++)
          (h = k[d][1]),
            null !== h &&
              isFinite(h) &&
              (!j || h > 0) &&
              ((n = Math.min(n, h)), (o = Math.max(o, h)));
        var p = 0.25;
        if (j)
          for (
            o = Dygraph.log10(o), o += o * p, n = Dygraph.log10(n), d = 0;
            d < k.length;
            d++
          )
            k[d][1] = Dygraph.log10(k[d][1]);
        else {
          var q,
            r = o - n;
          (q = r <= Number.MIN_VALUE ? o * p : r * p), (o += q), (n -= q);
        }
        return { data: k, yMin: n, yMax: o };
      }),
      (a.prototype.placeZoomHandles_ = function () {
        ...
        (this.leftZoomHandle_.style.left = f - i + "px"),
          (this.leftZoomHandle_.style.top = h + "px"),
          (this.rightZoomHandle_.style.left = g - i + "px"),
      ...
      (a.prototype.drawInteractiveLayer_ = function () {
        ...
        if (((a.strokeStyle = "black"), e.isZoomed)) {
          ...
          (a.fillStyle = "rgba(240, 240, 240, 0.6)"),
            a.fillRect(0, 0, f, this.canvasRect_.h),
            a.fillRect(g, 0, this.canvasRect_.w - g, this.canvasRect_.h),
            a.beginPath(),
            a.moveTo(b, b),
            a.lineTo(f, b),
            a.lineTo(f, d),
            ...
            a.stroke(),
            this.isUsingExcanvas_ &&
              ((this.iePanOverlay_.style.width = g - f + "px"),
              (this.iePanOverlay_.style.left = f + "px"),
              (this.iePanOverlay_.style.height = d + "px"),
          ...
          a.beginPath(),
            ...
            a.lineTo(c, b),
            a.stroke(),
            this.iePanOverlay_ && (this.iePanOverlay_.style.display = "none");
      }),
      (a.prototype.getZoomHandleStatus_ = function () {
        ...
        return {
          ...
          rightHandlePos: c,
          isZoomed:
            b - 1 > this.canvasRect_.x ||
            c + 1 < this.canvasRect_.x + this.canvasRect_.w,
        };
      }),
      a
    );
