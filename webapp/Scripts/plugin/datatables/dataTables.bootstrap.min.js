$.extend(!0, $.fn.dataTable.defaults, {
  ...
  oLanguage: {
    ...
    sSearch: "",
    sInfo:
      "แสดงข้อมูล <span class='txt-color-darken'>_START_</span> ถึง <span class='txt-color-darken'>_END_</span> ของ <span class='text-primary'>_TOTAL_</span> ทั้งหมด",
    ...
    sInfoEmpty: "<span class='text-danger'>ไม่พบข้อมูล</span>",
  ...
  $.fn.dataTable.Api
    ? (($.fn.dataTable.defaults.renderer = "bootstrap"),
      ($.fn.dataTable.ext.renderer.pageButton.bootstrap = function (
        a,
        b,
        c,
        d,
        ...
        var g,
          ...
          l = function (b, d) {
            var m,
              ...
              q = function (a) {
                a.preventDefault(),
                  "ellipsis" !== a.data.action &&
                    i.page(a.data.action).draw(!1);
              };
      ...
      ($.fn.dataTableExt.oApi.fnPagingInfo = function (a) {
        return {
          ...
          iPage:
            -1 === a._iDisplayLength
              ? 0
              : Math.ceil(a._iDisplayStart / a._iDisplayLength),
          iTotalPages:
            -1 === a._iDisplayLength
              ? 0
              : Math.ceil(a.fnRecordsDisplay() / a._iDisplayLength),
        };
      }),
      $.extend($.fn.dataTableExt.oPagination, {
        bootstrap: {
          fnInit: function (a, b, c) {
            ...
            $(b).append(
              '<ul class="pagination pagination-sm"><li class="prev disabled"><a href="#">&larr; ' +
                d.sPrevious +
                '</a></li><li class="next disabled"><a href="#">' +
                d.sNext +
                " &rarr; </a></li></ul>"
            );
            var f = $("a", b);
            $(f[0]).bind("click.DT", { action: "previous" }, e),
              $(f[1]).bind("click.DT", { action: "next" }, e);
          },
          fnUpdate: function (a, b) {
            ...
            for (
              j.iTotalPages < i
                ...
                : j.iPage <= l
                ? ((g = 1), (h = i))
                : j.iPage >= j.iTotalPages - l
                ? ((g = j.iTotalPages - i + 1), (h = j.iTotalPages))
                : ((g = j.iPage - l + 1), (h = g + i - 1)),
                c = 0,
                d = k.length;
              d > c;
              c++
              ...
              for (
                $("li:gt(0)", k[c]).filter(":not(:last)").remove(), e = g;
                h >= e;
                e++
              )
                (f = e == j.iPage + 1 ? 'class="active"' : ""),
                  $("<li " + f + '><a href="#">' + e + "</a></li>")
                    .insertBefore($("li:last", k[c])[0])
                    .bind("click", function (c) {
                      c.preventDefault(),
                        (a._iDisplayStart =
                          (parseInt($("a", this).text(), 10) - 1) * j.iLength),
                        b(a);
                    });
              0 === j.iPage
                ? $("li:first", k[c]).addClass("disabled")
                : $("li:first", k[c]).removeClass("disabled"),
                j.iPage === j.iTotalPages - 1 || 0 === j.iTotalPages
                  ? $("li:last", k[c]).addClass("disabled")
                  : $("li:last", k[c]).removeClass("disabled");
            }
          },
        },
      })),
