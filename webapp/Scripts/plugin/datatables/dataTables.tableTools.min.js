    ...
    return (
      (f.Client.prototype = {
        ...
        glue: function (a, c) {
          ...
          (g.position = "absolute"),
            ...
            (g.zIndex = d),
            "undefined" != typeof c && "" !== c && (this.div.title = c),
            0 !== e.width && 0 !== e.height && (this.sized = !0),
            this.domElement &&
              (this.domElement.appendChild(this.div),
              (this.div.innerHTML = this.getHTML(e.width, e.height).replace(
                /&/g,
                "&amp;"
              )));
        },
        ...
        reposition: function (a) {
          if (
            (a && ((this.domElement = f.$(a)), this.domElement || this.hide()),
      ...
      (function (a, b, d) {
        (TableTools = function (b, c) {
          ...
          var d = a.fn.dataTable.Api
            ? new a.fn.dataTable.Api(b).settings()[0]
            : b.fnSettings();
          return (
            (this.s = {
              that: this,
            ...
            this.s.dt.bJUI &&
              a.extend(!0, this.classes, TableTools.classes_themeroller),
          ...
          (TableTools.prototype = {
            fnGetSelected: function (a) {
              ...
              if (a)
                for (b = 0, c = f.length; c > b; b++)
                  e[f[b]]._DTTT_selected && d.push(e[f[b]].nTr);
              else
                for (b = 0, c = e.length; c > b; b++)
                  e[b]._DTTT_selected && d.push(e[b].nTr);
              return d;
            },
            fnGetSelectedData: function () {
              ...
              for (a = 0, b = d.length; b > a; a++)
                d[a]._DTTT_selected && c.push(this.s.dt.oInstance.fnGetData(a));
              return c;
            },
            fnGetSelectedIndexes: function (a) {
              ...
              if (a)
                for (b = 0, c = f.length; c > b; b++)
                  e[f[b]]._DTTT_selected && d.push(f[b]);
              else
                for (b = 0, c = e.length; c > b; b++)
                  e[b]._DTTT_selected && d.push(b);
              return d;
            },
            ...
            fnGetTitle: function (a) {
              var b = "";
              if ("undefined" != typeof a.sTitle && "" !== a.sTitle)
                b = a.sTitle;
              else {
            ...
            fnCalcColRatios: function (a) {
              var b,
                ...
                h = 0;
              for (b = 0, c = e.length; c > b; b++)
                e[b] && ((g = d[b].nTh.offsetWidth), (h += g), f.push(g));
            ...
            fnPrint: function (a, b) {
              b === c && (b = {}),
                a === c || a ? this._fnPrintStart(b) : this._fnPrintEnd();
            },
            fnInfo: function (b, c) {
              var d = a("<div/>")
            ...
            _fnConstruct: function (b) {
              ...
              this._fnCustomiseSettings(b),
                (this.dom.container = d.createElement(this.s.tags.container)),
                ...
                this.s.dt.aoDestroyCallback.push({
                  ...
                  fn: function () {
                    a(c.s.dt.nTBody)
                      .off("click.DTTT_Select", c.s.custom.sRowSelector)
                      .off("mousedown.DTTT_Select", "tr")
                      .off("mouseup.DTTT_Select", "tr"),
                      a(c.dom.container).empty();
            ...
            _fnCustomiseSettings: function (b) {
              "undefined" == typeof this.s.dt._TableToolsInit &&
                ...
                "undefined" != typeof f && (f.moviePath = this.s.swfPath),
            ...
            _fnButtonDefinations: function (b, c) {
              for (var d, e = 0, f = b.length; f > e; e++) {
                ...
                var h = this._fnCreateButton(
                  d,
                  a(c).hasClass(this.classes.collection.container)
                );
                h && c.appendChild(h);
              }
            },
            _fnCreateButton: function (b, c) {
              ...
              if (b.sAction.match(/flash/)) {
                ...
                "text" == b.sAction
                  ? this._fnTextConfig(d, b)
                  : "div" == b.sAction
                  ? this._fnTextConfig(d, b)
                  : "collection" == b.sAction &&
                    (this._fnTextConfig(d, b), this._fnCollectionConfig(d, b));
              return (
                -1 !== this.s.dt.iTabIndex &&
                  a(d)
            ...
            _fnButtonBase: function (a, b) {
              ...
              return (
                (g.className = f + " " + a.sButtonClass),
                g.setAttribute(
                  "id",
                  "ToolTables_" + this.s.dt.sInstance + "_" + i.buttonCounter
                ),
                g.appendChild(h),
                (h.innerHTML = a.sButtonText),
                i.buttonCounter++,
                g
              );
            },
            _fnGetMasterSettings: function () {
              ...
              for (
                var a = TableTools._aInstances, b = 0, c = a.length;
                c > b;
                b++
              )
            ...
            _fnCollectionShow: function (c, e) {
              ...
              i + p > n && (h.style.left = n - p + "px"),
                j + q > l && (h.style.top = j - q - a(c).outerHeight() + "px"),
                (this.dom.collection.collection = h),
                (this.dom.collection.background = o),
                setTimeout(function () {
                  a(h).animate({ opacity: 1 }, 500),
                    a(o).animate({ opacity: 0.25 }, 500);
                }, 10),
            ...
            _fnCollectionHide: function (b, c) {
              (null === c || "collection" != c.sExtends) &&
                ...
                (a(this.dom.collection.collection).animate(
                  { opacity: 0 },
                  500,
                  function (a) {
                    this.style.display = "none";
                ...
                a(c.nTable).addClass(this.classes.select.table),
                  ...
                  a(c.nTBody).on(
                    ...
                    function (d) {
                      ...
                      if (
                        e.parentNode == c.nTBody &&
                        null !== c.oInstance.fnGetData(e)
                      ) {
                        if ("os" == f.type)
                          if (d.ctrlKey || d.metaKey)
                            b.fnIsSelected(e)
                              ? b._fnRowDeselect(e, d)
                              : b._fnRowSelect(e, d);
                          else if (d.shiftKey) {
                            var h = b.s.dt.aiDisplay.slice(),
                              i = a.inArray(f.lastRow, h),
                              j = a.inArray(g, h);
                            if (0 === b.fnGetSelected().length || -1 === i)
                              h.splice(a.inArray(g, h) + 1, h.length);
                            else {
                              if (i > j) {
                                var k = j;
                                (j = i), (i = k);
                            ...
                            b.fnIsSelected(e)
                              ? (h.splice(a.inArray(g, h), 1),
                                b._fnRowDeselect(h, d))
                              : b._fnRowSelect(h, d);
                          } else
                            b.fnIsSelected(e) && 1 === b.fnGetSelected().length
                              ? b._fnRowDeselect(e, d)
                              : (b.fnSelectNone(), b._fnRowSelect(e, d));
                        else
                          b.fnIsSelected(e)
                            ? b._fnRowDeselect(e, d)
                            : "single" == f.type
                            ? (b.fnSelectNone(), b._fnRowSelect(e, d))
                            : "multi" == f.type && b._fnRowSelect(e, d);
                        f.lastRow = g;
                      }
                    }
                  ),
                  c.oApi._fnCallbackReg(
                    ...
                    function (d, e, f) {
                      c.aoData[f]._DTTT_selected &&
                        a(d).addClass(b.classes.select.row);
                    },
            ...
            _fnRowSelect: function (b, c) {
              ...
              for (d = 0, e = g.length; e > d; d++)
                g[d].nTr && h.push(g[d].nTr);
              if (
                null === this.s.select.preRowSelect ||
                this.s.select.preRowSelect.call(this, c, h, !0)
              ) {
                for (d = 0, e = g.length; e > d; d++)
                  (g[d]._DTTT_selected = !0),
                    g[d].nTr && a(g[d].nTr).addClass(f.classes.select.row);
                null !== this.s.select.postSelected &&
                  this.s.select.postSelected.call(this, h),
                  TableTools._fnEventDispatch(this, "select", h, !0);
              }
            },
            _fnRowDeselect: function (b, c) {
              ...
              if (
                null === this.s.select.preRowSelect ||
                this.s.select.preRowSelect.call(this, c, h, !1)
              ) {
                for (d = 0, e = g.length; e > d; d++)
                  (g[d]._DTTT_selected = !1),
                    g[d].nTr && a(g[d].nTr).removeClass(f.classes.select.row);
                null !== this.s.select.postDeselected &&
                  this.s.select.postDeselected.call(this, h),
                  TableTools._fnEventDispatch(this, "select", h, !1);
              }
            },
            _fnSelectData: function (a) {
              var b,
                ...
                e = [];
              if (a.nodeName)
                (b = this.s.dt.oInstance.fnGetPosition(a)),
                  e.push(this.s.dt.aoData[b]);
              else {
                if ("undefined" != typeof a.length) {
                  for (c = 0, d = a.length; d > c; c++)
                    a[c].nodeName
                      ? ((b = this.s.dt.oInstance.fnGetPosition(a[c])),
                        e.push(this.s.dt.aoData[b]))
                      : "number" == typeof a[c]
                      ? e.push(this.s.dt.aoData[a[c]])
                      : e.push(a[c]);
                  return e;
                }
            ...
            _fnTextConfig: function (b, c) {
              ...
              null !== c.fnInit && c.fnInit.call(this, b, c),
                ...
                a(b).hover(
                  function () {
                    null !== c.fnMouseover &&
                      c.fnMouseover.call(this, b, c, null);
                  },
                  function () {
                    null !== c.fnMouseout &&
                      c.fnMouseout.call(this, b, c, null);
                  }
                ),
                null !== c.fnSelect &&
                ...
                a(b).click(function (a) {
                  null !== c.fnClick && c.fnClick.call(d, b, c, null, a),
                    null !== c.fnComplete &&
                      c.fnComplete.call(d, b, c, null, null),
                    d._fnCollectionHide(b, c);
                });
            },
            _fnHasFlash: function () {
              try {
                ...
                if (
                  navigator.mimeTypes &&
                  navigator.mimeTypes["application/x-shockwave-flash"] !== c &&
            ...
            _fnFlashConfig: function (a, b) {
              ...
              null !== b.fnInit && b.fnInit.call(this, a, b),
                ...
                d.addEventListener("complete", function (e, f) {
                  null !== b.fnComplete && b.fnComplete.call(c, a, b, d, f),
            ...
            _fnColumnTargets: function (b) {
              ...
              else for (c = 0, d = h; d > c; c++) e.push(!0);
              return e;
            },
            ...
            _fnGetDataTablesData: function (b) {
              var c,
                ...
                p =
                  "undefined" != typeof b.bSelectedOnly ? b.bSelectedOnly : !1;
              if (b.bHeader) {
                for (h = [], c = 0, d = m.aoColumns.length; d > c; c++)
                  o[c] &&
              ...
              for (
                ...
                for (
                  j = m.aoData[q[f]].nTr, h = [], c = 0, d = m.aoColumns.length;
                  d > c;
                  c++
                )
                  if (o[c]) {
              ...
              if (b.bFooter && null !== m.nTFoot) {
                for (h = [], c = 0, d = m.aoColumns.length; d > c; c++)
                  o[c] &&
                    null !== m.aoColumns[c].nTf &&
                    ((l = m.aoColumns[c].nTf.innerHTML
                      .replace(/\n/g, " ")
                      .replace(/<.*?>/g, "")),
                    (l = this._fnHtmlDecode(l)),
                    h.push(this._fnBoundData(l, b.sFieldBoundary, n)));
            ...
            _fnChunkData: function (a, b) {
              for (var c = [], d = a.length, e = 0; d > e; e += b)
                d > e + b
                  ? c.push(a.substring(e, e + b))
                  : c.push(a.substring(e, d));
              return c;
            },
            _fnHtmlDecode: function (a) {
              ...
              return a.replace(/&([^\s]*?);/g, function (a, c) {
                return "#" === a.substr(1, 1)
                  ? String.fromCharCode(Number(c.substr(1)))
                  : ((b.innerHTML = a), b.childNodes[0].nodeValue);
              });
            },
            _fnPrintStart: function (c) {
              ...
              this._fnPrintHideNodes(f.nTable),
                ...
                c.bShowAll &&
                  ((f._iDisplayStart = 0),
                  (f._iDisplayLength = -1),
                  f.oApi._fnCalculateEnd && f.oApi._fnCalculateEnd(f),
                  f.oApi._fnDraw(f)),
              ...
              a(d.body).addClass(this.classes.print.body),
                "" !== c.sInfo && this.fnInfo(c.sInfo, 3e3),
                c.sMessage &&
                  a("<div/>")
                ...
                b.scrollTo(0, 0),
                a(d).bind("keydown.DTTT", function (a) {
                  27 == a.keyCode &&
                    (a.preventDefault(), e._fnPrintEnd.call(e, a));
                });
            },
            ...
            _fnPrintScrollStart: function () {
              ...
              (b = d.nTable.getElementsByTagName("thead")),
                ...
                null !== d.nTFoot &&
                  ((c = d.nTable.getElementsByTagName("tfoot")),
                  c.length > 0 && d.nTable.removeChild(c[0])),
                (b = d.nTHead.cloneNode(!0)),
                d.nTable.insertBefore(b, d.nTable.childNodes[0]),
                null !== d.nTFoot &&
                  ((c = d.nTFoot.cloneNode(!0)),
                  d.nTable.insertBefore(c, d.nTable.childNodes[1])),
                "" !== d.oScroll.sX &&
                  ((d.nTable.style.width = a(d.nTable).outerWidth() + "px"),
                  (f.style.width = a(d.nTable).outerWidth() + "px"),
                  (f.style.overflow = "visible")),
                "" !== d.oScroll.sY &&
                  ((f.style.height = a(d.nTable).outerHeight() + "px"),
                  (f.style.overflow = "visible"));
            },
            ...
            _fnPrintShowNodes: function () {
              for (
                var a = this.dom.print.hidden, b = 0, c = a.length;
                c > b;
                b++
              )
          ...
          (TableTools.fnGetMasters = function () {
            for (
              var a = [], b = 0, c = TableTools._aInstances.length;
              c > b;
              b++
            )
              TableTools._aInstances[b].s.master &&
                a.push(TableTools._aInstances[b]);
            return a;
          }),
          ...
          (TableTools._fnEventDispatch = function (a, b, c, d) {
            for (
              var e = TableTools._aListeners, f = 0, g = e.length;
              g > f;
              f++
            )
              a.dom.table == e[f].that.dom.table &&
                e[f].type == b &&
                e[f].fn(c, d);
          }),
            ...
            select: a.extend({}, TableTools.buttonBase, {
              ...
              fnSelect: function (b, c) {
                0 !== this.fnGetSelected().length
                  ? a(b).removeClass(this.classes.buttons.disabled)
          ...
          "function" == typeof a.fn.dataTable &&
          "function" == typeof a.fn.dataTableExt.fnVersionCheck &&
          a.fn.dataTableExt.fnVersionCheck("1.9.0")
      ...
      d.fn.dataTableExt.fnVersionCheck("1.9.0")
      ...
      (d.fn.dataTable.TableTools = TableTools),
      (d.fn.DataTable.TableTools = TableTools),
      TableTools
    );
  };
