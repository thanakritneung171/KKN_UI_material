  ...
  !(function (a) {
    ...
    function g(a) {
      ...
      !a.sEmptyTable &&
        ...
        La(a, a, "sZeroRecords", "sEmptyTable"),
        !a.sLoadingRecords &&
          c &&
          "Loading..." === b.sLoadingRecords &&
          La(a, a, "sZeroRecords", "sLoadingRecords"),
    ...
    function h(a) {
      sb(a, "ordering", "bSort"),
        sb(a, "orderMulti", "bSortMulti"),
        sb(a, "orderClasses", "bSortClasses"),
        sb(a, "orderCellsTop", "bSortCellsTop"),
        sb(a, "order", "aaSorting"),
        sb(a, "orderFixed", "aaSortingFixed"),
        sb(a, "paging", "bPaginate"),
        sb(a, "pagingType", "sPaginationType"),
        sb(a, "pageLength", "iDisplayLength"),
        sb(a, "searching", "bFilter");
    ...
    function i(a) {
      sb(a, "orderable", "bSortable"),
        sb(a, "orderData", "aDataSort"),
        sb(a, "orderSequence", "asSorting"),
        sb(a, "orderDataType", "sortDataType");
      var b = a.aDataSort;
        ...
        c = d("<div/>")
          ...
          .append(
            d("<div/>")
              ...
              .append(
                d('<div class="test"/>').css({ width: "100%", height: 10 })
              )
          )
          .appendTo("body"),
        e = c.find(".test");
    ...
    function m(a, b, e) {
      ...
      e !== c &&
        ...
        e.iDataSort !== c && (g.aDataSort = [e.iDataSort]),
        La(g, e, "aDataSort"));
      var l = g.mData,
        m = B(l),
      ...
      (g._bAttrSrc =
        d.isPlainObject(l) && (o(l.sort) || o(l.type) || o(l.filter))),
    ...
    function C(a) {
      ...
      var b = function (a, d, e) {
        for (
          ...
          h && ((k[m] = k[m].replace(ub, "")), (a = a[k[m]](d))),
      ...
      if (null === k.nTr) {
        for (
          ...
          (h = a.aoColumns[i]),
            ...
            m.push(g),
            (!d || h.mRender || h.mData !== i) &&
              (g.innerHTML = y(a, c, i, "display")),
            h.sClass && (g.className += " " + h.sClass),
            h.bVisible && !d
              ? f.appendChild(g)
              : !h.bVisible && d && g.parentNode.removeChild(g),
            h.fnCreatedCell &&
              h.fnCreatedCell.call(a.oInstance, g, y(a, c, i), l, c, i);
    ...
    function J(a) {
      ...
      if (b) {
        if ((c.DT_RowId && (b.id = c.DT_RowId), c.DT_RowClass)) {
          ...
          (a.__rowc = a.__rowc ? rb(a.__rowc.concat(e)) : e),
            d(b).removeClass(a.__rowc.join(" ")).addClass(c.DT_RowClass);
        }
        c.DT_RowAttr && d(b).attr(c.DT_RowAttr),
          ...
          for (h = 0, i = o[f].length; i > h; h++)
            if (((m = 1), (n = 1), p[f][h] === c)) {
              for (
                ...
                o[f + m] !== c && o[f][h].cell == o[f + m][h].cell;
    ...
    function M(a) {
      ...
      (a.bDrawing = !0),
        j !== c &&
          -1 !== j &&
          ((a._iDisplayStart = k ? j : j >= a.fnRecordsDisplay() ? 0 : j),
      ...
      if (0 !== l.length)
        for (
          var o = k ? 0 : m, p = k ? a.aoData.length : n, r = o;
          p > r;
          r++
        ) {
          var s = l[r],
          ...
          if (0 !== h) {
            var v = g[f % h];
            t._sRowStripe != v &&
              (d(u).removeClass(t._sRowStripe).addClass(v),
              (t._sRowStripe = v));
          }
        ...
        1 == a.iDraw && "ajax" == Sa(a)
          ? (w = i.sLoadingRecords)
          : i.sEmptyTable && 0 === a.fnRecordsTotal() && (w = i.sEmptyTable),
          (e[0] = d("<tr/>", { class: h ? g[0] : "" }).append(
            d("<td />", {
              valign: "top",
              colSpan: q(a),
      ...
      Pa(a, "aoHeaderCallback", "header", [
        d(a.nTHead).children("tr")[0],
        D(a),
        m,
        n,
        l,
      ]),
        Pa(a, "aoFooterCallback", "footer", [
          d(a.nTFoot).children("tr")[0],
          D(a),
          m,
          n,
          l,
    ...
    function O(a) {
      ...
      for (
        var h, i, j, k, l, m, n = a.sDom.split(""), o = 0;
        o < n.length;
        o++
      ) {
        if (((h = null), (i = n[o]), "<" == i)) {
      ...
      var l = {
        ...
        error: function (b, c, d) {
          ...
          "parsererror" == c
            ...
            : 4 === b.readyState && e(a, 0, "Ajax error", 7),
            oa(a, !1);
        },
      };
      (a.oAjaxData = b),
        ...
        a.fnServerData
          ...
          ? (a.jqXHR = d.ajax(d.extend(l, { url: h || a.sAjaxSource })))
          : d.isFunction(h)
          ? (a.jqXHR = h.call(i, b, j, a))
          : ((a.jqXHR = d.ajax(d.extend(l, h))), (h.data = g));
    }
    function S(a) {
    ...
    function T(a) {
      ...
      for (b = 0; h > b; b++)
        (e = g[b]),
          ...
          p("mDataProp_" + b, c),
          i.bFilter &&
            (p("sSearch_" + b, f.sSearch),
            p("bRegex_" + b, f.bRegex),
            p("bSearchable_" + b, e.bSearchable)),
    ...
    function V(a, b) {
      var e =
        d.isPlainObject(a.ajax) && a.ajax.dataSrc !== c
          ? a.ajax.dataSrc
          : a.sAjaxDataProp;
    ...
    function Y(a) {
      for (
        var b, c, d = Wa.ext.search, e = a.aiDisplay, f = 0, g = d.length;
        g > f;
        f++
      ) {
    ...
    function Z(a, b, c, d, e, f) {
      if ("" !== b)
        for (
          var g, h = a.aiDisplay, i = _(b, d, e, f), j = h.length - 1;
          j >= 0;
          j--
        )
        ...
        if (((i = a.aoData[c]), !i._aFilterData)) {
          for (g = [], d = 0, f = j.length; f > d; d++)
            (b = j[d]),
              ...
              h.indexOf &&
                -1 !== h.indexOf("&") &&
                ((vb.innerHTML = h), (h = wb ? vb.textContent : vb.innerText)),
    ...
    function ea(a) {
      ...
      return (
        c ||
          ...
          d(a.nTable).attr("aria-describedby", b + "_info")),
        e[0]
      );
    }
    function fa(a) {
    ...
    function ka(a) {
      ...
      return (
        ...
        l
          .children()
          .append(a.oLanguage.sLengthMenu.replace("_MENU_", i[0].outerHTML)),
        d("select", l)
    ...
    function ma(a, b, c) {
      ...
      return (
        (a._iDisplayStart = d), g && (Pa(a, null, "page", [a]), c && M(a)), g
      );
    }
    function na(a) {
      return d("<div/>", {
    ...
    function oa(a, b) {
      a.oFeatures.bProcessing &&
        d(a.aanFeatures.r).css("display", b ? "block" : "none"),
    ...
    function qa(a) {
      ...
      if (
        ...
        l.bCollapse &&
          "" !== p &&
          (y.height = x[0].offsetHeight + C[0].offsetHeight + "px"),
        (k = D.outerWidth()),
        "" === m
          ? ((F.width = "100%"),
            I &&
        ...
        D.outerWidth() < k
          ? ((j =
            ...
            I &&
              ...
              (F.width = ya(j - q)),
            ("" === m || "" !== n) &&
              Ka(a, 1, "Possible column misalignment", 6))
          : (j = "100%"),
        (y.width = ya(j)),
        (s.width = ya(j)),
      ...
      (u[R] = P ? q + "px" : "0px"),
        G &&
          ((B[0].style.width = ya(O)),
          (A[0].style.width = ya(O)),
          (A[0].style[R] = P ? q + "px" : "0px")),
        x.scroll(),
    ...
    function sa(b) {
      var c,
        ...
        w = !1,
        x = i.style.width;
      for (x && -1 !== x.indexOf("%") && (u = x), c = 0; c < s.length; c++)
        (e = j[s[c]]),
          null !== e.sWidth && ((e.sWidth = ua(e.sWidthOrig, v)), (w = !0));
      if (w || m || l || p != q(b) || p != t.length) {
        var y = d(i)
          ...
          .removeAttr("id")
          .append(d(b.nTHead).clone(!1))
          .append(d(b.nTFoot).clone(!1))
          .append(d("<tbody><tr/></tbody>"));
        y.find("tfoot th, tfoot td").css("width", "");
        var z = y.find("tbody tr");
        for (t = Q(b, y.find("thead")[0]), c = 0; c < s.length; c++)
          (e = j[s[c]]),
            (t[c].style.width =
        ...
        if (b.aoData.length)
          for (c = 0; c < s.length; c++)
            (f = s[c]),
              (e = j[f]),
              d(wa(b, f)).clone(!1).append(e.sContentPadding).appendTo(z);
        if (
          (y.appendTo(v),
          m && o
            ? y.width(o)
            : m
            ? (y.css("width", "auto"),
              y.width() < v.offsetWidth && y.width(v.offsetWidth))
            : l
            ? y.width(v.offsetWidth)
            : u && y.width(u),
          va(b, y[0]),
          m)
        ) {
          ...
          for (c = 0; c < s.length; c++)
            (e = j[s[c]]),
              ...
              (A +=
                null === e.sWidthOrig
                  ? h
                  : parseInt(e.sWidth, 10) + h - d(t[c]).width());
    ...
    function Ba(a) {
      var b,
        ...
        j = (a.aoColumns, 0),
        k = a.aiDisplayMaster;
      for (s(a), f = Aa(a), b = 0, c = f.length; c > b; b++)
    ...
    function Da(a, b, e, f) {
      var g,
        ...
        k = function (a, b) {
          var e = a._idx;
          return (
            e === c && (e = d.inArray(a[1], j)),
            e + 1 < j.length ? e + 1 : b ? null : 0
          );
        };
      if (
        ("number" == typeof i[0] && (i = a.aaSorting = [i]),
        ...
        -1 !== l
          ...
          : (i.push([b, j[0], 0]), (i[i.length - 1]._idx = 0));
    ...
    function Fa(a) {
      ...
      if (i.bSort && i.bSortClasses) {
        for (b = 0, c = f.length; c > b; b++)
          (e = f[b].src),
            d(mb(a.aoData, "anCells", e)).removeClass(g + (2 > b ? b + 1 : 3));
        for (b = 0, c = h.length; c > b; b++)
          (e = h[b].src),
            d(mb(a.aoData, "anCells", e)).addClass(g + (2 > b ? b + 1 : 3));
      }
      a.aLastSort = h;
    }
    function Ga(a, b) {
      ...
      if (a.oFeatures.bStateSave) {
        ...
        if (h && h.time) {
          ...
          if (-1 === d.inArray(!1, i)) {
            ...
            if (
              !(j > 0 && h.time < +new Date() - 1e3 * j) &&
              g.length === h.columns.length
            ) {
              for (
                a.oLoadedState = d.extend(!0, {}, h),
                  h.start !== c &&
                    ((a._iDisplayStart = h.start),
                    (a.iInitDisplayStart = h.start)),
                  h.length !== c && (a._iDisplayLength = h.length),
                  h.order !== c &&
                    ((a.aaSorting = []),
                    d.each(h.order, function (b, c) {
                      a.aaSorting.push(c[0] >= g.length ? [0, c[1]] : c);
                    })),
                  h.search !== c && d.extend(a.oPreviousSearch, da(h.search)),
                  e = 0,
                  f = h.columns.length;
                f > e;
                e++
                ...
                var k = h.columns[e];
                k.visible !== c && (g[e].bVisible = k.visible),
                  k.search !== c &&
                    d.extend(a.aoPreSearchCols[e], da(k.search));
              }
    ...
    function Ma(a, b, c) {
      ...
      for (var f in b)
        b.hasOwnProperty(f) &&
          ((e = b[f]),
          d.isPlainObject(e)
            ? (d.isPlainObject(a[f]) || (a[f] = {}), d.extend(!0, a[f], e))
            : c && "data" !== f && "aaData" !== f && d.isArray(e)
            ? (a[f] = e.slice())
            : (a[f] = e));
      return a;
    }
    ...
    function Ta(a, b) {
      ...
      return (
        d >= b
          ? (c = ob(0, b))
          : e >= a
          ? ((c = ob(0, d - 2)), c.push("ellipsis"), c.push(b - 1))
          : a >= b - 1 - e
          ? ((c = ob(b - (d - 2), b)),
    ...
    function Va(a) {
      return function () {
        var b = [Ja(this[Wa.ext.iApiIndex])].concat(
    ...
    var Wa,
      ...
      ib = function (a, b) {
        return (
          _a[b] || (_a[b] = new RegExp(aa(b), "g")),
          "string" == typeof a && "." !== b
            ? a.replace(/\./g, "").replace(_a[b], ".")
            : a
        );
      },
      jb = function (a, b, c) {
    ...
    Wa = function (a) {
      (this.$ = function (a, b) {
        ...
        (this.fnAddData = function (a, b) {
          var e = this.api(!0),
            f =
              d.isArray(a) && (d.isArray(a[0]) || d.isPlainObject(a[0]))
                ? e.rows.add(a)
                : e.row.add(a);
        ...
        (this.fnDeleteRow = function (a, b, d) {
          var e = this.api(!0),
            ...
            h = g.aoData[f[0][0]];
          return (
            f.remove(), b && b.call(this, g, h), (d === c || d) && e.draw(), h
          );
        }),
      ...
      return (
        this.each(function () {
          ...
          (C.nTable = this),
            ...
            p.aLengthMenu &&
              !p.iDisplayLength &&
              (p.iDisplayLength = d.isArray(p.aLengthMenu[0])
                ? p.aLengthMenu[0][0]
                : p.aLengthMenu[0]),
            (p = Ma(d.extend(!0, {}, w), p)),
            La(C.oFeatures, p, [
            ...
            (p.bJQueryUI
              ? (d.extend(D, Wa.ext.oJUIClasses, p.oClasses),
                p.sDom === w.sDom &&
                  ...
                  (C.sDom = '<"H"lfr>t<"F"ip>'),
                C.renderer
                  ? d.isPlainObject(C.renderer) &&
                    !C.renderer.header &&
                    (C.renderer.header = "jqueryui")
                  : (C.renderer = "jqueryui"))
              : d.extend(D, Wa.ext.classes, p.oClasses),
            x.addClass(D.sTable),
            ("" !== C.oScroll.sX || "" !== C.oScroll.sY) &&
              (C.oScroll.iBarWidth = za()),
            C.oScroll.sX === !0 && (C.oScroll.sX = "100%"),
            C.iInitDisplayStart === c &&
              ((C.iInitDisplayStart = p.iDisplayStart),
              (C._iDisplayStart = p.iDisplayStart)),
            null !== p.iDeferLoading)
          ) {
            C.bDeferLoading = !0;
            var E = d.isArray(p.iDeferLoading);
            (C._iRecordsDisplay = E ? p.iDeferLoading[0] : p.iDeferLoading),
              (C._iRecordsTotal = E ? p.iDeferLoading[1] : p.iDeferLoading);
          }
          var F = C.oLanguage;
          d.extend(!0, F, p.oLanguage),
            ...
            null === p.asStripeClasses &&
              (C.asStripeClasses = [D.sStripeOdd, D.sStripeEven]);
          ...
          -1 !==
            ...
            (d("tbody tr", this).removeClass(G.join(" ")),
            (C.asDestroyStripes = G.slice()));
          var J,
            K = [],
            L = this.getElementsByTagName("thead");
          if (
            (0 !== L.length && (P(C.aoHeader, L[0]), (K = Q(C))),
            null === p.aoColumns)
          )
          ...
          if (
            (p.bStateSave &&
              ((N.bStateSave = !0),
              Ia(C, p),
              Oa(C, "aoDrawCallback", Ha, "state_save")),
            p.aaSorting === c)
          ) {
            var O = C.aaSorting;
            for (q = 0, n = O.length; n > q; q++)
              O[q][1] = C.aoColumns[q].asSorting[0];
          }
          Fa(C),
            N.bSort &&
          ...
          var R = x.children("caption").each(function () {
            ...
            S = x.children("thead");
          0 === S.length && (S = d("<thead/>").appendTo(this)),
            (C.nTHead = S[0]);
          var T = x.children("tbody");
          0 === T.length && (T = d("<tbody/>").appendTo(this)),
            (C.nTBody = T[0]);
          ...
          if (
            (0 === U.length &&
              R.length > 0 &&
              ("" !== C.oScroll.sX || "" !== C.oScroll.sY) &&
              (U = d("<tfoot/>").appendTo(this)),
            0 === U.length || 0 === U.children().length
              ? x.addClass(D.sNoFooter)
              : U.length > 0 && ((C.nTFoot = U[0]), P(C.aoFooter, C.nTFoot)),
            p.aaData)
          )
            for (q = 0; q < p.aaData.length; q++) u(C, p.aaData[q]);
          else
            (C.bDeferLoading || "dom" == Sa(C)) &&
              v(C, d(C.nTBody).children("tr"));
    ...
    (Ya = function (a, b) {
      ...
      if (d.isArray(a)) for (var f = 0, g = a.length; g > f; f++) e(a[f]);
      else e(a);
      (this.context = rb(c)),
            ...
            if ("table" === b) (f = d.call(q, o[g], g)), f !== c && n.push(f);
              ...
              for (
                ...
                (m = l[i]),
                  (f =
                    "cell" === b
                      ? d.call(q, o[g], m.row, m.column, g, i)
                      : d.call(q, o[g], m, g, i, k)),
                  f !== c && n.push(f);
          }
          if (n.length || e) {
        ...
        function (a, b) {
          if (d.isArray(a))
            ...
            for (f = 0, g = j.length; g > f; f++) {
              ...
              var m = l(k, h);
              m ||
                ((m = { name: h, val: {}, methodExt: [], propExt: [] }),
                k.push(m)),
    ...
    var Db = function (a, b) {
        var e,
          ...
          l = typeof a;
        for (
          (a && "string" !== l && "function" !== l && a.length !== c) ||
            (a = [a]),
            g = 0,
            h = a.length;
          h > g;
          ...
          for (
            f = a[g] && a[g].split ? a[g].split(",") : [a[g]],
              i = 0,
              j = f.length;
            j > i;
            i++
          )
            (e = b("string" == typeof f[i] ? d.trim(f[i]) : f[i])),
      ...
      Hb = function (a, b, c) {
        return Db(b, function (b) {
          ...
          return b.nodeName && -1 !== d.inArray(b, g)
            ? [b._DT_RowIndex]
            : d(g)
                .filter(b)
                .map(function () {
    ...
    var Ib = function (a, b, c, e) {
      ...
      Jb = function (a, b) {
        ...
        if (d.length) {
          ...
          e._details &&
            (e._details.remove(), (e._detailsShow = c), (e._details = c));
        }
      },
      Kb = function (a, b) {
        var c = a.context;
    ...
    Za(Ob, function (a, b) {
      ...
      return a === c
        ...
        : (a === !0
            ...
            : a === !1
            ? Jb(this)
            : d.length && this.length && Ib(d[0], d[0].aoData[this[0]], a, b),
          this);
    }),
      ...
      return Db(b, function (b) {
          ...
          for (g = [], h = 0, i = n.length; i > h; h++)
            for (f = n[h], j = 0; q > j; j++)
              (k = { row: f, column: j }),
                e
                  ? ((l = a.aoData[f]),
                    b(k, y(a, f, j), l.anCells[j]) && g.push(k))
                  : g.push(k);
          return g;
        }
        return d.isPlainObject(b)
          ...
          : p
              ...
              .map(function (a, b) {
                return (
                  (f = b.parentNode._DT_RowIndex),
                  { row: f, column: d.inArray(b, m[f].anCells) }
                );
              })
              .toArray();
      });
    ...
    Za("cells()", function (a, b, e) {
      ...
      Za("cell().data()", function (a) {
        ...
        return a === c
          ? b.length && d.length
            ? y(b[0], d[0].row, d[0].column)
            : c
          : (z(b[0], d[0].row, d[0].column, a),
            G(b[0], d[0].row, "data", d[0].column),
            this);
      }),
      Za("order()", function (a, b) {
        ...
        return a === c
          ...
          : ("number" == typeof a
              ? (a = [[a, b]])
              : d.isArray(a[0]) || (a = Array.prototype.slice.call(arguments)),
            this.iterator("table", function (b) {
              b.aaSorting = a.slice();
            }));
      }),
      ...
      (Wa.versionCheck = Wa.fnVersionCheck =
        function (a) {
          for (
            var b,
              c,
      ...
      (Wa.isDataTable = Wa.fnIsDataTable =
        function (a) {
          var b = d(a).get(0),
            c = !1;
          return (
    ...
    d.extend(Ub, {
      ...
      d.extend(Wa.ext.type.detect, [
        ...
        function (a, b) {
          return gb(a) || ("string" == typeof a && -1 !== a.indexOf("<"))
            ? "html"
            : null;
        },
      ]),
        ...
        header: {
          ...
          jqueryui: function (a, b, c, e) {
            d("<div/>")
              ...
              .append(b.contents())
              .append(
                d("<span/>").addClass(e.sSortIcon + " " + c.sSortingClassJUI)
              )
              .appendTo(b),
              d(a.nTable).on("order.dt.DT", function (d, f, g, h) {
                if (a === f) {
