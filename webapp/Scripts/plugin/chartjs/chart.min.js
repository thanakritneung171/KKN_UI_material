...
(function () {
  ...
  var a = this,
    ...
    c = function (a) {
      ...
      return (
        (this.aspectRatio = this.width / this.height), d.retinaScale(this), this
      );
    };
  (c.defaults = {
    global: {
  ...
  var d = (c.helpers = {}),
    ...
    g = (d.extend = function (a) {
      return (
        e(Array.prototype.slice.call(arguments, 1), function (b) {
          e(b, function (c, d) {
    ...
    u =
      ((d.splineCurve = function (a, b, c, d) {
    ...
    v =
      ((d.calculateScaleRange = function (a, b, c, d, e) {
        var f = 2,
          g = Math.floor(b / (1.5 * c)),
          h = f >= g,
          i = p(a),
          j = q(a);
        i === j && ((i += 0.5), j >= 0.5 && !d ? (j -= 0.5) : (i += 0.5));
        for (
          var k = Math.abs(i - j),
            l = u(k),
            m = Math.ceil(i / (1 * Math.pow(10, l))) * Math.pow(10, l),
            n = d ? 0 : Math.floor(j / (1 * Math.pow(10, l))) * Math.pow(10, l),
            o = m - n,
            r = Math.pow(10, l),
            s = Math.round(o / r);
          (s > g || g > 2 * s) && !h;
        ...
        return (
          h && ((s = f), (r = o / s)),
          { steps: s, stepValue: r, min: n, max: n + s * r }
        );
      }),
    ...
    w =
      ...
      (d.easingEffects = {
        ...
        easeInElastic: function (a) {
          ...
          return 0 === a
            ...
            : (c || (c = 0.3),
              d < Math.abs(1)
                ? ((d = 1), (b = c / 4))
                : (b = (c / (2 * Math.PI)) * Math.asin(1 / d)),
              -(
                d *
                Math.pow(2, 10 * (a -= 1)) *
                Math.sin(((1 * a - b) * (2 * Math.PI)) / c)
              ));
        },
        ...
        easeInOutBounce: function (a) {
          return 0.5 > a
            ? 0.5 * w.easeInBounce(2 * a)
            : 0.5 * w.easeOutBounce(2 * a - 1) + 0.5;
        },
      })),
    ...
    z =
      ...
      (d.getRelativePosition = function (a) {
        ...
        return (
          d.touches
            ? ((b = d.touches[0].clientX - f.left),
              (c = d.touches[0].clientY - f.top))
            : ((b = d.clientX - f.left), (c = d.clientY - f.top)),
          { x: b, y: c }
        );
      }),
  ...
  (c.instances = {}),
    ...
    g(c.Type.prototype, {
      ...
      resize: function (a) {
        ...
        var b = this.chart.canvas,
          ...
          d = this.options.maintainAspectRatio
            ? c / this.chart.aspectRatio
            : D(this.chart.canvas);
        return (
      ...
      showTooltip: function (a, b) {
        ...
        var f = function (a) {
          var b = !1;
          return a.length !== this.activeElements.length
            ? (b = !0)
            : (e(
                a,
                function (a, c) {
        ...
        if (f || b) {
          if (
            ...
            if (this.datasets && this.datasets.length > 1) {
              for (
                var g, h, j = this.datasets.length - 1;
                j >= 0 &&
                ((g =
                  this.datasets[j].points ||
                  this.datasets[j].bars ||
                  this.datasets[j].segments),
                (h = i(g, a[0])),
                -1 === h);
                j--
              );
                ...
                m = function (a) {
                  ...
                  return (
                    d.each(this.datasets, function (a) {
                      (b = a.points || a.bars || a.segments),
                        b[h] && b[h].hasValue() && i.push(b[h]);
                    }),
                    d.each(
                      i,
                      function (a) {
                        j.push(a.x),
                          m.push(a.y),
                          k.push(
                            d.template(this.options.multiTooltipTemplate, a)
                          ),
                          l.push({
                    ...
                    (f = q(j)),
                    (c = p(j)),
                    { x: f > this.chart.width / 2 ? f : c, y: (g + e) / 2 }
                  );
                }.call(this, h);
              new c.MultiTooltip({
                x: m.x,
    ...
    (c.Type.extend = function (a) {
      ...
      if (
        ...
        var e = a.name || b.prototype.name,
          i = c.defaults[b.prototype.name]
            ? f(c.defaults[b.prototype.name])
            : {};
    ...
    (c.Point = c.Element.extend({
      ...
      inRange: function (a, b) {
        ...
        return (
          Math.pow(a - this.x, 2) + Math.pow(b - this.y, 2) < Math.pow(c, 2)
        );
      },
      draw: function () {
        if (this.display) {
    ...
    (c.MultiTooltip = c.Element.extend({
      initialize: function () {
        ...
        this.y - d < 0
          ? (this.y = d)
          : this.y + d > this.chart.height && (this.y = this.chart.height - d),
      ...
      getLineHeight: function (a) {
        ...
        return 0 === a
          ...
          : b +
              (1.5 * this.fontSize * c + this.fontSize / 2) +
              1.5 * this.titleFontSize;
      },
      draw: function () {
              ...
              function (b, c) {
                (a.fillStyle = this.textColor),
                  a.fillText(
                    ...
                    this.getLineHeight(c + 1)
                  ),
                  (a.fillStyle = this.legendColorBackground),
                  a.fillRect(
                    this.x + this.xPadding,
                    this.getLineHeight(c + 1) - this.fontSize / 2,
                    this.fontSize,
                    this.fontSize
                  ),
    ...
    (c.Scale = c.Element.extend({
      ...
      calculateXLabelRotation: function () {
        ...
        if (
          ...
          var e,
            f = H(this.ctx, this.font, this.xLabels);
          this.xLabelWidth = f;
          for (
            var g = Math.floor(this.calculateX(1) - this.calculateX(0)) - 6;
            (this.xLabelWidth > g && 0 === this.xLabelRotation) ||
            (this.xLabelWidth > g &&
            ...
            (e = Math.cos(s(this.xLabelRotation))),
              (a = e * c),
              (b = e * d),
              a + this.fontSize / 2 > this.yLabelWidth + 8 &&
                (this.xScalePaddingLeft = a + this.fontSize / 2),
              (this.xScalePaddingRight = this.fontSize / 2),
              this.xLabelRotation++,
              (this.xLabelWidth = e * f);
          this.xLabelRotation > 0 &&
            (this.endPoint -= Math.sin(s(this.xLabelRotation)) * f + 3);
        } else
          (this.xLabelWidth = 0),
          ...
          e(
            ...
            function (e, f) {
              ...
              (a.textAlign = "right"),
                ...
                i && a.beginPath(),
                f > 0
                  ? ((a.lineWidth = this.gridLineWidth),
          ...
          e(
            ...
            function (b, c) {
              var d = this.calculateX(c) + t(this.lineWidth),
                e =
                  this.calculateX(c - (this.offsetGridLines ? 0.5 : 0)) +
                  t(this.lineWidth),
          ...
          (a = this.getPointPosition(b, m)),
            (c =
              this.ctx.measureText(
                v(this.templateString, { value: this.labels[b] })
              ).width + 5),
            0 === b || b === this.valuesCount / 2
              ? ((d = c / 2),
                a.x + d > n && ((n = a.x + d), (e = b)),
                a.x - d < p && ((p = a.x - d), (g = b)))
              : b < this.valuesCount / 2
              ? a.x + c > n && ((n = a.x + c), (e = b))
              : b > this.valuesCount / 2 &&
                a.x - c < p &&
                ((p = a.x - c), (g = b));
          ...
          if (
            (e(
              ...
              function (b, c) {
                if (c > 0) {
                  var d,
                    e = c * (this.drawingArea / this.steps),
                    f = this.yCenter - e;
                  if (this.lineWidth > 0)
                    if (
                      ((a.strokeStyle = this.lineColor),
                    ...
                    if (
                      ...
                      (a.fillStyle = this.backdropColor),
                        a.fillRect(
                          ...
                          f - this.fontSize / 2 - this.backdropPaddingY,
      ...
      initialize: function (a) {
        ...
        (this.ScaleClass = b.Scale.extend({
          ...
          calculateBaseWidth: function () {
            return (
              this.calculateX(1) - this.calculateX(0) - 2 * d.barValueSpacing
            );
          },
          ...
          this.options.showTooltips &&
            c.bindEvents(this, this.options.tooltipEvents, function (a) {
  ...
  function () {
    ...
    b.Type.extend({
      ...
      initialize: function (a) {
        (this.segments = []),
          (this.outerRadius =
            (c.min([this.chart.width, this.chart.height]) -
        ...
        this.segments.splice(
          ...
          new this.SegmentArc({
            ...
            circumference: this.options.animateRotate
              ? 0
              : this.calculateCircumference(a.value),
            label: a.label,
          })
        ),
            ...
            function (a, c) {
              a.transition(
                ...
                c < this.segments.length - 1 &&
                  (this.segments[c + 1].startAngle = a.endAngle);
            },
            this
          );
      },
      ...
      b.types.Doughnut.extend({
        name: "Pie",
        defaults: c.merge(d, { percentageInnerCutout: 0 }),
      });
  }.call(this),
  function () {
    "use strict";
                  ...
                  function (c, e) {
                    d.points.push(
                      new this.PointClass({
                        ...
                        highlightStroke:
                          b.pointHighlightStroke || b.pointStrokeColor,
                      })
                    );
                  },
                  this
            ...
            function (a) {
              ...
              c.each(
                    ...
                    function (a, b) {
                      var d =
                        b > 0 && b < h.length - 1
                          ...
                          : 0;
                      (a.controlPoints = c.splineCurve(
                        g(a, h, b),
                        a,
                        f(a, h, b),
                        d
                      )),
                        a.controlPoints.outer.y > this.scale.endPoint
                          ? (a.controlPoints.outer.y = this.scale.endPoint)
                          : a.controlPoints.outer.y < this.scale.startPoint &&
                            (a.controlPoints.outer.y = this.scale.startPoint),
                        a.controlPoints.inner.y > this.scale.endPoint
                          ? (a.controlPoints.inner.y = this.scale.endPoint)
                          : a.controlPoints.inner.y < this.scale.startPoint &&
                            (a.controlPoints.inner.y = this.scale.startPoint);
                    },
                    this
                  ),
                ...
                c.each(
                  ...
                  function (a, b) {
                    if (0 === b) d.moveTo(a.x, a.y);
                      ...
                      var c = g(a, h, b);
                      d.bezierCurveTo(
                        c.controlPoints.outer.x,
                        c.controlPoints.outer.y,
                        a.controlPoints.inner.x,
                        a.controlPoints.inner.y,
                        a.x,
                        a.y
                      );
                ...
                this.options.datasetFill &&
                  h.length > 0 &&
                  (d.lineTo(h[h.length - 1].x, this.scale.endPoint),
    ...
    b.Type.extend({
        ...
        this.segments.splice(
          ...
          new this.SegmentArc({
            ...
            outerRadius: this.options.animateScale
              ? 0
              : this.scale.calculateCenterOffset(a.value),
            circumference: this.options.animateRotate
              ? 0
      ...
      updateScaleRange: function (a) {
        ...
        var d = this.options.scaleOverride
          ...
          : c.calculateScaleRange(
              b,
              c.min([this.chart.width, this.chart.height]) / 2,
              this.options.scaleFontSize,
    ...
    b.Type.extend({
                ...
                c.each(
                  ...
                  function (c, e) {
                    ...
                    this.scale.animation ||
                      (f = this.scale.getPointPosition(
                        e,
                        this.scale.calculateCenterOffset(c)
                      )),
                      d.points.push(
                        new this.PointClass({
                          value: c,
      ...
      getPointsAtEvent: function (a) {
        var b = c.getRelativePosition(a),
          ...
          g = [];
        return (
          (f >= this.scale.valuesCount || 0 > f) && (f = 0),
          d.distance <= this.scale.drawingArea &&
      ...
      addData: function (a, b) {
        this.scale.valuesCount++,
          c.each(
            a,
            function (a, c) {
              var d = this.scale.getPointPosition(
                this.scale.valuesCount,
