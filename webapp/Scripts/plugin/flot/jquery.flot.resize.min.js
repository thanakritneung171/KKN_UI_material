  ...
  (g[l] = 200),
    ...
    (a.event.special[j] = {
      ...
      teardown: function () {
        ...
        b.removeData(k),
          f.length ||
            (h ? cancelAnimationFrame(e) : clearTimeout(e), (e = null));
      },
      add: function (b) {
        function d(b, d, f) {
          var g = a(this),
    ...
    b.cancelAnimationFrame ||
      (b.cancelAnimationFrame = (function () {
        return (
          ...
          b.oCancelRequestAnimationFrame ||
          b.msCancelRequestAnimationFrame ||
          clearTimeout
        );
      })());
})(jQuery, this),
