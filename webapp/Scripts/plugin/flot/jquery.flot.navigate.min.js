!(function (a) {
  function b(e) {
    var j,
      ...
      l = e.data || {};
    if (l.elem)
      (k = e.dragTarget = l.elem),
        (e.dragProxy = i.proxy || k),
        (e.cursorOffsetX = l.pageX - l.left),
        (e.cursorOffsetY = l.pageY - l.top),
        (e.offsetX = e.pageX - e.cursorOffsetX),
        (e.offsetY = e.pageY - e.cursorOffsetY);
    else if (
      i.dragging ||
      (l.which > 0 && e.which != l.which) ||
      a(e.target).is(l.not)
    )
      return;
    switch (e.type) {
      case "mousedown":
        return (
          a.extend(l, a(k).offset(), {
            elem: k,
            target: e.target,
            pageX: e.pageX,
            pageY: e.pageY,
          }),
          g.add(document, "mousemove mouseup", b, l),
          f(k, !1),
          (i.dragging = null),
          !1
        );
      case !i.dragging && "mousemove":
        ...
        (e.target = l.target),
          (j = c(e, "dragstart", k)),
          j !== !1 &&
            ((i.dragging = k), (i.proxy = e.dragProxy = a(j || k)[0]));
      case "mousemove":
        if (i.dragging) {
          if (
            ((j = c(e, "drag", k)),
            h.drop && ((h.drop.allowed = j !== !1), h.drop.handler(e)),
            j !== !1)
          )
            break;
          e.type = "mouseup";
      ...
      case "mouseup":
        g.remove(document, "mousemove mouseup", b),
          i.dragging && (h.drop && h.drop.handler(e), c(e, "dragend", k)),
          f(k, !0),
          (i.dragging = i.proxy = l.elem = !1);
    }
    return !0;
  }
  function c(b, c, d) {
  ...
  var g = a.event,
    ...
    i = (h.drag = {
      ...
      setup: function (c) {
        (c = a.extend(
          { distance: i.distance, which: i.which, not: i.not },
          c || {}
        )),
          (c.distance = d(c.distance)),
          g.add(this, "mousedown", b, c),
          this.attachEvent && this.attachEvent("ondragstart", e);
      },
      teardown: function () {
        g.remove(this, "mousedown", b),
          this === i.dragging && (i.dragging = i.proxy = !1),
          f(this, !0),
          this.detachEvent && this.detachEvent("ondragstart", e);
      },
    });
  h.dragstart = h.dragend = { setup: function () {}, teardown: function () {} };
})(jQuery),
  (function (a) {
    function b(b) {
    ...
    function b(b) {
      function c(a, c) {
        ...
        (d.left = a.pageX - d.left),
          (d.top = a.pageY - d.top),
          c ? b.zoomOut({ center: d }) : b.zoom({ center: d });
      }
      function d(a, b) {
      ...
      function g(a) {
        m && (clearTimeout(m), (m = null)),
          b.getPlaceholder().css("cursor", j),
          b.pan({ left: k - a.pageX, top: l - a.pageY });
      }
      function h(a, b) {
        var h = a.getOptions();
        h.zoom.interactive && (b[h.zoom.trigger](c), b.mousewheel(d)),
          h.pan.interactive &&
            (b.bind("dragstart", { distance: 10 }, e),
            b.bind("drag", f),
            b.bind("dragend", g));
      }
      function i(a, b) {
      ...
      (b.zoomOut = function (a) {
        ...
        (b.zoom = function (c) {
          ...
          var d = c.center,
            ...
            f = b.width(),
            g = b.height();
          d || (d = { left: f / 2, top: g / 2 });
          var h = d.left / f,
            i = d.top / g,
            j = {
              x: { min: d.left - (h * f) / e, max: d.left + ((1 - h) * f) / e },
              y: { min: d.top - (i * g) / e, max: d.top + ((1 - i) * g) / e },
            };
        ...
        b.hooks.bindEvents.push(h),
        b.hooks.shutdown.push(i);
    }
    var c = {
