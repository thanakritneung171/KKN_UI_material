  ...
  function b(a, b, c, d) {
    ...
    if (e || f) {
      ...
      if (!g) {
        ...
        if (
          ((g = []),
          g.push({ x: !0, number: !0, required: !0 }),
          g.push({ y: !0, number: !0, required: !0 }),
          h.bars.show || (h.lines.show && h.lines.fill))
        ) {
          var i = !!(
            (h.bars.show && h.bars.zero) ||
            (h.lines.show && h.lines.zero)
          );
          g.push({
            y: !0,
            number: !0,
            ...
            h.bars.horizontal &&
              (delete g[g.length - 1].y, (g[g.length - 1].x = !0));
        }
        d.format = g;
      }
  ...
  function e(b, c, e) {
    if ("categories" == b[c].options.mode) {
      if (!b[c].categories) {
        ...
        if (a.isArray(h)) for (var i = 0; i < h.length; ++i) g[h[i]] = i;
        else for (var j in h) g[j] = h[j];
        b[c].categories = g;
      }
