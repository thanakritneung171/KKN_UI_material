  ...
  function b(b) {
    function c(b, c, d, e, f) {
      var g,
        ...
        l = d.pointsize,
        m = a.extend({}, c);
      (m.datapoints = { points: [], pointsize: l, format: d.format }),
        (m.label = null),
        (m.color = f),
        (m.threshold = null),
        (m.originSeries = c),
      ...
      if (
        ((d.points = r),
        (m.datapoints.points = q),
        m.datapoints.points.length > 0)
      ) {
    ...
    function d(b, d, e) {
      d.threshold &&
        (d.threshold instanceof Array
          ? (d.threshold.sort(function (a, b) {
