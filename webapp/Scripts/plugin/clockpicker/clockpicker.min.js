  ...
  function d(d, h) {
    function j(a, b) {
      var c = m.offset(),
        ...
        e = c.left + s,
        g = c.top + s,
        j = (d ? a.originalEvent.touches[0] : a).pageX - e,
        l = (d ? a.originalEvent.touches[0] : a).pageY - g,
        n = Math.sqrt(j * j + l * l),
        q = !1;
      if (!b || !(t - v > n || n > t + v)) {
        a.preventDefault();
        ...
        k && m.append(D.canvas),
          D.setHand(j, l, !b, !0),
          i.off(o).on(o, function (a) {
            a.preventDefault();
            var b = /^touch/.test(a.type),
              c = (b ? a.originalEvent.touches[0] : a).pageX - e,
              d = (b ? a.originalEvent.touches[0] : a).pageY - g;
          ...
          i.off(p).on(p, function (a) {
            ...
            var c = /^touch/.test(a.type),
              ...
              k = (c ? a.originalEvent.changedTouches[0] : a).pageY - g;
            (b || q) && d === j && k === l && D.setHand(d, k),
              "hours" === D.currentView
                ? D.toggleView("minutes", x / 2)
                : h.autoclose &&
    ...
    var l = g(y),
      m = l.find(".clockpicker-plate"),
      q = l.find(".clockpicker-hours"),
      r = l.find(".clockpicker-minutes"),
      z = l.find(".clockpicker-am-pm-block"),
      A = "INPUT" === d.prop("tagName"),
      B = A ? d : d.find("input"),
      C = d.find(".input-group-addon"),
      D = this;
    if (
      ((this.id = c("cp")),
      (this.element = d),
      ...
      g(
        ...
        g(
          ...
          .on("click", function () {
            (D.amOrPm = "PM"),
              g(".clockpicker-span-am-pm").empty().append("PM");
          })
          .appendTo(this.amPmBlock);
    }
    h.autoclose ||
      g(
        ...
        .click(g.proxy(this.done, this))
        .appendTo(l),
      ("top" !== h.placement && "bottom" !== h.placement) ||
        ("top" !== h.align && "bottom" !== h.align) ||
        (h.align = "left"),
      ("left" !== h.placement && "right" !== h.placement) ||
        ("left" !== h.align && "right" !== h.align) ||
        (h.align = "top"),
      l.addClass(h.placement),
      l.addClass("clockpicker-align-" + h.align),
      this.spanHours.click(g.proxy(this.toggleView, this, "hours")),
      this.spanMinutes.click(g.proxy(this.toggleView, this, "minutes")),
      B.on("focus.clockpicker click.clockpicker", g.proxy(this.show, this)),
      C.on("click.clockpicker", g.proxy(this.toggle, this));
    var F,
      G,
      H,
      I,
      J = g('<div class="clockpicker-tick"></div>');
    if (h.twelvehour)
      for (F = 1; 13 > F; F += 1)
        (G = J.clone()),
          (H = (F / 6) * Math.PI),
    ...
    for (F = 0; 60 > F; F += 5)
      (G = J.clone()),
        (H = (F / 30) * Math.PI),
        G.css({ left: s + Math.sin(H) * t - v, top: s - Math.cos(H) * t - v }),
        G.css("font-size", "120%"),
        G.html(b(F)),
        r.append(G),
        G.on(n, j);
    if (
      ...
      var L = l.find(".clockpicker-canvas"),
        M = a("svg");
      M.setAttribute("class", "clockpicker-svg"),
        M.setAttribute("width", w),
        M.setAttribute("height", w);
      var N = a("g");
      N.setAttribute("transform", "translate(" + s + "," + s + ")");
      var O = a("circle");
      O.setAttribute("class", "clockpicker-canvas-bearing"),
        O.setAttribute("cx", 0),
        O.setAttribute("cy", 0),
        O.setAttribute("r", 2);
      var P = a("line");
      ...
      var R = a("circle");
      R.setAttribute("class", "clockpicker-canvas-fg"),
  ...
  var f,
    ...
    k =
      ...
      (function () {
        ...
        return (
          (b.innerHTML = "<svg/>"),
          (a = (b.firstChild && b.firstChild.namespaceURI) == j),
          (b.innerHTML = ""),
          a
        );
      })(),
    ...
    n = "mousedown" + (m ? " touchstart" : ""),
    o = "mousemove.clockpicker" + (m ? " touchmove.clockpicker" : ""),
    p = "mouseup.clockpicker" + (m ? " touchend.clockpicker" : ""),
    q = navigator.vibrate
      ? "vibrate"
  ...
  (d.DEFAULTS = {
    ...
    (d.prototype.show = function (a) {
      if (!this.isShown) {
        ...
        var c = this;
        this.isAppended ||
          ((f = g(document.body).append(this.popover)),
          h.on("resize.clockpicker" + this.id, function () {
            c.isShown && c.locate();
          }),
          (this.isAppended = !0));
        var d = (
        ...
        (this.hours = +d[0] || 0),
          (this.minutes = +d[1] || 0),
          this.spanHours.html(b(this.hours)),
          this.spanMinutes.html(b(this.minutes)),
          ...
          i.on(
            ...
            function (a) {
              var b = g(a.target);
              0 === b.closest(c.popover).length &&
                0 === b.closest(c.addon).length &&
                0 === b.closest(c.input).length &&
                c.hide();
            }
          ),
    ...
    (d.prototype.toggleView = function (a, b) {
      var c = !1;
      "minutes" === a &&
        "visible" === g(this.hoursView).css("visibility") &&
        (e(this.options.beforeHourSelect), (c = !0));
      var d = "hours" === a,
        f = d ? this.hoursView : this.minutesView,
        h = d ? this.minutesView : this.hoursView;
      (this.currentView = a),
        this.spanHours.toggleClass("text-primary", d),
        this.spanMinutes.toggleClass("text-primary", !d),
        h.addClass("clockpicker-dial-out"),
        f.css("visibility", "visible").removeClass("clockpicker-dial-out"),
        this.resetClock(b),
        clearTimeout(this.toggleViewTimer),
        (this.toggleViewTimer = setTimeout(function () {
          h.css("visibility", "hidden");
        }, x)),
        c && e(this.options.afterHourSelect);
    }),
    (d.prototype.resetClock = function (a) {
      var b = this.currentView,
        ...
        j = this;
      k && a
        ? (j.canvas.addClass("clockpicker-canvas-out"),
          setTimeout(function () {
    ...
    (d.prototype.setHand = function (a, c, d, e) {
      ...
      if (
        ...
        m.twelvehour
          ...
          : i
          ? (12 === f && (f = 0),
            (f = n ? (0 === f ? 12 : f) : 0 === f ? 0 : f + 12))
          : (d && (f *= 5), 60 === f && (f = 0)),
        this[this.currentView] !== f &&
          q &&
        ...
        (this[this.currentView] = f),
        this[i ? "spanHours" : "spanMinutes"].html(b(f)),
        !k)
      )
        return void this[i ? "hoursView" : "minutesView"]
      ...
      var p = Math.sin(h) * o,
        r = -Math.cos(h) * o;
      this.hand.setAttribute("x2", p),
        this.hand.setAttribute("y2", r),
        this.bg.setAttribute("cx", p),
        this.bg.setAttribute("cy", r),
        this.fg.setAttribute("cx", p),
        this.fg.setAttribute("cy", r);
    }),
    (d.prototype.done = function () {
      e(this.options.beforeDone), this.hide();
      var a = this.input.prop("value"),
        c = b(this.hours) + ":" + b(this.minutes);
      this.options.twelvehour && (c += this.amOrPm),
        this.input.prop("value", c),
        c !== a &&
    ...
    (d.prototype.remove = function () {
      this.element.removeData("clockpicker"),
        ...
        this.isAppended &&
          (h.off("resize.clockpicker" + this.id), this.popover.remove());
    }),
