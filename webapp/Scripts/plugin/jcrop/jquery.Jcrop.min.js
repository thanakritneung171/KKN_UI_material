!(function (a) {
  (a.Jcrop = function (b, c) {
    ...
    function j(a, b, c) {
      if (
        ((I = g(R)),
        oa.setCursor("move" === a ? a : a + "-resize"),
        "move" === a)
      )
        return oa.activateHandlers(l(b), q, c);
      var d = la.getFixed(),
        e = m(a),
        f = la.getCorner(m(e));
      la.setPressed(la.getCorner(e)),
        la.setCurrent(f),
        oa.activateHandlers(k(a, d), q, c);
    }
    function k(a, b) {
      return function (c) {
        if (J.aspectRatio)
    ...
    function q(a) {
      var b = la.getFixed();
      b.w > J.minSelect[0] && b.h > J.minSelect[1]
        ? (na.enableHandles(), na.done())
        : na.release(),
        oa.setCursor(J.allowSelect ? "crosshair" : "default");
    }
    function r(a) {
      ...
      return (
        la.setPressed(b),
        na.update(),
        oa.activateHandlers(s, q, "touch" === a.type.substring(0, 5)),
        pa.watchKeys(),
        a.stopPropagation(),
        a.preventDefault(),
        !1
    ...
    function w(a) {
      x([a[0] / ba, a[1] / ca, a[2] / ba, a[3] / ca]),
        J.onSelect.call(qa, p(la.getFixed())),
        na.enableHandles();
    }
    function x(a) {
    ...
    function B() {
      (J.disabled = !0),
        na.disableHandles(),
        na.setCursor("default"),
        oa.setCursor("default");
    }
    function C() {
      (J.disabled = !1), H();
    }
    ...
    function G(a, b, c) {
      var d = b || J.bgColor;
      J.bgFade && f() && J.fadeTime && !c
        ? a.animate({ backgroundColor: d }, { queue: !1, duration: J.fadeTime })
    ...
    function H(a) {
      J.allowResize
        ...
        : na.disableHandles(),
        oa.setCursor(J.allowSelect ? "crosshair" : "default"),
        na.setCursor(J.allowMove ? "move" : "default"),
        J.hasOwnProperty("trueSize") &&
          ((ba = J.trueSize[0] / S), (ca = J.trueSize[1] / T)),
        J.hasOwnProperty("setSelect") &&
          (w(J.setSelect), na.done(), delete J.setSelect),
        ma.refresh(),
        J.bgColor != ia &&
          (G(
            J.shade ? ma.getShades() : U,
            J.shade ? J.shadeColor || J.bgColor : J.bgColor
          ),
          (ia = J.bgColor)),
        ja != J.bgOpacity &&
          ((ja = J.bgOpacity), J.shade ? ma.refresh() : na.setBgOpacity(ja)),
        (Z = J.maxSize[0] || 0),
        ($ = J.maxSize[1] || 0),
        (_ = J.minSize[0] || 0),
        (aa = J.minSize[1] || 0),
        J.hasOwnProperty("outerImage") &&
          (R.attr("src", J.outerImage), delete J.outerImage),
        na.refresh();
    }
    var I,
      J = a.extend({}, a.Jcrop.defaults),
    ...
    var N = {
      ...
      P = !0;
    if ("IMG" == b.tagName) {
      if (0 != O[0].width && 0 != O[0].height)
        O.width(O[0].width), O.height(O[0].height);
      else {
        var Q = new Image();
    ...
    var S = R.width(),
      ...
      U = a("<div />")
        ...
        .height(T)
        .addClass(e("holder"))
        .css({ position: "relative", backgroundColor: J.bgColor })
        .insertAfter(O)
        .append(R);
    ...
    var V = a("<div />"),
      ...
      Y = a("<div />")
        ...
        .append(W, X);
    P &&
      ((V = a("<img />").attr("src", R.attr("src")).css(N).width(S).height(T)),
      W.append(V)),
      M && Y.css({ overflowY: "hidden" });
    var Z,
      $,
      _,
      aa,
      ...
      ha = t()
        .width(S + 2 * ga)
        .height(T + 2 * ga)
        .css({ position: "absolute", top: d(-ga), left: d(-ga), zIndex: 290 })
        .mousedown(r),
      ia = J.bgColor,
      ja = J.bgOpacity;
    I = g(R);
    var ka = (function () {
        function a() {
          ...
          try {
            for (a = 0; a < c.length; a++) {
              ...
              var f = e in d;
              f ||
                (d.setAttribute(e, "return;"), (f = "function" == typeof d[e])),
                (b[c[a]] = f);
            }
        ...
        function b() {
          return J.touchSupport === !0 || J.touchSupport === !1
            ? J.touchSupport
            : a();
        }
        return {
      ...
      la = (function () {
              ...
              : ((a = o),
                ...
                0 > b
                  ...
                  : b > T &&
                    ...
                    (a = 0 > l ? m - c : c + m))),
            a > m
              ? (f > a - m ? (a = m + f) : a - m > g && (a = m + g),
                (b = b > n ? n + (a - m) / e : n - (a - m) / e))
              : m > a &&
                (f > m - a ? (a = m - f) : m - a > g && (a = m - g),
                (b = b > n ? n + (m - a) / e : n - (m - a) / e)),
        ...
        function i() {
          var a,
            ...
            c = p - n;
          return (
            Z && Math.abs(b) > Z && (o = b > 0 ? m + Z : m - Z),
            $ && Math.abs(c) > $ && (p = c > 0 ? n + $ : n - $),
            aa / ca &&
              Math.abs(c) < aa / ca &&
              (p = c > 0 ? n + aa / ca : n - aa / ca),
            _ / ba &&
              Math.abs(b) < _ / ba &&
              (o = b > 0 ? m + _ / ba : m - _ / ba),
            0 > m && ((o -= m), (m -= m)),
      ...
      ma = (function () {
        ...
        function e(a) {
          o.top.css({ left: d(a.x), width: d(a.w), height: d(a.y) }),
            o.bottom.css({
              top: d(a.y2),
              left: d(a.x),
              width: d(a.w),
            ...
            o.right.css({ left: d(a.x2), width: d(S - a.x2) }),
            o.left.css({ width: d(a.x) });
        }
        function f() {
          return a("<div />")
            .css({
        ...
        function g() {
          m ||
            ...
            n.insertBefore(R),
            c(),
            na.setBgOpacity(1, 0, 1),
            V.hide(),
            h(J.shadeColor || J.bgColor, 1),
            na.isAwake() ? j(J.bgOpacity, 1) : j(1, 1));
        }
        function h(a, b) {
          G(l(), a, b);
        }
        function i() {
          m &&
            ...
            (m = !1),
            na.isAwake()
              ? na.setBgOpacity(J.bgOpacity, 1, 1)
              : (na.setBgOpacity(1, 1, 1), na.disableHandles()),
            G(U, 0, 1));
        }
        function j(a, b) {
          m &&
      ...
      na = (function () {
        function b(b) {
          var c = a("<div />")
            .css({ position: "absolute", opacity: J.borderOpacity })
            .addClass(e(b));
          return W.append(c), c;
        }
        function c(b, c) {
          var d = a("<div />")
            ...
            .addClass("ord-" + b);
          return (
            ka.support && d.bind("touchstart.jcrop", ka.createDragger(b)),
            X.append(d),
            d
          );
        }
        ...
        function k(a, b) {
          J.shade || V.css({ top: d(-b), left: d(-a) }),
            Y.css({ top: d(b), left: d(a) });
        }
        function l(a, b) {
        ...
        function q(a) {
          ...
          l(b.w, b.h),
            k(b.x, b.y),
            J.shade && ma.updateRaw(b),
            A || s(),
            a ? J.onSelect.call(qa, p(b)) : J.onChange.call(qa, p(b));
        }
        function r(a, b, c) {
          (A || b) &&
            (J.bgFade && !c
              ? R.animate({ opacity: a }, { queue: !1, duration: J.fadeTime })
              : R.css("opacity", a));
        }
        function s() {
        ...
        return (
          ka.support && G.bind("touchstart.jcrop", ka.createDragger("move")),
          W.append(G),
          x(),
          {
            updateVisible: o,
      ...
      oa = (function () {
        function b(b) {
          ha.css({ zIndex: 450 }),
            b
              ? a(document).bind("touchmove.jcrop", g).bind("touchend.jcrop", i)
              : m &&
                a(document).bind("mousemove.jcrop", d).bind("mouseup.jcrop", e);
        }
        function c() {
        ...
        function e(a) {
          return (
            ...
            da &&
              ((da = !1),
              l(h(a)),
              na.isAwake() && J.onSelect.call(qa, p(la.getFixed())),
              c(),
              (k = function () {}),
              (l = function () {})),
            !1
        ...
        var k = function () {},
          ...
          m = J.trackDocument;
        return (
          m || ha.mousemove(d).mouseup(e).mouseout(e),
          R.before(ha),
          { activateHandlers: f, setCursor: j }
        );
      })(),
      pa = (function () {
        function b() {
        ...
        function d(a, b, c) {
          J.allowMove && (la.moveOffset([b, c]), na.updateVisible(!0)),
            a.preventDefault(),
            a.stopPropagation();
        }
        function e(a) {
        ...
        return (
          J.keySupport &&
            (f.keydown(e).blur(c),
            M || !J.fixedSupport
              ? (f.css({ position: "absolute", left: "-20px" }),
                g.append(f).insertBefore(R))
              : f.insertBefore(R)),
          { watchKeys: b }
        );
      })();
    ...
    (a.Jcrop.Loader = function (b, c, d) {
      function e() {
        g.complete
          ? (f.unbind(".jcloader"), a.isFunction(c) && c.call(g))
