  ...
  a.fn.extend({
    maxlength: function (b, c) {
      function d(a) {
        ...
        return (
          b.utf8
            ? ((e = d ? getUTF8Length(d) : 0), (f = getUTF8Length(a.val()) + e))
            : ((e = d ? d.length : 0), (f = a.val().length + e)),
          f
        );
      }
      function e(a, c, e) {
      ...
      function i(a, c) {
        ...
        return (
          b.message
            ? (d = b.message
                .replace("%charsTyped%", c)
                .replace("%charsRemaining%", a - c)
                .replace("%charsTotal%", a))
            : (b.preText && (d += b.preText),
              (d += b.showCharsTyped ? c : a - c),
              b.showMaxLength && (d += b.separator + a),
              b.postText && (d += b.postText)),
          d
        );
      }
      function j(a, c, d, f) {
        f.html(i(d, d - a)),
          a > 0
            ? e(c, b.threshold, d)
              ? g(f.removeClass(b.limitReachedClass).addClass(b.warningClass))
              : h(f)
            : g(f.removeClass(b.warningClass).addClass(b.limitReachedClass));
      }
      function k(b) {
        var c = b[0];
        return a.extend(
      ...
      return (
        ...
        this.each(function () {
          ...
          c.is("textarea") &&
            ...
            c.mouseup(function () {
              (c.outerWidth() !== c.data("maxlenghtsizex") ||
                c.outerHeight() !== c.data("maxlenghtsizey")) &&
                l(c, e),
                c.data("maxlenghtsizex", c.outerWidth()),
                c.data("maxlenghtsizey", c.outerHeight());
            })),
            ...
            c.keyup(function (a) {
              ...
              return (
                0 !== g ||
                  ...
                  a.shiftKey ||
                  c
                    .attr("maxlength", m(c) + 1)
                    .trigger({ type: "keypress", which: 9 })
                    .attr("maxlength", m(c) - 1),
