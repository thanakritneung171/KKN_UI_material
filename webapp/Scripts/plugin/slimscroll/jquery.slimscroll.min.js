        ...
        this.each(function () {
          ...
          function e(a, b, c) {
            ...
            if (
              (b &&
                ((e =
                  parseInt(A.css("top")) +
                  ((a * parseInt(d.wheelStep)) / 100) * A.outerHeight()),
                (e = Math.min(Math.max(e, 0), f)),
                (e = a > 0 ? Math.ceil(e) : Math.floor(e)),
                A.css({ top: e + "px" })),
              (p =
                parseInt(A.css("top")) / (v.outerHeight() - A.outerHeight())),
              (e = p * (v[0].scrollHeight - v.outerHeight())),
              c)
            ) {
              e = a;
          ...
          function f() {
            window.addEventListener
              ? (this.addEventListener("DOMMouseScroll", c, !1),
                this.addEventListener("mousewheel", c, !1),
                this.addEventListener("MozMousePixelScroll", c, !1))
              : document.attachEvent("onmousewheel", c);
          }
          function g() {
            (o = Math.max(
              (v.outerHeight() / v[0].scrollHeight) * v.outerHeight(),
              s
            )),
              A.css({ height: o + "px" });
          ...
          if (v.parent().hasClass(d.wrapperClass)) {
            var w = v.scrollTop();
            if (
              ((A = v.parent().find("." + d.barClass)),
              (z = v.parent().find("." + d.railClass)),
              g(),
              a.isPlainObject(b))
            ) {
            ...
            z.css(B),
              ...
              v.bind("touchmove", function (a) {
                if (
                  (u || a.originalEvent.preventDefault(),
                  a.originalEvent.touches.length)
                ) {
                  var b =
                    (n - a.originalEvent.touches[0].pageY) / d.touchScrollStep;
                  e(b, !0), (n = a.originalEvent.touches[0].pageY);
                }
              }),
              g(),
              "bottom" === d.start
                ? (A.css({ top: v.outerHeight() - A.outerHeight() }), e(0, !0))
                : "top" !== d.start &&
