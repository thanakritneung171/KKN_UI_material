!(function (b) {
  ...
  function d() {
    ...
    return (
      "Markdown.mk_block( " +
      a.inspect(this.toString()) +
      ", " +
      a.inspect(this.trailing) +
      ", " +
      a.inspect(this.lineNumber) +
      " )"
    );
  }
  function e(a) {
  ...
  function h(a) {
    return q(a) && a.length > 1 && "object" == typeof a[1] && !q(a[1])
      ? a[1]
      : void 0;
  }
  function i(a) {
  ...
  function j(a) {
    ...
    for (
      ...
      d.push(arguments.callee(a.shift()));
    var e = "";
    for (var f in c) e += " " + f + '="' + i(c[f]) + '"';
    return "img" == b || "br" == b || "hr" == b
      ? "<" + b + e + "/>"
      : "<" + b + e + ">" + d.join("") + "</" + b + ">";
  }
  function k(a, b, c) {
    ...
    c = c || {};
    var e = a.slice(0);
    "function" == typeof c.preprocessTreeNode &&
      (e = c.preprocessTreeNode(e, b));
    var f = h(e);
    if (f) {
      e[1] = {};
  ...
  function l(a) {
    for (var b = h(a) ? 2 : 1; b < a.length; )
      "string" == typeof a[b]
        ? b + 1 < a.length && "string" == typeof a[b + 1]
          ? (a[b] += a.splice(b + 1, 1)[0])
          : ++b
        : (arguments.callee(a[b]), ++b);
  }
  ...
  (m.prototype.split_blocks = function (a, b) {
    ...
    for (
      null != (c = /^(\s*\n)/.exec(a)) &&
      ((g += e(c[0])), (d.lastIndex = c[0].length));
      null !== (c = d.exec(a));

    )
      f.push(n(c[1], c[2], g)), (g += e(c[0]));
    return f;
  }),
    (m.prototype.processBlock = function (a, b) {
      ...
      for (var e = 0; e < d.length; e++) {
        ...
        if (f)
          return (
            (!q(f) || (f.length > 0 && !q(f[0]))) &&
              this.debug(d[e], "didn't return a proper array"),
            f
          );
      }
      return [];
      ...
      block: {
        atxHeader: function (a, b) {
          ...
          if (c) {
            ...
            return (
              Array.prototype.push.apply(d, this.processInline(c[2])),
              c[0].length < a.length &&
                b.unshift(
                  n(a.substr(c[0].length), a.trailing, a.lineNumber + 2)
                ),
              [d]
            );
          }
        ...
        horizRule: function (a, b) {
          ...
          if (c) {
            var d = [["hr"]];
            return (
              c[1] && d.unshift.apply(d, this.processBlock(c[1], [])),
              c[3] && b.unshift(n(c[3])),
              d
            );
          }
        ...
        lists: (function () {
          ...
          function c(a, b, c, d) {
            ...
            var e =
              a[a.length - 1] instanceof Array && "para" == a[a.length - 1][0]
                ? a[a.length - 1]
                : a;
            ...
            for (var f = 0; f < c.length; f++) {
              var g = c[f],
                h = "string" == typeof g;
              h && e.length > 1 && "string" == typeof e[e.length - 1]
                ? (e[e.length - 1] += g)
                : e.push(g);
            }
          }
              ...
              for (var l, m, n = [], p = j(k), q = !1, r = [n[0].list]; ; ) {
                for (
                  ...
                  if (((k = w.match(x)), void 0 !== k[1])) {
                    t.length &&
                      (c(l, q, this.processInline(t), v), (q = !1), (t = "")),
                      (k[1] = b(k[1]));
                    var y = Math.floor(k[1].length / 4) + 1;
                    if (y > n.length)
                      (p = j(k)), l.push(p), (l = p[1] = ["listitem"]);
                    else {
                      var z = !1;
                ...
                var A = d(n.length, i);
                A.length > 0 &&
                  (o(n, e, this), l.push.apply(l, this.toTree(A, [])));
    ...
    (m.dialects.Gruber.inline = {
      __oneElement__: function (a, b, c) {
        ...
        var e;
        return (
          d[2] in this.dialect.inline &&
            (e = this.dialect.inline[d[2]].call(
              this,
              a.substr(d.index),
              d,
              c || []
      ...
      "![": function (a) {
        ...
        if (b) {
          b[2] &&
            "<" == b[2][0] &&
            ">" == b[2][b[2].length - 1] &&
            (b[2] = b[2].substring(1, b[2].length - 1)),
        ...
        return (
          ...
          b
            ? [
                ...
                [
                  "img_ref",
                  { alt: b[1], ref: b[2].toLowerCase(), original: b[0] },
                ],
              ]
            : [2, "!["]
        );
      ...
      "[": function s(a) {
        ...
        if (g) {
          ...
          return (
            (h = this.dialect.inline.__call__.call(this, h, /\\/)[0]),
            (d = { href: h || "" }),
        ...
        return (
          ...
          g
            ? ((e += g[0].length),
              ...
              (s = ["link_ref", d].concat(f)),
              [e, s])
            : 1 == f.length && "string" == typeof f[0]
            ? ((d = { ref: f[0].toLowerCase(), original: b.substr(0, e) }),
              (s = ["link_ref", d, f[0]]),
              [e, s])
            : [1, "["]
        );
      ...
      "<": function (a) {
        ...
        return null !=
          ...
          ? b[3]
            ? [b[0].length, ["link", { href: "mailto:" + b[3] }, b[3]]]
            : "mailto" == b[2]
            ? [
                b[0].length,
                ["link", { href: b[1] }, b[1].substr("mailto:".length)],
              ]
            : [b[0].length, ["link", { href: b[1] }, b[1]]]
          : [1, "<"];
      },
      "`": function (a) {
        var b = a.match(/(`+)(([\s\S]*?)\1)/);
        return b && b[2]
          ? [b[1].length + b[2].length, ["inlinecode", b[3]]]
          : [1, "`"];
      },
      "  \n": function (a) {
        return [3, ["linebreak"]];
    ...
    (m.dialects.Maruku.processMetaHash = function (a) {
      for (var b = g(a), c = {}, d = 0; d < b.length; ++d)
        if (/^#/.test(b[d])) c.id = b[d].substring(1);
          ...
          c["class"]
            ? (c["class"] = c["class"] + b[d].replace(/./, " "))
            : (c["class"] = b[d].substring(1));
        else if (/\=/.test(b[d])) {
          var e = b[d].split(/\=/);
          c[e[0]] = e[1];
        }
    ...
    (m.dialects.Maruku.block.block_meta = function (b, c) {
      ...
      if (d) {
        var e,
          f = this.dialect.processMetaHash(d[2]);
        if ("" === d[1]) {
      ...
      if ((h = a.match(d))) {
        ...
        for (var g = 0; g < f.length; ++g) {
          ...
          for (c = 0; c < j.length; ++c)
            e.push(
              ["dd"].concat(this.processInline(j[c].replace(/(\n)\s+/, "$1")))
            );
        }
        return [e];
      }
  ...
  (function () {
    return "undefined" == typeof exports
