$(document).ready(function () {
  ...
  if ($("#decimal-graph").length) {
    for (var d = [], e = 0; 360 >= e; e += 10)
      d.push({ x: e, y: Math.sin((Math.PI * e) / 180).toFixed(4) });
