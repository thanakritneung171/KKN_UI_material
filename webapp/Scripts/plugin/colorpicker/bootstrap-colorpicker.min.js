  ...
  b.prototype = {
    ...
    setColor: function (b) {
      ...
      a.each(d.stringParsers, function (a, e) {
        ...
        return g
          ? ("hsla" === h
              ? (c.value = d.RGBtoHSB.apply(null, d.HSLtoRGB.apply(null, g)))
              : (c.value = d.RGBtoHSB.apply(null, g)),
            !1)
          : void 0;
      });
    },
    ...
    hide: function () {
      this.picker.hide(),
        ...
        this.isInput
          ...
          : (a(document).off({ mousedown: this.hide }),
            this.component &&
    ...
    mousedown: function (b) {
      ...
      if (!e.is(".colorpicker")) {
        ...
        (this.slider.knob = e.find("i")[0].style),
          ...
          (this.pointer = { left: b.pageX, top: b.pageY }),
          a(document)
            .on({
    ...
    mousemove: function (a) {
      ...
      var b = Math.max(
          ...
          Math.min(
            this.slider.maxLeft,
            this.slider.left +
              ((a.pageX || this.pointer.left) - this.pointer.left)
          )
        ),
        c = Math.max(
          0,
          Math.min(
            this.slider.maxTop,
            this.slider.top + ((a.pageY || this.pointer.top) - this.pointer.top)
          )
        );
      return (
    ...
    (a.fn.colorpicker = function (b, d) {
      return this.each(function () {
        ...
        f ||
          e.data(
            "colorpicker",
            (f = new c(this, a.extend({}, a.fn.colorpicker.defaults, g)))
          ),
