...
(jvm.$ = jQuery),
  ...
  (jvm.AbstractShapeElement.prototype.updateStyle = function () {
    var e = {};
    jvm.$.extend(e, this.style.initial || {}),
      jvm.$.extend(e, this.style.current || {}),
      this.isHovered && jvm.$.extend(e, this.style.hover || {}),
      this.isSelected &&
        (jvm.$.extend(e, this.style.selected || {}),
        this.isHovered && jvm.$.extend(e, this.style.selectedHover || {})),
      this.set(e);
  }),
  ...
  (jvm.DataSeries = function (e, t) {
    ...
    (e = e || {}),
      ...
      e.values && ((this.values = e.values || {}), this.setValues(e.values));
  }),
  ...
  (jvm.Proj = {
      ...
      return {
        ...
        y:
          (-(
            (180 / Math.PI) *
            (5 / 4) *
            Math.log(Math.tan(Math.PI / 4 + (0.8 * e * Math.PI) / 360))
          ) /
            360) *
    ...
    aea: function (e, t, n) {
      ...
      return {
        ...
        y:
          (-(p - h * Math.cos(c)) / (2 * Math.PI)) * jvm.WorldMap.circumference,
      };
    },
    lcc: function (e, t, r) {
      var i = 0,
      ...
      return (
        ...
        (F = (Math.cos(u) * Math.pow(Math.tan(Math.PI / 4 + u / 2), n)) / n),
        (ro = F * Math.pow(1 / Math.tan(Math.PI / 4 + f / 2), n)),
        (ro0 = F * Math.pow(1 / Math.tan(Math.PI / 4 + i / 2), n)),
        {
          x:
            ((ro * Math.sin(n * (o - s))) / (2 * Math.PI)) *
            jvm.WorldMap.circumference,
          y:
            (-(ro0 - ro * Math.cos(n * (o - s))) / (2 * Math.PI)) *
            jvm.WorldMap.circumference,
        }
      );
    },
  ...
  (jvm.WorldMap.prototype = {
    ...
    bindContainerTouchEvents: function () {
      ...
      jvm.$(this.container).bind("gesturestart", function (i) {
        ...
        jvm.$(this.container).bind("touchstart", function (e) {
          ...
          t.length == 2 &&
            (t[0].pageX > t[1].pageX
              ? (o = t[1].pageX + (t[0].pageX - t[1].pageX) / 2)
              : (o = t[0].pageX + (t[1].pageX - t[0].pageX) / 2),
            t[0].pageY > t[1].pageY
              ? (u = t[1].pageY + (t[0].pageY - t[1].pageY) / 2)
              : (u = t[0].pageY + (t[1].pageY - t[0].pageY) / 2)),
        ...
        jvm.$(this.container).bind("touchmove", function (e) {
          ...
          if (r.scale != r.baseScale)
            return (
              e.originalEvent.touches.length == 1 && i && s
                ? ((t = e.originalEvent.touches[0]),
                  (r.transX -= (i - t.pageX) / r.scale),
                  (r.transY -= (s - t.pageY) / r.scale),
                  r.applyTransform(),
                  r.label.hide(),
                  (i = t.pageX),
                  (s = t.pageY))
      ...
      this.container.mousemove(function () {
        ...
        this.container.delegate(
          ...
          function (t) {
            var n = this,
              r =
                jvm.$(this).attr("class").indexOf("jvectormap-region") === -1
                  ? "marker"
                  : "region",
              i =
                r == "region"
              ...
              s = r == "region" ? e.regions[i].element : e.markers[i].element,
              o =
                r == "region"
                  ? e.mapData.paths[i].name
                  : e.markers[i].config.name || "",
              u = jvm.$.Event(r + "LabelShow.jvectormap"),
              a = jvm.$.Event(r + "Over.jvectormap");
            t.type == "mouseover"
              ? (e.container.trigger(a, [i]),
                a.isDefaultPrevented() || s.setHovered(!0),
                e.label.text(o),
                e.container.trigger(u, [e.label, i]),
            ...
            var r = this,
              ...
              s =
                i == "region"
                  ? jvm.$(this).attr("data-code")
                  : jvm.$(this).attr("data-index"),
              o = jvm.$.Event(i + "Click.jvectormap"),
              u = i == "region" ? e.regions[s].element : e.markers[s].element;
            if (!t) {
              e.container.trigger(o, [s]);
              if (
                (i === "region" && e.params.regionsSelectable) ||
    ...
    setFocus: function (e, t, n) {
      var r;
      typeof e == "string" && this.regions[e]
        ? ((r = this.regions[e].element.getBBox()),
          this.setScale(
    ...
    createMarkers: function (e) {
      ...
      for (t in e)
        (i = e[t] instanceof Array ? { latLng: e[t] } : e[t]),
          (r = this.latLngToPoint.apply(this, i.latLng || [0, 0])),
    ...
    repositionMarkers: function () {
      ...
      for (e in this.markers)
        (t = this.latLngToPoint.apply(this, this.markers[e].config.latLng)),
