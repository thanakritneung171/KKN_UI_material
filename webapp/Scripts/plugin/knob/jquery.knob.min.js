    ...
    (b.o = function () {
      ...
      (this.o = null),
            ...
            return (
              ...
              this.c
                ? ((this.scale =
                  ...
                  this._draw(),
                  this)
                : void (this.o.error && this.o.error())
            );
        }),
        (this._carve = function () {
          if (this.relative) {
            var a = this.relativeWidth
                ? (this.$div.parent().width() * parseInt(this.o.width)) / 100
                : this.$div.parent().width(),
              b = this.relativeHeight
        ...
        (this._touch = function (a) {
          var d = function (a) {
            var b = c.xy2val(
              a.originalEvent.touches[c.t].pageX,
              a.originalEvent.touches[c.t].pageY
            );
            b != c.cv &&
              ((c.cH && c.cH(b) === !1) ||
                (c.change(c._validate(b)), c._draw()));
          };
          return (
            (this.t = b.c.t(a)),
            d(a),
    ...
    (b.Dial = function () {
      b.o.call(this),
        ...
        (this.val = function (a) {
          return null == a
            ? this.v
            : ((this.cv = this.o.stopper ? c(d(a, this.o.max), this.o.min) : a),
              (this.v = this.cv),
              this.$.val(this.v),
              this._draw(),
              void 0);
        ...
        (this.xy2val = function (a, b) {
          ...
          return (
            (e =
              Math.atan2(a - (this.x + this.w2), -(b - this.y - this.w2)) -
              this.angleOffset),
            this.angleArc != this.PI2 && 0 > e && e > -0.5
              ? (e = 0)
              : 0 > e && (e += this.PI2),
            (f =
              ~~(0.5 + (e * (this.o.max - this.o.min)) / this.angleArc) +
              this.o.min),
          ...
          var b,
            ...
            g = function (a) {
              ...
              var b = a.originalEvent,
                c = b.detail || b.wheelDeltaX,
                d = b.detail || b.wheelDeltaY,
                e =
                  parseInt(f.$.val()) +
                  (c > 0 || d > 0 ? f.o.step : 0 > c || 0 > d ? -f.o.step : 0);
              (f.cH && f.cH(e) === !1) || f.val(e);
            },
            h = 1,
            i = { 37: -f.o.step, 38: f.o.step, 39: f.o.step, 40: -f.o.step };
          this.$.bind("keydown", function (g) {
            var j = g.keyCode;
            if (
              (j >= 96 && 105 >= j && (j = g.keyCode = j - 48),
              (b = parseInt(String.fromCharCode(j))),
              isNaN(b) &&
                (13 !== j &&
                  8 !== j &&
                  9 !== j &&
              ...
              f.o.stopper && (k = c(d(k, f.o.max), f.o.min)),
                f.change(k),
                f._draw(),
            ...
            isNaN(b)
              ? e &&
                (window.clearTimeout(e), (e = null), (h = 1), f.val(f.$.val()))
              : (f.$.val() > f.o.max && f.$.val(f.o.max)) ||
                (f.$.val() < f.o.min && f.$.val(f.o.min));
          }),
            this.$c.bind("mousewheel DOMMouseScroll", g),
            this.$.bind("mousewheel DOMMouseScroll", g);
        }),
        (this.init = function () {
        ...
        (this.draw = function () {
          ...
          (c.lineWidth = this.lineWidth),
            ...
            c.stroke(),
            this.o.displayPrevious &&
              ((b = this.startAngle + this.angle(this.v)),
              (a = this.startAngle),
              this.o.cursor &&
                (a = b - this.cursorExt) &&
                (b += this.cursorExt),
              ...
              c.arc(this.xy, this.xy, this.radius, a, b, !1),
              c.stroke(),
              (g = this.cv == this.v)),
            c.beginPath(),
            (c.strokeStyle = g ? this.o.fgColor : this.fgColor),
            c.arc(this.xy, this.xy, this.radius, e, f, !1),
            c.stroke();
        }),
