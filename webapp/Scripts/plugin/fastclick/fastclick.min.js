...
(FastClick.prototype.deviceIsAndroid =
  ...
  (FastClick.prototype.focus = function (a) {
    var b;
    this.deviceIsIOS && a.setSelectionRange
  ...
  (FastClick.prototype.touchHasMoved = function (a) {
    return (
      ...
      10 < Math.abs(a.pageX - this.touchStartX) ||
      10 < Math.abs(a.pageY - this.touchStartY)
        ? !0
        : !1
    );
  }),
  ...
  (FastClick.prototype.onTouchEnd = function (a) {
    ...
    if (
      ...
      return 100 < a.timeStamp - b ||
        (this.deviceIsIOS && window.top !== window && "input" === c)
        ? ((this.targetElement = null), !1)
        : (this.focus(d),
          (this.deviceIsIOS4 && "select" === c) ||
    ...
    return this.deviceIsIOS &&
      ...
      ? !0
      : (this.needsClick(d) || (a.preventDefault(), this.sendClick(d, a)), !1);
  }),
  ...
  (FastClick.prototype.onClick = function (a) {
    return this.trackingClick
      ...
      ? !0
      : ((a = this.onMouse(a)), a || (this.targetElement = null), a);
  }),
