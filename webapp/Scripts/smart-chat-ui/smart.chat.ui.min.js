  ...
  a.widget("ui.chatbox", {
    options: {
      ...
      boxManager: {
        ...
        addMsg: function (b, c) {
          ...
          a(i).text(c),
            f.appendChild(i),
            a(f).addClass("ui-chatbox-msg"),
            a(f).css("maxWidth", a(e).width()),
            a(f).fadeIn(),
            a(f).find("span").emoticonize(),
            d._scrollToBottom(),
            d.elem.uiChatboxTitlebar.hasClass("ui-state-focus") ||
              d.highlightLock ||
              ((d.highlightLock = !0), d.highlightBox());
        },
        highlightBox: function () {
          var a = this;
          a.elem.uiChatboxTitlebar.effect("highlight", {}, 300),
            a.elem.uiChatbox.effect("bounce", { times: 2 }, 300, function () {
    ...
    _create: function () {
      var b = this,
        c = b.options,
        d = c.title || "No Title",
        e = (b.uiChatbox = a("<div></div>"))
          .appendTo(document.body)
          .addClass("ui-widget ui-chatbox")
          .attr("outline", 0)
          .focusin(function () {
        ...
        f = (b.uiChatboxTitlebar = a("<div></div>"))
          .addClass(
            "ui-widget-header ui-chatbox-titlebar " +
              b.options.status +
              " ui-dialog-header"
          )
          .click(function (a) {
          ...
          .appendTo(e),
        g =
          ((b.uiChatboxTitle = a("<span></span>")).html(d).appendTo(f),
          (b.uiChatboxTitlebarClose = a(
            ...
            .appendTo(f)),
        h =
          (a("<i></i>").addClass("fa fa-times").appendTo(g),
          (b.uiChatboxTitlebarMinimize = a(
            ...
            .appendTo(f)),
        i =
          (a("<i></i>").addClass("fa fa-minus").appendTo(h),
          (b.uiChatboxContent = a(
            '<div class="' +
              b.options.alertshow +
            ...
            .appendTo(e)),
        j =
          ((b.uiChatboxLog = b.element)
            .addClass("ui-widget-content ui-chatbox-log custom-scroll")
            .appendTo(i),
          (b.uiChatboxInput = a("<div></div>"))
            .addClass("ui-widget-content ui-chatbox-input")
            .click(function (a) {})
            .appendTo(i)),
        k = (b.uiChatboxInputBox = a("<textarea></textarea>"))
          .addClass("ui-widget-content ui-chatbox-input-box ")
          .appendTo(j)
          .keydown(function (c) {
            return c.keyCode && c.keyCode == a.ui.keyCode.ENTER
              ? ((msg = a.trim(a(this).val())),
                msg.length > 0 &&
                  b.options.messageSent(b.options.id, b.options.user, msg),
                a(this).val(""),
                !1)
              : void 0;
          })
      ...
      f.find("*").add(f).disableSelection(),
        ...
        b._setWidth(b.options.width),
        b._position(b.options.offset),
        b.options.boxManager.init(b),
        b.options.hidden || e.show(),
        a(".ui-chatbox [rel=tooltip]").tooltip();
    },
    ...
    _setWidth: function (a) {
      this.uiChatbox.width(a + 28 + "px"),
        this.uiChatboxInputBox.css("width", a + 18 + "px");
    },
    ...
    (a.fn.emoticonize = function (b) {
      ...
      return this.not(l).each(function () {
        ...
        a(e).each(function () {
          ...
          a(f).each(function () {
            b.html(
              b
                ...
                .replace(
                  this,
                  "$1<span class='" + d + " spaced-emoticon'>$2</span>"
                )
            );
          }),
          ...
          c.animate &&
            setTimeout(function () {
              a(".un-transformed-emoticon").removeClass(
                "un-transformed-emoticon"
              );
            }, c.delay);
      });
    }),
      (a.fn.unemoticonize = function (b) {
        ...
        return this.each(function () {
          ...
          b.find("span.css-emoticon").each(function () {
            var b = a(this);
            c.animate
              ? (b.addClass("un-transformed-emoticon"),
                setTimeout(function () {
